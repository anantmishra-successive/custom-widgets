...
interface LuminaArcgisAreaMeasurement3d extends Partial<Pick<ArcgisAreaMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisAreaMeasurement3dElement> {
...
interface LuminaArcgisBasemapGallery extends Partial<Pick<ArcgisBasemapGallery, 'activeBasemap' | 'autoDestroyDisabled' | 'disabled' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'source'>>, h.JSX.HTMLAttributes<HTMLArcgisBasemapGalleryElement> {
...
interface LuminaArcgisCompass extends Partial<Pick<ArcgisCompass, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisCompassElement> {
...
interface LuminaArcgisDirections extends Partial<Pick<ArcgisDirections, 'apiKey' | 'autoDestroyDisabled' | 'goToOverride' | 'headingLevel' | 'hideLayerDetails' | 'hideSaveAsButton' | 'hideSaveButton' | 'icon' | 'label' | 'layer' | 'maxStops' | 'position' | 'referenceElement' | 'routeLayerItemId' | 'searchProperties' | 'unit' | 'useDefaultRouteLayer'>>, h.JSX.HTMLAttributes<HTMLArcgisDirectionsElement> {
...
interface LuminaArcgisDirectLineMeasurement3d extends Partial<Pick<ArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisDirectLineMeasurement3dElement> {
...
interface LuminaArcgisDirectlineMeasurement3d extends Partial<Pick<DeprecatedArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisDirectlineMeasurement3dElement> {
  onarcgisPropertyChange?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisPropertyChange"]>;
  onarcgisReady?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisReady"]>;
}

interface LuminaArcgisDistanceMeasurement2d extends Partial<Pick<ArcgisDistanceMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisDistanceMeasurement2dElement> {
...
interface LuminaArcgisFullscreen extends Partial<Pick<ArcgisFullscreen, 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, ArcgisFullscreenSetterTypes, h.JSX.HTMLAttributes<HTMLArcgisFullscreenElement> {
...
interface LuminaArcgisGridControls extends Partial<Pick<ArcgisGridControls, 'autoDestroyDisabled' | 'customColor' | 'dynamicScaling' | 'gridColor' | 'hideColorSelection' | 'hideDynamicScaleToggle' | 'hideGridEnabledToggle' | 'hideGridSnapEnabledToggle' | 'hideLineIntervalInput' | 'hideNumericInputs' | 'hideOutOfScaleWarning' | 'hidePlacementButtons' | 'hideRotateWithMapToggle' | 'icon' | 'interactivePlacementState' | 'label' | 'majorLineInterval' | 'messageOverrides' | 'placementDisabled' | 'position' | 'referenceElement' | 'rotateWithMap' | 'rotation' | 'snappingEnabled' | 'snappingOptions' | 'spacing' | 'theme' | 'unit'>>, h.JSX.HTMLAttributes<HTMLArcgisGridControlsElement> {
...
interface LuminaArcgisHistogramRangeSlider extends Partial<Pick<ArcgisHistogramRangeSlider, 'autoDestroyDisabled' | 'average' | 'barCreatedFunction' | 'bins' | 'dataLineCreatedFunction' | 'dataLines' | 'icon' | 'label' | 'labelFormatFunction' | 'max' | 'min' | 'position' | 'precision' | 'rangeType' | 'referenceElement' | 'standardDeviation' | 'standardDeviationCount' | 'values'>>, ArcgisHistogramRangeSliderSetterTypes, h.JSX.HTMLAttributes<HTMLArcgisHistogramRangeSliderElement> {
...
interface LuminaArcgisLineOfSight extends Partial<Pick<ArcgisLineOfSight, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisLineOfSightElement> {
...
interface LuminaArcgisLinkChartLayoutSwitcher extends Partial<Pick<ArcgisLinkChartLayoutSwitcher, 'appearance' | 'autoDestroyDisabled' | 'closeOnSelectDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'preventExtentUpdate' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisLinkChartLayoutSwitcherElement> {
...
interface LuminaArcgisLocate extends Partial<Pick<ArcgisLocate, 'autoDestroyDisabled' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'popupDisabled' | 'position' | 'referenceElement' | 'scale' | 'state'>>, h.JSX.HTMLAttributes<HTMLArcgisLocateElement> {
...
interface LuminaArcgisNavigationToggle extends Partial<Pick<ArcgisNavigationToggle, 'icon' | 'label' | 'layout' | 'messageOverrides' | 'navigationMode' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisNavigationToggleElement> {
...
interface LuminaArcgisPrint extends Partial<Pick<ArcgisPrint, 'allowedFormats' | 'allowedFormatsForSaving' | 'allowedLayouts' | 'autoDestroyDisabled' | 'browseTemplateButtonOnClick' | 'excludeDefaultTemplates' | 'excludeOrganizationTemplates' | 'exportedLinks' | 'extraParameters' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'outSpatialReference' | 'portal' | 'position' | 'printServiceUrl' | 'referenceElement' | 'saveAsButtonCallback' | 'showPrintAreaEnabled' | 'templateCustomTextElements' | 'templateOptions'>>, h.JSX.HTMLAttributes<HTMLArcgisPrintElement> {
...
interface LuminaArcgisScene extends Partial<Pick<ArcgisScene, 'alphaCompositingEnabled' | 'analyses' | 'autoDestroyDisabled' | 'basemap' | 'basemapView' | 'camera' | 'cameraFov' | 'cameraHeading' | 'cameraPosition' | 'cameraTilt' | 'clippingArea' | 'constraints' | 'displayFilterDisabled' | 'environment' | 'extent' | 'fatalError' | 'floors' | 'focusAreas' | 'graphics' | 'highlightOptions' | 'highlights' | 'itemId' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'qualityProfile' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'viewingMode' | 'viewpoint' | 'zoom'>>, ArcgisSceneSetterTypes, h.JSX.HTMLAttributes<HTMLArcgisSceneElement> {
...
interface LuminaArcgisSlice extends Partial<Pick<ArcgisSlice, 'analysis' | 'autoDestroyDisabled' | 'excludedLayers' | 'excludeGroundSurface' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'shape' | 'tiltEnabled'>>, h.JSX.HTMLAttributes<HTMLArcgisSliceElement> {
...
interface LuminaArcgisTimeZoneLabel extends Partial<Pick<ArcgisTimeZoneLabel, 'disabled' | 'expanded' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, ArcgisTimeZoneLabelSetterTypes, h.JSX.HTMLAttributes<HTMLArcgisTimeZoneLabelElement> {
...
interface LuminaArcgisTrack extends Partial<Pick<ArcgisTrack, 'autoDestroyDisabled' | 'error' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'positionFilterFunction' | 'referenceElement' | 'rotationDisabled' | 'scale'>>, h.JSX.HTMLAttributes<HTMLArcgisTrackElement> {
...
interface LuminaArcgisUtilityNetworkValidateTopology extends Partial<Pick<ArcgisUtilityNetworkValidateTopology, 'autoDestroyDisabled' | 'extentToValidate' | 'icon' | 'label' | 'position' | 'referenceElement' | 'utilityNetwork'>>, h.JSX.HTMLAttributes<HTMLArcgisUtilityNetworkValidateTopologyElement> {
...
interface LuminaArcgisVersionManagement extends Partial<Pick<ArcgisVersionManagement, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'initialVersionInfos' | 'label' | 'messageOverrides' | 'mode' | 'pageSize' | 'position' | 'referenceElement' | 'versioningStates'>>, h.JSX.HTMLAttributes<HTMLArcgisVersionManagementElement> {
...
interface LuminaArcgisVideo extends Partial<Pick<ArcgisVideo, 'autoDestroyDisabled' | 'layer' | 'map'>>, h.JSX.HTMLAttributes<HTMLArcgisVideoElement> {
  onarcgisViewReadyChange?: EventHandler<HTMLArcgisVideoElement["arcgisViewReadyChange"]>;
}

interface LuminaArcgisVideoPlayer extends Partial<Pick<ArcgisVideoPlayer, 'autoDestroyDisabled' | 'followingMode' | 'hideHeader' | 'icon' | 'label' | 'layer' | 'messageOverrides' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisVideoPlayerElement> {
...
interface LuminaArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLArcgisWeatherElement> {
...
interface LuminaArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement' | 'state'>>, h.JSX.HTMLAttributes<HTMLArcgisZoomElement> {
...
declare module "@arcgis/lumina" {
  export namespace h.JSX {
    interface IntrinsicElements {
      ...
      "arcgis-direct-line-measurement-3d": LuminaArcgisDirectLineMeasurement3d;
      ...
      "arcgis-grid-controls": LuminaArcgisGridControls;
      ...
      "arcgis-video": LuminaArcgisVideo;
      "arcgis-video-player": LuminaArcgisVideoPlayer;
