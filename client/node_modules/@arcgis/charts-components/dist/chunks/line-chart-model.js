...
import "lodash-es";
import "d3-array";
import { aA as h, ao as o, Y as f, P as m } from "./interfaces.js";
...
import { f as S, e as a, h as d } from "./data.js";
import "./model-with-y-guides.js";
import { M as c, a as g } from "./model-with-baseline-stacking.js";
import { s as y, a as u, b as p, c as b, d as I } from "./baseline-stacking.js";
import { S as C, s as L, a as k } from "./serial-chart-model.js";
/*! All material copyright Esri, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
v4.33.19 */
class M extends C {
  constructor() {
    super(...arguments), this._chartType = n.LineSeries;
  }
  async setup(i) {
    await this.loadConfigFromLayer(i), this.commonStrings = await S(), i.config !== void 0 && this.updateSeriesFromLayerFilter(), await this.initDefaultSeries(), this.resolveSetup();
  }
  // ---------------------------------------------------------------------------------------------
  // Protected methods
  // ---------------------------------------------------------------------------------------------
  ...
  resetSeriesStyling() {
    ...
    for (let e = 0; e < i; e += 1) {
      ...
      if (L(r, e, this._config), y(r, e, this._config), this.layerInfo !== void 0) {
        ...
        s !== this.layerInfo.objectIdField && k(s ?? t, e, this._config);
      }
      u(this.defaultSeries?.lineSymbol?.style, e, this._config), p(this.defaultSeries?.lineSymbol?.width, e, this._config), b(this.defaultSeries?.markerSymbol?.style, e, this._config), I(this.defaultSeries?.markerSymbol?.size, e, this._config);
    }
