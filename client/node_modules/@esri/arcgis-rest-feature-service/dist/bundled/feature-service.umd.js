...
(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  async function queryAllFeatures(requestOptions) {
      ...
      const pageSizeResponse = await arcgisRestRequest.request(requestOptions.url, {
          httpMethod: "GET"
      });
      ...
      while (hasMore) {
          ...
          const queryOptions = arcgisRestRequest.appendCustomParams(pagedOptions, [
              "where",
              "objectIds",
              "relationParam",
              "time",
          ...
          const response = await arcgisRestRequest.request(`${arcgisRestRequest.cleanUrl(requestOptions.url)}/query`, queryOptions);
