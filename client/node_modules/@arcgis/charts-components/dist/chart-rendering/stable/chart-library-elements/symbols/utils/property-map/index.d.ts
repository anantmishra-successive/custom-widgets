import { AxisItemLocation } from '@amcharts/amcharts4/.internal/charts/axes/Axis.js';
import { LineSeries } from '@amcharts/amcharts4/charts.js';
import { Align, Container, HorizontalCenter, Pattern, VerticalAlign, VerticalCenter } from '@amcharts/amcharts4/core.js';
import { ISimpleLineSymbol, ISimpleMarkerSymbol, SimpleFillSymbolStyle, WebChartTextSymbol, RESTHorizontalAlignment, RESTVerticalAlignment } from '@arcgis/charts-spec';
import { default as SimpleLineSymbol } from '@arcgis/core/symbols/SimpleLineSymbol';
import { EsriColor, AmChartsColor } from '../../../../types';
/**
