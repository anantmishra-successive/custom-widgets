import { XYSeries, LineSeries, GaugeChartDataItem, Chart, XYChart, PieChart } from '@amcharts/amcharts4/charts.js';
import { List, Sprite, Optional, Pattern, LinearGradient, RadialGradient } from '@amcharts/amcharts4/core.js';
