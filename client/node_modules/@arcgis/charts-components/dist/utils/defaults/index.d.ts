import { CategoryFormatOptions, Color, DateTimeFormatOptions, HistogramOverlays, IFont, ISimpleFillSymbol, ISimpleLineSymbol, ISimpleMarkerSymbol, NumberFormatOptions, ScatterplotOverlays, SizePolicy, WebBoxPlot, WebChart, WebChartAxis, WebChartBarChartSeries, WebChartBoxPlotSeries, WebChartCursorCrosshair, WebChartGaugeAxis, WebChartGaugeSeries, WebChartHistogramSeries, WebChartLegend, WebChartLineChartSeries, WebChartNeedle, WebChartOverlay, WebChartPieChartSeries, WebChartPieChartTick, WebChartRadarChartSeries, WebChartScatterplotSeries, WebChartText, WebChartTextSymbol, WebGaugeChart, WebChartStackedKinds, WebChartTypes } from '@arcgis/charts-spec';
import { ChartElementLimit, ChartElementTechnicalLimit, ChartTextProps, QueryDefaults, TextElements } from './interfaces';
...
export declare const ramp: Color[];
/**
...
/**
 * Gets default cursor crosshair
 * @returns default cursor crosshair
 */
export declare function getDefaultCursorCrosshair(): WebChartCursorCrosshair;
/**
...
/**
 * Returns a default RadarChartSeries object as per the WebChart Specification
 */
export declare function getDefaultRadarChartSeries(props: {
    objectIDField?: string;
    seriesIndex?: number;
}): Promise<Required<Pick<WebChartRadarChartSeries, "dataLabels" | "lineSymbol" | "markerSymbol" | "query">> & WebChartRadarChartSeries>;
/**
...
export declare function getDefaultBarChart(id?: string): Promise<WebChart>;
export declare function getDefaultBoxPlot(id?: string): Promise<WebBoxPlot>;
export declare function getDefaultLineChart(id?: string): Promise<WebChart>;
export declare function getDefaultRadarChart(id?: string): Promise<WebChart>;
export declare function getDefaultPieChart(id?: string): Promise<WebChart>;
export declare function getDefaultGauge(id?: string): Promise<WebGaugeChart>;
export declare function getDefaultScatterplot(id?: string): Promise<WebChart>;
...
export declare function getDefaultHistogram(id?: string): Promise<WebChart>;
/**
 ...
 */
export declare function getDefaultAggregationTypeLabel(aggregationType: string | undefined): Promise<string>;
/**
...
export declare const percentageSuffix = " percentage ";
