import { Color, ISimpleFillSymbol, WebChartCursorCrosshair, WebChartDataItem, WebChartPieChartGroupSlice, RESTHorizontalAlignment, RESTSimpleMarkerSymbolStyle, RESTVerticalAlignment, WebChartLegendPositions, WebChartLineSmoothedKinds, WebChartSortOrderKinds, WebChartStackedKinds } from '@arcgis/charts-spec';
import { SelectionTheme, ActionModes } from '../../../utils';
...
export interface PieChartDefaults {
    ...
    min: number;
    max: number;
    displayCategoryOnLegend?: boolean;
...
/** Charts version of amCharts aria roles. */
...
export interface CommonChartDefaults {
    aria: Readonly<{
    ...
    rotatedChartPadding: Readonly<LabelProperties>;
    ...
    loaderSpinnerColor: Readonly<EsriColor>;
    ...
    originalServerBinningRange: string;
    dateBinModel: string;
    /** Query defaults */
 ...
 */
export declare const CommonChartDefaults: Readonly<CommonChartDefaults>;
export {};
