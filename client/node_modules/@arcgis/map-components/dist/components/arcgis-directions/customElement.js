...
import d from "@arcgis/core/widgets/Directions.js";
import { LitElement as n, createEvent as l, noShadowRoot as w } from "@arcgis/lumina";
import { m } from "../../chunks/useWidget.js";
import { e as u } from "../../chunks/component-utils.js";
import { css as y } from "@lit/reactive-element/css-tag.js";
/*! All material copyright Esri, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
v4.33.19 */
const c = y`@layer{arcgis-directions{display:block}}`, g = m(d), i = "map-components:arcgis-directions";
class p extends n {
  constructor() {
  ...
  static {
    this.properties = { apiKey: 1, autoDestroyDisabled: 5, goToOverride: 0, headingLevel: 9, hideLayerDetails: 5, hideSaveAsButton: 5, hideSaveButton: 5, icon: 1, label: 1, lastRoute: 0, layer: 0, maxStops: 9, position: 1, referenceElement: 1, routeLayerItemId: 1, searchProperties: 0, state: 3, unit: 1, useDefaultRouteLayer: 5 };
  }
  static {
