import { IField, SupportedLayer, WebBoxPlot, WebChart, WebChartDataFilters, WebChartDataItem, WebChartDataItemValue, WebChartDataTypes, WebChartPieChartSlice, WebChartQuery, WebGaugeChart } from '@arcgis/charts-spec';
...
import { AbortControllerKeyType, ActionModes, BinnedServerData, ChartElementLimit, CommonStrings, CursorRange, ErrorStrings, LoaderColors, QueryObject, SelectionData, SelectionTheme } from '../../utils';
export declare const uuidNamespace: string;
export interface NotifyOptions {
    closable?: boolean;
}
export type AnyConfigType = WebBoxPlot | WebChart | WebGaugeChart;
...
export interface UpdateChartProps {
    newChartConfig?: WebChart | WebGaugeChart;
...
export interface ChartOptions {
     ...
     * `unit` and `size` become optional and will be automatically set to values that fit the data set.
     *
     * @default false
     */
