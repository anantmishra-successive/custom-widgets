...
export declare const WebChartStatisticType: {
    ...
    readonly ContinuousPercentile: "percentile-continuous";
    readonly DiscretePercentile: "percentile-discrete";
...
export type WebChartStatisticType = (typeof WebChartStatisticType)[keyof typeof WebChartStatisticType];
 ...
 */
export declare const WebChartTemporalBinningTypes: {
    readonly FixedDateBased: "fixedDateBased";
    readonly CalendarBased: "calendarBased";
};
export type WebChartTemporalBinningTypes = (typeof WebChartTemporalBinningTypes)[keyof typeof WebChartTemporalBinningTypes];
/**
 * The temporal binning units
 */
export declare const WebChartTemporalBinningUnits: {
...
export type WebChartTemporalBinningUnits = (typeof WebChartTemporalBinningUnits)[keyof typeof WebChartTemporalBinningUnits];
/**
 * The temporal binning units for fixed-date based binning
 */
export declare const WebChartFixedDateBinningUnits: {
    readonly Second: "seconds";
    readonly Minute: "minutes";
    readonly Hour: "hours";
    readonly Day: "days";
...
export type WebChartFixedDateBinningUnits = (typeof WebChartFixedDateBinningUnits)[keyof typeof WebChartFixedDateBinningUnits];
/**
 * The temporal binning units for calendar based binning
 */
export declare const WebChartCalendarBinningUnits: {
    readonly Second: "seconds";
    readonly Minute: "minutes";
    readonly Hour: "hours";
    readonly Day: "days";
...
export type WebChartCalendarBinningUnits = (typeof WebChartCalendarBinningUnits)[keyof typeof WebChartCalendarBinningUnits];
/**
 * The temporal binning units for the calendar based binning offset
 */
export declare const WebChartCalendarBinningOffsetUnits: {
    readonly Second: "seconds";
    readonly Minute: "minutes";
    readonly Hour: "hours";
    readonly Day: "days";
};
export type WebChartCalendarBinningOffsetUnits = (typeof WebChartCalendarBinningOffsetUnits)[keyof typeof WebChartCalendarBinningOffsetUnits];
/**
