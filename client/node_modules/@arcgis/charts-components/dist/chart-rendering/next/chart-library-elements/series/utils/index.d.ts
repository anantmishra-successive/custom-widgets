import { Chart, Graphics, Series } from '@amcharts/amcharts5';
import { Axis, AxisRenderer, ColumnSeries, LineSeries, XYChart } from '@amcharts/amcharts5/xy.js';
import { IField, WebChart, WebChartBarChartSeries, WebChartDataTypes, WebChartLineChartSeries, WebChartRadarChartSeries, WebChartSeriesType, WebChartTypes } from '@arcgis/charts-spec';
import { SubtypeInfo } from '../../../../../utils';
import { DataUpdateNeededDetails } from '../../../../common/data/utils/misc/interfaces';
import { ApplySelectionOnSeriesProps } from '../../../selection/apply/interfaces';
import { StyleCallbackProps, UpdateSeriesProps } from '../interfaces';
/**
...
/**
 * Determines whether styling is needed for a series.
 *
 * @param props.chartConfig The chart configuration
 * @param props.seriesWereReinitialized Whether the series were reinitialized
 * @param props.dataWasUpdated Whether the data was updated
 * @param props.colorMatchChanged Whether the color match changed
 * @param props.seriesStyleChanged Whether the series style changed
 * @param props.sortChanged Whether the sort changed
 * @returns True if styling is needed, false otherwise
 */
export declare function isStylingNeeded(props: UpdateSeriesProps<WebChartDataTypes, WebChart>): boolean;
/**
 ...
 * @param props.seriesFilteredOut Whether any series was filtered out
 */
 ...
 */
export declare function findSeriesConfig(seriesInstance: Series, chartConfig?: WebChart): {
    seriesConfig: WebChartSeriesType | undefined;
    seriesIndex: number | undefined;
};
/**
 * Adds logic to a marker to hide it when renderer outside of its container
 * @param bulletSprite The marker
 * @param markerSeries The marker series
 */
export declare function hideOutOfTheContainerMarker(bulletSprite: Graphics, markerSeries: LineSeries): void;
/**
