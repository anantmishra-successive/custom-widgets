import { WebChart, WebChartSeriesType, RESTSymbolType, WebChartTypes, WebChartVersionStatus } from '@arcgis/charts-spec';
import { ChartSubType } from '../../misc/interfaces';
import { WebChartSeriesSupportingTemporalBinning } from './interfaces';
/**
 ...
 */
export declare function getSeriesReference(chartConfig: WebChart): WebChartSeriesType;
/**
...
/**
 * Indicates whether a series supports temporal binning.
 * @param series The series to test
 */
export declare function doesSeriesSupportTemporalBinning(series: WebChartSeriesType): series is WebChartSeriesSupportingTemporalBinning;
