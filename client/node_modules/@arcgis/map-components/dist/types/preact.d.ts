...
interface PreactArcgisAreaMeasurement3d extends Partial<Pick<ArcgisAreaMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisAreaMeasurement3dElement> {
...
interface PreactArcgisBasemapGallery extends Partial<Pick<ArcgisBasemapGallery, 'activeBasemap' | 'autoDestroyDisabled' | 'disabled' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'source'>>, PreactJsx.HTMLAttributes<HTMLArcgisBasemapGalleryElement> {
...
interface PreactArcgisCompass extends Partial<Pick<ArcgisCompass, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisCompassElement> {
...
interface PreactArcgisDirections extends Partial<Pick<ArcgisDirections, 'apiKey' | 'autoDestroyDisabled' | 'goToOverride' | 'headingLevel' | 'hideLayerDetails' | 'hideSaveAsButton' | 'hideSaveButton' | 'icon' | 'label' | 'layer' | 'maxStops' | 'position' | 'referenceElement' | 'routeLayerItemId' | 'searchProperties' | 'unit' | 'useDefaultRouteLayer'>>, PreactJsx.HTMLAttributes<HTMLArcgisDirectionsElement> {
...
interface PreactArcgisDirectLineMeasurement3d extends Partial<Pick<ArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisDirectLineMeasurement3dElement> {
...
interface PreactArcgisDirectlineMeasurement3d extends Partial<Pick<DeprecatedArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisDirectlineMeasurement3dElement> {
  onarcgisPropertyChange?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisPropertyChange"]>;
  onarcgisReady?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisReady"]>;
}

interface PreactArcgisDistanceMeasurement2d extends Partial<Pick<ArcgisDistanceMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisDistanceMeasurement2dElement> {
...
interface PreactArcgisFullscreen extends Partial<Pick<ArcgisFullscreen, 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, ArcgisFullscreenSetterTypes, PreactJsx.HTMLAttributes<HTMLArcgisFullscreenElement> {
...
interface PreactArcgisGridControls extends Partial<Pick<ArcgisGridControls, 'autoDestroyDisabled' | 'customColor' | 'dynamicScaling' | 'gridColor' | 'hideColorSelection' | 'hideDynamicScaleToggle' | 'hideGridEnabledToggle' | 'hideGridSnapEnabledToggle' | 'hideLineIntervalInput' | 'hideNumericInputs' | 'hideOutOfScaleWarning' | 'hidePlacementButtons' | 'hideRotateWithMapToggle' | 'icon' | 'interactivePlacementState' | 'label' | 'majorLineInterval' | 'messageOverrides' | 'placementDisabled' | 'position' | 'referenceElement' | 'rotateWithMap' | 'rotation' | 'snappingEnabled' | 'snappingOptions' | 'spacing' | 'theme' | 'unit'>>, PreactJsx.HTMLAttributes<HTMLArcgisGridControlsElement> {
...
interface PreactArcgisHistogramRangeSlider extends Partial<Pick<ArcgisHistogramRangeSlider, 'autoDestroyDisabled' | 'average' | 'barCreatedFunction' | 'bins' | 'dataLineCreatedFunction' | 'dataLines' | 'icon' | 'label' | 'labelFormatFunction' | 'max' | 'min' | 'position' | 'precision' | 'rangeType' | 'referenceElement' | 'standardDeviation' | 'standardDeviationCount' | 'values'>>, ArcgisHistogramRangeSliderSetterTypes, PreactJsx.HTMLAttributes<HTMLArcgisHistogramRangeSliderElement> {
...
interface PreactArcgisLineOfSight extends Partial<Pick<ArcgisLineOfSight, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisLineOfSightElement> {
...
interface PreactArcgisLinkChartLayoutSwitcher extends Partial<Pick<ArcgisLinkChartLayoutSwitcher, 'appearance' | 'autoDestroyDisabled' | 'closeOnSelectDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'preventExtentUpdate' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisLinkChartLayoutSwitcherElement> {
...
interface PreactArcgisLocate extends Partial<Pick<ArcgisLocate, 'autoDestroyDisabled' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'popupDisabled' | 'position' | 'referenceElement' | 'scale' | 'state'>>, PreactJsx.HTMLAttributes<HTMLArcgisLocateElement> {
...
interface PreactArcgisNavigationToggle extends Partial<Pick<ArcgisNavigationToggle, 'icon' | 'label' | 'layout' | 'messageOverrides' | 'navigationMode' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisNavigationToggleElement> {
...
interface PreactArcgisPrint extends Partial<Pick<ArcgisPrint, 'allowedFormats' | 'allowedFormatsForSaving' | 'allowedLayouts' | 'autoDestroyDisabled' | 'browseTemplateButtonOnClick' | 'excludeDefaultTemplates' | 'excludeOrganizationTemplates' | 'exportedLinks' | 'extraParameters' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'outSpatialReference' | 'portal' | 'position' | 'printServiceUrl' | 'referenceElement' | 'saveAsButtonCallback' | 'showPrintAreaEnabled' | 'templateCustomTextElements' | 'templateOptions'>>, PreactJsx.HTMLAttributes<HTMLArcgisPrintElement> {
...
interface PreactArcgisScene extends Partial<Pick<ArcgisScene, 'alphaCompositingEnabled' | 'analyses' | 'autoDestroyDisabled' | 'basemap' | 'basemapView' | 'camera' | 'cameraFov' | 'cameraHeading' | 'cameraPosition' | 'cameraTilt' | 'clippingArea' | 'constraints' | 'displayFilterDisabled' | 'environment' | 'extent' | 'fatalError' | 'floors' | 'focusAreas' | 'graphics' | 'highlightOptions' | 'highlights' | 'itemId' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'qualityProfile' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'viewingMode' | 'viewpoint' | 'zoom'>>, ArcgisSceneSetterTypes, PreactJsx.HTMLAttributes<HTMLArcgisSceneElement> {
...
interface PreactArcgisSlice extends Partial<Pick<ArcgisSlice, 'analysis' | 'autoDestroyDisabled' | 'excludedLayers' | 'excludeGroundSurface' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'shape' | 'tiltEnabled'>>, PreactJsx.HTMLAttributes<HTMLArcgisSliceElement> {
...
interface PreactArcgisTimeZoneLabel extends Partial<Pick<ArcgisTimeZoneLabel, 'disabled' | 'expanded' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, ArcgisTimeZoneLabelSetterTypes, PreactJsx.HTMLAttributes<HTMLArcgisTimeZoneLabelElement> {
...
interface PreactArcgisTrack extends Partial<Pick<ArcgisTrack, 'autoDestroyDisabled' | 'error' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'positionFilterFunction' | 'referenceElement' | 'rotationDisabled' | 'scale'>>, PreactJsx.HTMLAttributes<HTMLArcgisTrackElement> {
...
interface PreactArcgisUtilityNetworkValidateTopology extends Partial<Pick<ArcgisUtilityNetworkValidateTopology, 'autoDestroyDisabled' | 'extentToValidate' | 'icon' | 'label' | 'position' | 'referenceElement' | 'utilityNetwork'>>, PreactJsx.HTMLAttributes<HTMLArcgisUtilityNetworkValidateTopologyElement> {
...
interface PreactArcgisVersionManagement extends Partial<Pick<ArcgisVersionManagement, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'initialVersionInfos' | 'label' | 'messageOverrides' | 'mode' | 'pageSize' | 'position' | 'referenceElement' | 'versioningStates'>>, PreactJsx.HTMLAttributes<HTMLArcgisVersionManagementElement> {
...
interface PreactArcgisVideo extends Partial<Pick<ArcgisVideo, 'autoDestroyDisabled' | 'layer' | 'map'>>, PreactJsx.HTMLAttributes<HTMLArcgisVideoElement> {
  onarcgisViewReadyChange?: EventHandler<HTMLArcgisVideoElement["arcgisViewReadyChange"]>;
}

interface PreactArcgisVideoPlayer extends Partial<Pick<ArcgisVideoPlayer, 'autoDestroyDisabled' | 'followingMode' | 'hideHeader' | 'icon' | 'label' | 'layer' | 'messageOverrides' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisVideoPlayerElement> {
...
interface PreactArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, PreactJsx.HTMLAttributes<HTMLArcgisWeatherElement> {
...
interface PreactArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement' | 'state'>>, PreactJsx.HTMLAttributes<HTMLArcgisZoomElement> {
...
declare module 'preact' {
  namespace createElement.JSX {
    interface IntrinsicElements extends PreactJsx.IntrinsicElements {
      ...
      "arcgis-direct-line-measurement-3d": PreactArcgisDirectLineMeasurement3d;
      ...
      "arcgis-grid-controls": PreactArcgisGridControls;
      ...
      "arcgis-video": PreactArcgisVideo;
      "arcgis-video-player": PreactArcgisVideoPlayer;
