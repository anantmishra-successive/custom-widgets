...
const Hn = "Canceled";
function Mo(e) {
  return e instanceof Co ? !0 : e instanceof Error && e.name === Hn && e.message === Hn;
}
...
(function(e) {
  ...
  e.reduce = v;
  function* w(y, b, L = y.length) {
    for (b < 0 && (b += y.length), L < 0 ? L += y.length : L > y.length && (L = y.length); b < L; b++)
      yield y[b];
  }
  e.slice = w;
  function _(y, b = Number.POSITIVE_INFINITY) {
    const L = [];
    if (b === 0)
      return [L, y];
...
class Ht {
  ...
  add(t) {
    ...
    return this._isDisposed ? Ht.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t;
  }
  /**
...
(function(e) {
  ...
  function n(k) {
    return (R, I = null, T) => {
      ...
      return D = k((B) => {
        if (!P)
          return D ? D.dispose() : P = !0, R.call(I, B);
      }, null, T), P && D.dispose(), D;
    };
  }
  e.once = n;
  function r(k, R) {
    return e.once(e.filter(k, R));
  }
  e.onceIf = r;
  function i(k, R, I) {
    return h((T, P = null, D) => k((B) => T.call(P, R(B)), null, D), I);
  }
  e.map = i;
  function s(k, R, I) {
    return h((T, P = null, D) => k((B) => {
      R(B), T.call(P, B);
    }, null, D), I);
  }
  e.forEach = s;
  function a(k, R, I) {
    return h((T, P = null, D) => k((B) => R(B) && T.call(P, B), null, D), I);
  }
  e.filter = a;
  function l(k) {
    return k;
  ...
  function o(...k) {
    return (R, I = null, T) => {
      const P = Po(...k.map((D) => D((B) => R.call(I, B))));
      return c(P, T);
    };
  }
  e.any = o;
  ...
  function c(k, R) {
    return R instanceof Array ? R.push(k) : R && R.add(k), k;
  }
  function d(k, R, I = 100, T = !1, P = !1, D, B) {
    let j, ee, ot, Gt = 0, Rt;
    const So = {
      leakWarningThreshold: D,
      onWillAddFirstListener() {
        j = k((Ao) => {
          Gt++, ee = R(ee, Ao), T && !ot && (Jt.fire(ee), ee = void 0), Rt = () => {
            const ko = ee;
            ee = void 0, ot = void 0, (!T || Gt > 1) && Jt.fire(ko), Gt = 0;
          }, typeof I == "number" ? (clearTimeout(ot), ot = setTimeout(Rt, I)) : ot === void 0 && (ot = 0, queueMicrotask(Rt));
        });
      },
    ...
    return B?.add(Jt), Jt.event;
  }
  e.debounce = d;
  function m(k, R = 0, I) {
    return e.debounce(k, (T, P) => T ? (T.push(P), T) : [P], R, void 0, !0, void 0, I);
  }
  e.accumulate = m;
  function g(k, R = (T, P) => T === P, I) {
    let T = !0, P;
    return a(k, (D) => {
      const B = T || !R(D, P);
      return T = !1, P = D, B;
  ...
  e.split = p;
  function v(k, R = !1, I = [], T) {
    let P = I.slice(), D = k((ee) => {
      P ? P.push(ee) : j.fire(ee);
    });
    T && T.add(D);
    const B = () => {
      P?.forEach((ee) => j.fire(ee)), P = null;
    }, j = new _e({
      onWillAddFirstListener() {
        D || (D = k((ee) => j.fire(ee)), T && T.add(D));
      },
  ...
  class x {
    ...
    filter(R) {
      return this.steps.push((I) => R(I) ? I : _), this;
    }
    reduce(R, I) {
      let T = I;
  ...
  function y(k, R, I = (T) => T) {
    const T = (...j) => B.fire(I(...j)), P = () => k.on(R, T), D = () => k.removeListener(R, T), B = new _e({ onWillAddFirstListener: P, onDidRemoveLastListener: D });
    return B.event;
  }
  e.fromNodeEventEmitter = y;
  function b(k, R, I = (T) => T) {
    const T = (...j) => B.fire(I(...j)), P = () => k.addEventListener(R, T), D = () => k.removeEventListener(R, T), B = new _e({ onWillAddFirstListener: P, onDidRemoveLastListener: D });
    return B.event;
  }
  e.fromDOMEventEmitter = b;
  function L(k) {
    return new Promise((R) => n(k)(R));
  }
  e.toPromise = L;
  function S(k) {
    const R = new _e();
  ...
  class O {
    constructor(R, I) {
      ...
      this.emitter = new _e(T), I && I.add(this.emitter);
    }
    beginUpdate(R) {
      this._counter++;
    }
  ...
  function C(k, R) {
    return new O(k, R).emitter.event;
  }
  e.fromObservable = C;
  function N(k) {
    return (R, I, T) => {
      ...
      const B = {
        ...
        endUpdate() {
          P--, P === 0 && (k.reportChanges(), D && (D = !1, R.call(I)));
        },
      ...
      return T instanceof Ht ? T.add(j) : Array.isArray(T) && T.push(j), j;
    };
  }
...
class Tr {
  ...
  constructor(t, n, r = (Tr._idPool++).toString(16).padStart(3, "0")) {
...
class _e {
  constructor(t) {
    this._size = 0, this._options = t, this._leakageMon = this._options?.leakWarningThreshold ? new Tr(t?.onListenerError ?? Vt, this._options?.leakWarningThreshold ?? Vo) : void 0, this._perfMon = this._options?._profName ? new dn(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (t, n, r) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(l);
        const o = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], u = new Oo(`${l}. HINT: Stack shows most frequent listener (${o[1]}-times)`, o[0]);
        return (this._options?.onListenerError || Vt)(u), fn.None;
      }
      if (this._disposed)
        return fn.None;
      n && (t = t.bind(n));
      const i = new Tn(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (i.stack = Pr.create(), s = this._leakageMon.check(i.stack, this._size + 1)), this._listeners ? this._listeners instanceof Tn ? (this._deliveryQueue ??= new $o(), this._listeners = [this._listeners, i]) : this._listeners.push(i) : (this._options?.onWillAddFirstListener?.(this), this._listeners = i, this._options?.onDidAddFirstListener?.(this)), this._size++;
      const a = cn(() => {
        s?.(), this._removeListener(i);
      });
      return r instanceof Ht ? r.add(a) : Array.isArray(r) && r.push(a), a;
    }, this._event;
  }
  _removeListener(t) {
    ...
    if (this._size * Bo <= n.length) {
      ...
      for (let a = 0; a < n.length; a++)
        n[a] ? n[s++] = n[a] : i && (this._deliveryQueue.end--, s < this._deliveryQueue.i && this._deliveryQueue.i--);
      n.length = s;
    }
  }
  _deliver(t, n) {
    if (!t)
      return;
    const r = this._options?.onListenerError || Vt;
    if (!r) {
      t.value(n);
      return;
    }
   ...
   */
  fire(t) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof Tn)
...
const qo = Ba() === "pseudo" || typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function qr(e, t) {
  let n;
  ...
  }), qo && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function X(e, t, ...n) {
  return qr(typeof e == "number" ? jo(e, t) : t, n);
}
function jo(e, t) {
  const n = Uo()?.[e];
  if (typeof n != "string") {
...
const bt = "en";
let zn = !1, Gn = !1, Pn = !1, $a = !1, Ir = !1, Xt, In = bt, jr = bt, Wo, De;
const Oe = globalThis;
let ve;
typeof Oe.vscode < "u" && typeof Oe.vscode.process < "u" ? ve = Oe.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (ve = process);
const Ho = typeof ve?.versions?.electron == "string", zo = Ho && ve?.type === "renderer";
if (typeof ve == "object") {
  zn = ve.platform === "win32", Gn = ve.platform === "darwin", Pn = ve.platform === "linux", Pn && ve.env.SNAP && ve.env.SNAP_REVISION, ve.env.CI || ve.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Xt = bt, In = bt;
  const e = ve.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      Xt = t.userLocale, jr = t.osLocale, In = t.resolvedLanguage || bt, Wo = t.languagePack?.translationsConfigFile;
    } catch {
    }
  $a = !0;
} else typeof navigator == "object" && !zo ? (De = navigator.userAgent, zn = De.indexOf("Windows") >= 0, Gn = De.indexOf("Macintosh") >= 0, (De.indexOf("Macintosh") >= 0 || De.indexOf("iPad") >= 0 || De.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Pn = De.indexOf("Linux") >= 0, De?.indexOf("Mobi") >= 0, Ir = !0, In = Ba() || bt, Xt = navigator.language.toLowerCase(), jr = Xt) : console.error("Unable to resolve platform.");
const Bt = zn, Go = Gn, Jo = $a, Xo = Ir, Qo = Ir && typeof Oe.importScripts == "function", Yo = Qo ? Oe.origin : void 0, Fe = De, Zo = typeof Oe.postMessage == "function" && !Oe.importScripts;
(() => {
  if (Zo) {
    const e = [];
...
const Ko = !!(Fe && Fe.indexOf("Chrome") >= 0);
Fe && Fe.indexOf("Firefox") >= 0;
!Ko && Fe && Fe.indexOf("Safari") >= 0;
Fe && Fe.indexOf("Edg/") >= 0;
...
class Ye {
  ...
  static {
    this._locales = new Wr(() => Object.keys(Ye.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
  }
  static getLocales() {
...
class nt {
  ...
  static getData() {
    return this._data || (this._data = new Set(nt.getRawData())), this._data;
  }
  static isInvisibleCharacter(t) {
    return nt.getData().has(t);
  }
...
if (typeof Fn < "u" && typeof Fn.process < "u") {
...
} else typeof process < "u" && typeof process?.versions?.node == "string" ? xt = {
  get platform() {
  ...
  // Supported
  get platform() {
    return Bt ? "win32" : Go ? "darwin" : "linux";
  },
  get arch() {
  },
  // Unsupported
...
const gn = xt.cwd, ul = xt.env, cl = xt.platform, fl = 65, hl = 97, dl = 90, ml = 122, Ke = 46, le = 47, de = 92, je = 58, gl = 63;
...
function pl(e, t) {
  if (e === null || typeof e != "object")
    throw new ja(t, "Object", e);
}
function Z(e, t) {
  if (typeof e != "string")
    throw new ja(t, "string", e);
}
const qe = cl === "win32";
function U(e) {
  return e === le || e === de;
...
const fe = {
  ...
  resolve(...e) {
    ...
    for (let i = e.length - 1; i >= -1; i--) {
      let s;
      if (i >= 0) {
        if (s = e[i], Z(s, `paths[${i}]`), s.length === 0)
          continue;
      } else t.length === 0 ? s = gn() : (s = ul[`=${t}`] || gn(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === de) && (s = `${t}\\`));
      const a = s.length;
      let l = 0, o = "", u = !1;
      ...
      if (a === 1)
        ...
        if (u = !0, U(s.charCodeAt(1))) {
          let c = 2, d = c;
          for (; c < a && !U(s.charCodeAt(c)); )
            c++;
          if (c < a && c !== d) {
            const m = s.slice(d, c);
            for (d = c; c < a && U(s.charCodeAt(c)); )
              c++;
            if (c < a && c !== d) {
              for (d = c; c < a && !U(s.charCodeAt(c)); )
                c++;
          ...
          l = 1;
      else We(h) && s.charCodeAt(1) === je && (o = s.slice(0, 2), l = 2, a > 2 && U(s.charCodeAt(2)) && (u = !0, l = 3));
      if (o.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (U(s))
      if (i = !0, U(e.charCodeAt(1))) {
        let l = 2, o = l;
        for (; l < t && !U(e.charCodeAt(l)); )
          l++;
        if (l < t && l !== o) {
          const u = e.slice(o, l);
          for (o = l; l < t && U(e.charCodeAt(l)); )
            l++;
          if (l < t && l !== o) {
            for (o = l; l < t && !U(e.charCodeAt(l)); )
              l++;
        ...
        n = 1;
    else We(s) && e.charCodeAt(1) === je && (r = e.slice(0, 2), n = 2, t > 2 && U(e.charCodeAt(2)) && (i = !0, n = 3));
    let a = n < t ? pn(e.slice(n), !i, "\\", U) : "";
    return a.length === 0 && !i && (a = "."), a.length > 0 && U(e.charCodeAt(t - 1)) && (a += "\\"), r === void 0 ? i ? `\\${a}` : a : i ? `${r}\\${a}` : `${r}${a}`;
  },
  isAbsolute(e) {
    Z(e, "path");
    const t = e.length;
    ...
    t > 2 && We(n) && e.charCodeAt(1) === je && U(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let s = 0; s < e.length; ++s) {
      const a = e[s];
      Z(a, "path"), a.length > 0 && (t === void 0 ? t = n = a : t += `\\${a}`);
    }
    if (t === void 0)
      return ".";
    let r = !0, i = 0;
  ...
  relative(e, t) {
    ...
    if (d !== h) {
      ...
      if (u > h) {
        if (t.charCodeAt(l + d) === de)
          return r.slice(l + d + 1);
        if (d === 2)
          return r.slice(l + d);
      }
      a > h && (e.charCodeAt(i + d) === de ? c = d : d === 2 && (c = 3)), c === -1 && (c = 0);
    }
    let m = "";
    for (d = i + c + 1; d <= s; ++d)
      (d === s || e.charCodeAt(d) === de) && (m += m.length === 0 ? ".." : "\\..");
    return l += c, m.length > 0 ? `${m}${r.slice(l, o)}` : (r.charCodeAt(l) === de && ++l, r.slice(l, o));
  },
  toNamespacedPath(e) {
    ...
    } else if (We(t.charCodeAt(0)) && t.charCodeAt(1) === je && t.charCodeAt(2) === de)
      return `\\\\?\\${t}`;
    return e;
  },
  dirname(e) {
    ...
    } else We(i) && e.charCodeAt(1) === je && (n = t > 2 && U(e.charCodeAt(2)) ? 3 : 2, r = n);
    let s = -1, a = !0;
    for (let l = t - 1; l >= r; --l)
      if (U(e.charCodeAt(l))) {
        if (!a) {
  ...
  basename(e, t) {
    ...
    let n = 0, r = -1, i = !0, s;
    if (e.length >= 2 && We(e.charCodeAt(0)) && e.charCodeAt(1) === je && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === je && We(e.charCodeAt(0)) && (t = r = 2);
  ...
  parse(e) {
    ...
    if (U(i)) {
      if (r = 1, U(e.charCodeAt(1))) {
        let c = 2, d = c;
        for (; c < n && !U(e.charCodeAt(c)); )
          c++;
        if (c < n && c !== d) {
          for (d = c; c < n && U(e.charCodeAt(c)); )
            c++;
          if (c < n && c !== d) {
            for (d = c; c < n && !U(e.charCodeAt(c)); )
              c++;
    ...
    } else if (We(i) && e.charCodeAt(1) === je) {
      if (n <= 2)
  ...
  resolve(...e) {
    ...
    for (let r = e.length - 1; r >= -1 && !n; r--) {
      const i = r >= 0 ? e[r] : vl();
      Z(i, `paths[${r}]`), i.length !== 0 && (t = `${i}/${t}`, n = i.charCodeAt(0) === le);
    }
    return t = pn(t, !n, "/", Xn), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (Z(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === le, n = e.charCodeAt(e.length - 1) === le;
    return e = pn(e, !t, "/", Xn), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
    return Z(e, "path"), e.length > 0 && e.charCodeAt(0) === le;
  },
  join(...e) {
    if (e.length === 0)
      return ".";
  ...
  relative(e, t) {
    if (Z(e, "from"), Z(t, "to"), e === t || (e = he.resolve(e), t = he.resolve(t), e === t))
      return "";
    ...
    if (u === l)
      if (a > l) {
        ...
        if (u === 0)
          return t.slice(s + u);
      } else i > l && (e.charCodeAt(n + u) === le ? o = u : u === 0 && (o = 0));
    let h = "";
    for (u = n + o + 1; u <= r; ++u)
  ...
  extname(e) {
    ...
    for (let a = e.length - 1; a >= 0; --a) {
      ...
      r === -1 && (i = !1, r = a + 1), l === Ke ? t === -1 ? t = a : s !== 1 && (s = 1) : t !== -1 && (s = -1);
    }
...
he.win32 = fe.win32 = fe;
he.posix = fe.posix = he;
qe ? fe.normalize : he.normalize;
const xl = qe ? fe.join : he.join;
qe ? fe.resolve : he.resolve;
qe ? fe.relative : he.relative;
qe ? fe.dirname : he.dirname;
qe ? fe.basename : he.basename;
qe ? fe.extname : he.extname;
qe ? fe.sep : he.sep;
const yl = /^\w[\w\d+.-]*$/, wl = /^\//, _l = /^\/\//;
function Ll(e, t) {
  if (!e.scheme && t)
    throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`);
  if (e.scheme && !yl.test(e.scheme))
    throw new Error("[UriError]: Scheme contains illegal characters.");
  if (e.path) {
    if (e.authority) {
      if (!wl.test(e.path))
        throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
    } else if (_l.test(e.path))
...
let Te = class en {
  static isUri(t) {
    return t instanceof en ? !0 : t ? typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function" : !1;
  }
  /**
   * @internal
   */
  constructor(t, n, r, i, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || G, this.authority = t.authority || G, this.path = t.path || G, this.query = t.query || G, this.fragment = t.fragment || G) : (this.scheme = Nl(t, a), this.authority = n || G, this.path = Sl(this.scheme, r || G), this.query = i || G, this.fragment = s || G, Ll(this, a));
  }
  // ---- filesystem path -----------------------
  /**
  ...
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = G), r === void 0 ? r = this.authority : r === null && (r = G), i === void 0 ? i = this.path : i === null && (i = G), s === void 0 ? s = this.query : s === null && (s = G), a === void 0 ? a = this.fragment : a === null && (a = G), n === this.scheme && r === this.authority && i === this.path && s === this.query && a === this.fragment ? this : new lt(n, r, i, s, a);
  }
  // ---- parse & validate ------------------------
  /**
  ...
  static parse(t, n = !1) {
    const r = Al.exec(t);
    return r ? new lt(r[2] || G, Qt(r[4] || G), Qt(r[5] || G), Qt(r[7] || G), Qt(r[9] || G), n) : new lt(G, G, G, G, G);
  }
  /**
  ...
  static joinPath(t, ...n) {
    ...
    let r;
    return Bt && t.scheme === "file" ? r = en.file(fe.join(Qn(t, !0), ...n)).path : r = he.join(t.path, ...n), t.with({ path: r });
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new lt(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === Ha ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
};
const Ha = Bt ? 1 : void 0;
class lt extends Te {
  constructor() {
  ...
  toString(t = !1) {
    return t ? Yn(this, !0) : (this._formatted || (this._formatted = Yn(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: 1
    ...
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = Ha), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const za = {
  58: "%3A",
...
function kl(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const r = e.charCodeAt(n);
    r === 35 || r === 63 ? (t === void 0 && (t = e.substr(0, n)), t += za[r]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function Qn(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === 47 && (e.path.charCodeAt(1) >= 65 && e.path.charCodeAt(1) <= 90 || e.path.charCodeAt(1) >= 97 && e.path.charCodeAt(1) <= 122) && e.path.charCodeAt(2) === 58 ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, Bt && (n = n.replace(/\//g, "\\")), n;
}
function Yn(e, t) {
  const n = t ? kl : Hr;
  ...
  return l && (r += "?", r += n(l, !1, !1)), o && (r += "#", r += t ? o : Hr(o, !1, !1)), r;
}
function Ga(e) {
  try {
    return decodeURIComponent(e);
  } catch {
    return e.length > 3 ? e.substr(0, 3) + Ga(e.substr(3)) : e;
  }
}
const zr = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function Qt(e) {
  return e.match(zr) ? e.replace(zr, (t) => Ga(t)) : e;
}
var Ze;
(function(e) {
...
class El {
  ...
  get _remoteResourcesPath() {
    return he.join(this._serverRootPath, Ze.vscodeRemoteResource);
  }
  rewrite(t) {
    if (this._delegate)
      try {
    ...
    return typeof s == "string" && (a += `&${Rl}=${encodeURIComponent(s)}`), Te.from({
      scheme: Xo ? this._preferredWebSchema : Ze.vscodeRemoteResource,
      authority: `${r}:${i}`,
...
class bn {
   ...
   */
  uriToBrowserUri(t) {
    return t.scheme === Ze.vscodeRemote ? Ml.rewrite(t) : (
      // ...only ever for `file` resources
      t.scheme === Ze.file && // ...and we run in native environments
      (Jo || // ...or web worker extensions on desktop
      Yo === `${Ze.vscodeFileResource}://${bn.FALLBACK_AUTHORITY}`) ? t.with({
        scheme: Ze.vscodeFileResource,
        // We need to provide an authority here so that it can serve
        // as origin for network and loading matters in chromium.
        // If the URI is not coming with an authority already, we
        // add our own
        authority: t.authority || bn.FALLBACK_AUTHORITY,
        query: null,
        fragment: null
      }) : t
    );
  ...
  toUri(t, n) {
    ...
    if (globalThis._VSCODE_FILE_ROOT) {
      ...
      if (/^\w[\w\d+.-]*:\/\//.test(r))
        return Te.joinPath(Te.parse(r, !0), t);
      const i = xl(r, t);
      return Te.file(i);
    }
    return Te.parse(n.toUrl(t));
  }
}
const Ja = new bn();
var Gr;
(function(e) {
  ...
  function r(s) {
    let a;
    typeof s == "string" ? a = new URL(s).searchParams : s instanceof URL ? a = s.searchParams : Te.isUri(s) && (a = new URL(s.toString(!0)).searchParams);
    const l = a?.get(n);
    if (l)
      return t.get(l);
  }
...
const Vn = "default", Tl = "$initialize";
class Pl {
...
class Dl {
  ...
  sendMessage(t, n, r) {
    ...
    return new Promise((s, a) => {
      this._pendingReplies[i] = {
        resolve: s,
        reject: a
      }, this._send(new Pl(this._workerId, i, t, n, r));
    });
  }
  listen(t, n, r) {
    let i = null;
    const s = new _e({
      onWillAddFirstListener: () => {
        i = String(++this._lastSentReq), this._pendingEmitters.set(i, s), this._send(new Il(this._workerId, i, t, n, r));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(i), this._send(new Vl(this._workerId, i)), i = null;
      }
    });
    return s.event;
  }
  ...
  createProxyToRemoteChannel(t, n) {
    const r = {
      get: (i, s) => (typeof s == "string" && !i[s] && (Qa(s) ? i[s] = (a) => this.listen(t, s, a) : Xa(s) ? i[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === 36 && (i[s] = async (...a) => (await n?.(), this.sendMessage(t, s, a)))), i[s])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((i) => {
      ...
      i.detail instanceof Error && (i.detail = Ur(i.detail)), this._send(new Jr(this._workerId, n, void 0, Ur(i)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, r = this._handler.handleEvent(t.channel, t.eventName, t.arg)((i) => {
      this._send(new Fl(this._workerId, n, i));
    });
...
class Ol {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new Dl({
      sendMessage: (r, i) => {
        t(r, i);
      },
  ...
  _handleMessage(t, n, r) {
    ...
    const i = t === Vn ? this._requestHandler : this._localChannels.get(t);
    if (!i)
  ...
  async initialize(t, n, r) {
    ...
    return n && (typeof n.baseUrl < "u" && delete n.baseUrl, typeof n.paths < "u" && typeof n.paths.vs < "u" && delete n.paths.vs, typeof n.trustedTypesPolicy < "u" && delete n.trustedTypesPolicy, n.catchError = !0, globalThis.require.config(n)), import(`${Ja.asBrowserUri(`${r}.js`).toString(!0)}`).then((s) => {
...
function Bl(e, t) {
  ...
  for (let n = 0, r = e.length; n < r; n++)
    t = Xr(e.charCodeAt(n), t);
  return t;
}
function Dn(e, t, n = 32) {
  const r = n - t, i = ~((1 << r) - 1);
  return (e << t | (i & e) >>> r) >>> 0;
}
function Qr(e, t = 0, n = e.byteLength, r = 0) {
  for (let i = 0; i < n; i++)
    e[t + i] = r;
}
function $l(e, t, n = "0") {
...
function Et(e, t = 32) {
  return e instanceof ArrayBuffer ? Array.from(new Uint8Array(e)).map((n) => n.toString(16).padStart(2, "0")).join("") : $l((e >>> 0).toString(16), t / 4);
}
class Ya {
  static {
  ...
  digest() {
    ...
    )), this._totalLen += this._buffLen, this._wrapUp()), Et(this._h0) + Et(this._h1) + Et(this._h2) + Et(this._h3) + Et(this._h4);
  }
  _wrapUp() {
  ...
  _step() {
    const t = Ya._bigBlock32, n = this._buffDV;
    for (let c = 0; c < 64; c += 4)
      t.setUint32(c, n.getUint32(c, !1), !1);
    for (let c = 64; c < 320; c += 4)
      t.setUint32(c, Dn(t.getUint32(c - 12, !1) ^ t.getUint32(c - 32, !1) ^ t.getUint32(c - 56, !1) ^ t.getUint32(c - 64, !1), 1), !1);
    let r = this._h0, i = this._h1, s = this._h2, a = this._h3, l = this._h4, o, u, h;
    for (let c = 0; c < 80; c++)
      c < 20 ? (o = i & s | ~i & a, u = 1518500249) : c < 40 ? (o = i ^ s ^ a, u = 1859775393) : c < 60 ? (o = i & s | i & a | s & a, u = 2400959708) : (o = i ^ s ^ a, u = 3395469782), h = Dn(r, 5) + o + l + u + t.getUint32(c * 4, !1) & 4294967295, l = a, a = s, s = Dn(i, 30), i = r, r = h;
...
function Ul(e, t, n) {
  return new Qe(new Yr(e), new Yr(t)).ComputeDiff(n).changes;
}
class ut {
  static Assert(t, n) {
    if (!t)
...
class Zr {
   ...
   */
  MarkNextChange() {
    (this.m_originalCount > 0 || this.m_modifiedCount > 0) && this.m_changes.push(new Ge(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount)), this.m_originalCount = 0, this.m_modifiedCount = 0, this.m_originalStart = 1073741824, this.m_modifiedStart = 1073741824;
  }
  /**
...
class Qe {
  ...
  constructor(t, n, r = null) {
    ...
    const [i, s, a] = Qe._getElements(t), [l, o, u] = Qe._getElements(n);
  ...
  ComputeDiffRecursive(t, n, r, i, s) {
    ...
    if (t > n || r > i) {
      let c;
      return r <= i ? (ut.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), c = [
        new Ge(t, 0, r, i - r + 1)
      ]) : t <= n ? (ut.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), c = [
        new Ge(t, n - t + 1, r, 0)
      ]) : (ut.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), ut.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), c = []), c;
    }
    ...
    if (!s[0]) {
      ...
      let d = [];
      return s[0] ? d = [
        new Ge(u + 1, n - (u + 1) + 1, h + 1, i - (h + 1) + 1)
      ] : d = this.ComputeDiffRecursive(u + 1, n, h + 1, i, s), this.ConcatenateChanges(c, d);
    }
    return [
      new Ge(t, n - t + 1, r, i - r + 1)
    ];
  }
  WALKTRACE(t, n, r, i, s, a, l, o, u, h, c, d, m, g, p, v, w, _) {
    let x = null, y = null, b = new Zr(), L = n, S = r, M = m[0] - v[0] - i, F = -1073741824, O = this.m_forwardHistory.length - 1;
    do {
      const C = M + t;
      C === L || C < S && u[C - 1] < u[C + 1] ? (c = u[C + 1], g = c - M - i, c < F && b.MarkNextChange(), F = c, b.AddModifiedElement(c + 1, g), M = C + 1 - t) : (c = u[C - 1] + 1, g = c - M - i, c < F && b.MarkNextChange(), F = c - 1, b.AddOriginalElement(c, g + 1), M = C - 1 - t), O >= 0 && (u = this.m_forwardHistory[O], t = u[0], L = 1, S = u.length - 1);
    } while (--O >= -1);
    if (x = b.getReverseChanges(), _[0]) {
      let C = m[0] + 1, N = v[0] + 1;
      if (x !== null && x.length > 0) {
        const k = x[x.length - 1];
        C = Math.max(C, k.getOriginalEnd()), N = Math.max(N, k.getModifiedEnd());
      }
      y = [
        new Ge(C, d - C + 1, N, p - N + 1)
      ];
    } else {
      b = new Zr(), L = a, S = l, M = m[0] - v[0] - o, F = 1073741824, O = w ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const C = M + s;
        C === L || C < S && h[C - 1] >= h[C + 1] ? (c = h[C + 1] - 1, g = c - M - o, c > F && b.MarkNextChange(), F = c + 1, b.AddOriginalElement(c + 1, g + 1), M = C + 1 - s) : (c = h[C - 1], g = c - M - o, c > F && b.MarkNextChange(), F = c, b.AddModifiedElement(c + 1, g + 1), M = C - 1 - s), O >= 0 && (h = this.m_reverseHistory[O], s = h[0], L = 1, S = h.length - 1);
      } while (--O >= -1);
      y = b.getChanges();
    }
    return this.ConcatenateChanges(x, y);
  }
  /**
  ...
  ComputeRecursionPoint(t, n, r, i, s, a, l) {
    ...
    const g = n - t + (i - r), p = g + 1, v = new Int32Array(p), w = new Int32Array(p), _ = i - r, x = n - t, y = t - r, b = n - i, S = (x - _) % 2 === 0;
    v[_] = t, w[x] = n, l[0] = !1;
    for (let M = 1; M <= g / 2 + 1; M++) {
      let F = 0, O = 0;
      h = this.ClipDiagonalBound(_ - M, M, _, p), c = this.ClipDiagonalBound(_ + M, M, _, p);
      for (let N = h; N <= c; N += 2) {
        N === h || N < c && v[N - 1] < v[N + 1] ? o = v[N + 1] : o = v[N - 1] + 1, u = o - (N - _) - y;
        const k = o;
        for (; o < n && u < i && this.ElementsAreEqual(o + 1, u + 1); )
          o++, u++;
        if (v[N] = o, o + u > F + O && (F = o, O = u), !S && Math.abs(N - x) <= M - 1 && o >= w[N])
          return s[0] = o, a[0] = u, k <= w[N] && M <= 1448 ? this.WALKTRACE(_, h, c, y, x, d, m, b, v, w, o, n, s, u, i, a, S, l) : null;
      }
      const C = (F - t + (O - r) - M) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(F, C))
        return l[0] = !0, s[0] = F, a[0] = O, C > 0 && M <= 1448 ? this.WALKTRACE(_, h, c, y, x, d, m, b, v, w, o, n, s, u, i, a, S, l) : (t++, r++, [
          new Ge(t, n - t + 1, r, i - r + 1)
        ]);
      d = this.ClipDiagonalBound(x - M, M, x, p), m = this.ClipDiagonalBound(x + M, M, x, p);
      for (let N = d; N <= m; N += 2) {
        N === d || N < m && w[N - 1] >= w[N + 1] ? o = w[N + 1] - 1 : o = w[N - 1], u = o - (N - x) - b;
        const k = o;
        for (; o > t && u > r && this.ElementsAreEqual(o, u); )
          o--, u--;
        if (w[N] = o, S && Math.abs(N - _) <= M && o <= v[N])
          return s[0] = o, a[0] = u, k >= v[N] && M <= 1448 ? this.WALKTRACE(_, h, c, y, x, d, m, b, v, w, o, n, s, u, i, a, S, l) : null;
      }
      if (M <= 1447) {
        let N = new Int32Array(c - h + 2);
        N[0] = _ - h + 1, ct.Copy2(v, h, N, 1, c - h + 1), this.m_forwardHistory.push(N), N = new Int32Array(m - d + 2), N[0] = x - d + 1, ct.Copy2(w, d, N, 1, m - d + 1), this.m_reverseHistory.push(N);
      }
    }
    return this.WALKTRACE(_, h, c, y, x, d, m, b, v, w, o, n, s, u, i, a, S, l);
  }
  /**
  ...
  ChangesOverlap(t, n, r) {
    if (ut.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), ut.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart), r[0] = new Ge(i, s, a, l), !0;
    } else
      return r[0] = null, !1;
  }
  /**
...
let K = class tt {
  ...
  static intersectRanges(t, n) {
    ...
    return r < l ? (r = l, i = o) : r === l && (i = Math.max(i, o)), s > u ? (s = u, a = h) : s === u && (a = Math.min(a, h)), r > s || r === s && i > a ? null : new ne(r, i, s, a);
  }
  /**
...
class Fr {
  constructor(t) {
    const n = Kr(t);
    this._defaultValue = n, this._asciiMap = Fr._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
  }
      ...
      for (; u < o; ) {
        ...
        if (d === 13) {
          ...
          switch (_) {
            ...
            case 34:
            case 96:
              c === _ ? x = 1 : c === 39 || c === 34 || c === 96 ? x = 0 : x = 1;
              break;
            case 42:
              x = c === 42 ? 1 : 0;
              break;
          ...
          x === 1 && (i.push(vn._createLink(r, l, s, h, u)), w = !0);
        } else if (d === 12) {
          let x;
          _ === 91 ? (g = !0, x = 0) : x = r.get(_), x === 1 ? w = !0 : d = 13;
        } else
          d = n.nextState(d, _), d === 0 && (w = !0);
        w && (d = 1, m = !1, g = !1, v = !1, h = u + 1, c = _), u++;
      }
      d === 13 && i.push(vn._createLink(r, l, s, h, o));
    }
    return i;
  }
}
...
const Za = Object.freeze(function(e, t) {
...
class tn {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? Za : (this._emitter || (this._emitter = new _e()), this._emitter.event);
  }
  dispose() {
...
class Gl {
  ...
  cancel() {
    this._token ? this._token instanceof tn && this._token.cancel() : this._token = xn.Cancelled;
  }
  dispose(t = !1) {
    t && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof tn && this._token.dispose() : this._token = xn.None;
  }
}
class Dr {
  constructor() {
...
const nn = new Dr(), Zn = new Dr(), Kn = new Dr(), Jl = new Array(230), Xl = /* @__PURE__ */ Object.create(null), Ql = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const i of t) {
    ...
    if (r[a] || (r[a] = !0, Xl[l] = a, Ql[l.toLowerCase()] = a), !n[o]) {
      if (n[o] = !0, !u)
        throw new Error(`String representation missing for key code ${o} around scan code ${l}`);
      nn.define(o, u), Zn.define(o, d || u), Kn.define(o, m || d || u);
    }
    h && (Jl[h] = o);
  }
})();
...
(function(e) {
  ...
  function s(l) {
    return Zn.strToKeyCode(l) || Kn.strToKeyCode(l);
  }
...
class pe extends z {
   ...
   */
  equalsSelection(t) {
    return pe.selectionsEqual(this, t);
  }
  /**
   ...
   */
  setEndPosition(t, n) {
    return this.getDirection() === 0 ? new pe(this.startLineNumber, this.startColumn, t, n) : new pe(t, n, this.startLineNumber, this.startColumn);
  }
  /**
  ...
  */
   ...
   */
  setStartPosition(t, n) {
    return this.getDirection() === 0 ? new pe(t, n, this.endLineNumber, this.endColumn) : new pe(this.endLineNumber, this.endColumn, t, n);
  }
  // ----
  /**
  ...
  static fromRange(t, n) {
    return n === 0 ? new pe(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn) : new pe(t.endLineNumber, t.endColumn, t.startLineNumber, t.startColumn);
  }
  /**
   * Create a `Selection` from an `ISelection`.
   */
  static liftSelection(t) {
    return new pe(t.selectionStartLineNumber, t.selectionStartColumn, t.positionLineNumber, t.positionColumn);
  }
  /**
   * `a` equals `b`.
   */
  ...
  static createWithDirection(t, n, r, i, s) {
    return s === 0 ? new pe(t, n, r, i) : new pe(r, i, t, n);
  }
}
function Zl(e) {
...
class Ka {
  ...
  register(t, n) {
    return this._tokenizationSupports.set(t, n), this.handleChange([t]), cn(() => {
  ...
  registerFactory(t, n) {
    ...
    const r = new tu(this, t, n);
    return this._factories.set(t, r), cn(() => {
...
class yn {
  ...
  static getChannel(t) {
    return t.getChannel(yn.CHANNEL_NAME);
  }
  static setChannel(t, n) {
    t.setChannel(yn.CHANNEL_NAME, n);
  }
}
var ns;
class su {
  constructor() {
    this[ns] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
  }
  clear() {
...
function du(e, t, n, r, i) {
  return fu(e, t, n, r, i) && hu(e, t, n, r, i);
}
class mu {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (i === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          al(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = i, this._prevMatchLength = s, !this._wordSeparators || du(this._wordSeparators, t, n, i, s))
        return r;
    } while (r);
    return null;
  }
}
function gu(e, t = "Unreachable") {
  throw new Error(t);
}
function wn(e) {
  if (!e()) {
    debugger;
    e(), Vt(new ye("Assertion Failed"));
  }
}
function eo(e, t) {
  let n = 0;
...
function Or(e, t, n, r, i) {
  if (t = no(t), i || (i = un.first(ro)), n.length > i.maxLen) {
    let u = e - i.maxLen / 2;
...
class xu {
  static computeUnicodeHighlights(t, n, r) {
    const i = r ? r.startLineNumber : 1, s = r ? r.endLineNumber : t.getLineCount(), a = new os(n), l = a.getCandidateCodePoints();
    let o;
    l === "allNonBasicAscii" ? o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${yu(Array.from(l))}`, "g");
    const u = new mu(null, o), h = [];
    let c = !1, d, m = 0, g = 0, p = 0;
    e: for (let v = i, w = s; v <= w; v++) {
      ...
      do
        if (d = u.next(_), d) {
          ...
          if (y > 0) {
            const F = _.charCodeAt(y - 1);
            mn(F) && y--;
          }
          if (b + 1 < x) {
            const F = _.charCodeAt(b - 1);
            mn(F) && b++;
          }
          const L = _.substring(y, b);
          let S = Or(y + 1, to, _, 0);
          S && S.endColumn <= y + 1 && (S = null);
          const M = a.shouldHighlightNonBasicASCII(L, S ? S.word : null);
          if (M !== 0) {
            if (M === 3 ? m++ : M === 2 ? g++ : M === 1 ? p++ : gu(), h.length >= 1e3) {
              c = !0;
              break e;
            }
            h.push(new z(v, y + 1, v, b + 1));
          }
        }
      while (d);
    }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (r.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 3: {
        const s = t.codePointAt(0), a = r.ambiguousCharacters.getPrimaryConfusable(s), l = Ye.getLocales().filter((o) => !Ye.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, o])).isAmbiguous(s));
...
function yu(e, t) {
  return `[${nl(e.map((r) => String.fromCodePoint(r)).join(""))}]`;
}
class os {
  constructor(t) {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of nt.codePoints)
        ls(String.fromCodePoint(n)) || t.add(n);
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const a of n) {
        const l = a.codePointAt(0), o = ll(a);
        i = i || o, !o && !this.ambiguousCharacters.isAmbiguous(l) && !nt.isInvisibleCharacter(l) && (s = !0);
      }
    return (
      /* Don't allow mixing weird looking characters with ASCII */
      !i && /* Is there an obviously weird looking character? */
      s ? 0 : this.options.invisibleCharacters && !ls(t) && nt.isInvisibleCharacter(r) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(r) ? 3 : 0
    );
  }
}
function ls(e) {
...
class $ {
  static fromRangeInclusive(t) {
    return new $(t.startLineNumber, t.endLineNumber + 1);
  }
  /**
  ...
  constructor(t, n) {
    if (t > n)
      throw new ye(`startLineNumber ${t} cannot be after endLineNumberExclusive ${n}`);
   ...
   */
  delta(t) {
    return new $(this.startLineNumber + t, this.endLineNumberExclusive + t);
  }
  deltaLength(t) {
    return new $(this.startLineNumber, this.endLineNumberExclusive + t);
  }
  /**
   ...
   */
  join(t) {
    return new $(Math.min(this.startLineNumber, t.startLineNumber), Math.max(this.endLineNumberExclusive, t.endLineNumberExclusive));
  }
  toString() {
    return `[${this.startLineNumber},${this.endLineNumberExclusive})`;
  }
...
class Pe {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = ir(this._normalizedRanges, (i) => i.endLineNumberExclusive >= t.startLineNumber), r = $t(this._normalizedRanges, (i) => i.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === r)
   ...
   */
  subtractFrom(t) {
    const n = ir(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), r = $t(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === r)
      return new Pe([t]);
    const i = [];
    ...
    return s < t.endLineNumberExclusive && i.push(new $(s, t.endLineNumberExclusive)), new Pe(i);
  }
  toString() {
...
class pt {
  ...
  static betweenPositions(t, n) {
    return t.lineNumber === n.lineNumber ? new pt(0, n.column - t.column) : new pt(n.lineNumber - t.lineNumber, n.column - 1);
  }
  static ofRange(t) {
    return pt.betweenPositions(t.getStartPosition(), t.getEndPosition());
  }
  static ofText(t) {
    let n = 0, r = 0;
    for (const i of t)
...
class Ne {
  static inverse(t, n, r) {
    ...
    let s = 1, a = 1;
    for (const o of t) {
      const u = new Ne(new $(s, o.original.startLineNumber), new $(a, o.modified.startLineNumber));
      u.modified.isEmpty || i.push(u), s = o.original.endLineNumberExclusive, a = o.modified.endLineNumberExclusive;
    }
    const l = new Ne(new $(s, n + 1), new $(a, r + 1));
  ...
  */
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new ke(new z(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new z(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new ke(new z(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new z(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
  }
  /**
   * This method assumes that the LineRangeMapping describes a valid diff!
   * I.e. if one range is empty, the other range cannot be the entire document.
  ...
  */
  toRangeMapping2(t, n) {
    if (us(this.original.endLineNumberExclusive, t) && us(this.modified.endLineNumberExclusive, n))
      return new ke(new z(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new z(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new ke(z.fromPositions(new K(this.original.startLineNumber, 1), ht(new K(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), z.fromPositions(new K(this.modified.startLineNumber, 1), ht(new K(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new ke(z.fromPositions(ht(new K(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), ht(new K(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), z.fromPositions(ht(new K(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), ht(new K(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new ye();
  }
}
function ht(e, t) {
  ...
  if (e.lineNumber > t.length)
    return new K(t.length, t[t.length - 1].length + 1);
...
class Be extends Ne {
  static fromRangeMappings(t) {
    const n = $.join(t.map((i) => $.fromRangeInclusive(i.originalRange))), r = $.join(t.map((i) => $.fromRangeInclusive(i.modifiedRange)));
    return new Be(n, r, t);
  }
  constructor(t, n, r) {
  ...
  flip() {
    return new Be(this.modified, this.original, this.innerChanges?.map((t) => t.flip()));
  }
...
class Su {
  computeDiff(t, n, r) {
    ...
    for (const o of s.changes) {
      let u;
      o.originalEndLineNumber === 0 ? u = new $(o.originalStartLineNumber + 1, o.originalStartLineNumber + 1) : u = new $(o.originalStartLineNumber, o.originalEndLineNumber + 1);
      let h;
      o.modifiedEndLineNumber === 0 ? h = new $(o.modifiedStartLineNumber + 1, o.modifiedStartLineNumber + 1) : h = new $(o.modifiedStartLineNumber, o.modifiedEndLineNumber + 1);
      let c = new Be(u, h, o.charChanges?.map((d) => new ke(new z(d.originalStartLineNumber, d.originalStartColumn, d.originalEndLineNumber, d.originalEndColumn), new z(d.modifiedStartLineNumber, d.modifiedStartColumn, d.modifiedEndLineNumber, d.modifiedEndColumn))));
      l && (l.modified.endLineNumberExclusive === c.modified.startLineNumber || l.original.endLineNumberExclusive === c.original.startLineNumber) && (c = new Be(l.original.join(c.original), l.modified.join(c.modified), l.innerChanges && c.innerChanges ? l.innerChanges.concat(c.innerChanges) : void 0), a.pop()), a.push(c), l = c;
    }
    return wn(() => eo(a, (o, u) => u.original.startLineNumber - o.original.endLineNumberExclusive === u.modified.startLineNumber - o.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    o.original.endLineNumberExclusive < u.original.startLineNumber && o.modified.endLineNumberExclusive < u.modified.startLineNumber)), new rn(a, [], s.quitEarly);
  }
}
function io(e, t, n, r) {
...
function ku(e) {
  ...
  for (let r = 1, i = e.length; r < i; r++) {
    ...
    Math.min(a, l) < Nu ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
  }
  return t;
}
class Dt {
...
class Ru {
  ...
  computeDiff() {
    ...
    const t = io(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, r = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const l = [];
      for (let o = 0, u = n.length; o < u; o++)
        l.push(Dt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[o], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: r,
        changes: l
      };
        ...
        if (d !== m) {
          {
            ...
            for (; g > 1 && p > 1; ) {
              const v = d.charCodeAt(g - 2), w = m.charCodeAt(p - 2);
              if (v !== w)
                break;
              g--, p--;
            }
          ...
          {
            let g = ar(d, 1), p = ar(m, 1);
            const v = d.length + 1, w = m.length + 1;
            for (; g < v && p < w; ) {
              const _ = d.charCodeAt(g - 1), x = d.charCodeAt(p - 1);
              if (_ !== x)
                break;
              g++, p++;
            }
            (g < v || p < w) && this._pushTrimWhitespaceCharChange(i, s + 1, g, v, a + 1, p, w);
          }
        }
        s++, a++;
      }
      u && (i.push(Dt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, u, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += u.originalLength, a += u.modifiedLength);
    }
    return {
      quitEarly: r,
      changes: i
  ...
  _pushTrimWhitespaceCharChange(t, n, r, i, s, a, l) {
    if (this._mergeTrimWhitespaceCharChange(t, n, r, i, s, a, l))
      return;
    let o;
    this.shouldComputeCharChanges && (o = [new yt(n, r, n, i, s, a, s, l)]), t.push(new Dt(n, n, s, s, o));
  }
  _mergeTrimWhitespaceCharChange(t, n, r, i, s, a, l) {
    ...
    if (o === 0)
      return !1;
    const u = t[o - 1];
    return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0 ? !1 : u.originalEndLineNumber === n && u.modifiedEndLineNumber === s ? (this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new yt(n, r, n, i, s, a, s, l)), !0) : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === s ? (u.originalEndLineNumber = n, u.modifiedEndLineNumber = s, this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new yt(n, r, n, i, s, a, s, l)), !0) : !1;
  }
}
function sr(e, t) {
  const n = il(e);
...
class on {
  ...
  filter(t) {
    return new on((n) => this.iterate((r) => t(r) ? n(r) : !0));
  }
  map(t) {
    return new on((n) => this.iterate((r) => n(t(r))));
  }
  findLast(t) {
    let n;
...
class $e {
  static trivial(t, n) {
    return new $e([new Q(W.ofLength(t.length), W.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new $e([new Q(W.ofLength(t.length), W.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class Q {
  static invert(t, n) {
    const r = [];
    return Cu(t, (i, s) => {
      r.push(Q.fromOffsetPairs(i ? i.getEndExclusives() : Me.zero, s ? s.getStarts() : new Me(n, (i ? i.seq2Range.endExclusive - i.seq1Range.endExclusive : 0) + n)));
    }), r;
  }
  static fromOffsetPairs(t, n) {
    return new Q(new W(t.offset1, n.offset1), new W(t.offset2, n.offset2));
  }
  static assertSorted(t) {
    let n;
    for (const r of t) {
  ...
  join(t) {
    return new Q(this.seq1Range.join(t.seq1Range), this.seq2Range.join(t.seq2Range));
  }
  delta(t) {
    return t === 0 ? this : new Q(this.seq1Range.delta(t), this.seq2Range.delta(t));
  }
  deltaStart(t) {
    return t === 0 ? this : new Q(this.seq1Range.deltaStart(t), this.seq2Range.deltaStart(t));
  }
  deltaEnd(t) {
    return t === 0 ? this : new Q(this.seq1Range.deltaEnd(t), this.seq2Range.deltaEnd(t));
  }
  intersect(t) {
...
class Me {
  static {
    this.zero = new Me(0, 0);
  }
  static {
    this.max = new Me(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
  }
  constructor(t, n) {
...
class Vu {
  compute(t, n, r = zt.instance, i) {
    ...
    const s = new Bn(t.length, n.length), a = new Bn(t.length, n.length), l = new Bn(t.length, n.length);
    for (let g = 0; g < t.length; g++)
      for (let p = 0; p < n.length; p++) {
        if (!r.isValid())
          return $e.trivialTimedOut(t, n);
        const v = g === 0 ? 0 : s.get(g - 1, p), w = p === 0 ? 0 : s.get(g, p - 1);
        let _;
        t.getElement(g) === n.getElement(p) ? (g === 0 || p === 0 ? _ = 0 : _ = s.get(g - 1, p - 1), g > 0 && p > 0 && a.get(g - 1, p - 1) === 3 && (_ += l.get(g - 1, p - 1)), _ += i ? i(g, p) : 1) : _ = -1;
        const x = Math.max(v, w, _);
        if (x === _) {
          const y = g > 0 && p > 0 ? l.get(g - 1, p - 1) : 0;
          l.set(g, p, y + 1), a.set(g, p, 3);
        } else x === v ? (l.set(g, p, 0), a.set(g, p, 1)) : x === w && (l.set(g, p, 0), a.set(g, p, 2));
        s.set(g, p, x);
      }
    const o = [];
    let u = t.length, h = n.length;
    function c(g, p) {
      (g + 1 !== u || p + 1 !== h) && o.push(new Q(new W(g + 1, u), new W(p + 1, h))), u = g, h = p;
    }
    let d = t.length - 1, m = n.length - 1;
    for (; d >= 0 && m >= 0; )
      a.get(d, m) === 3 ? (c(d, m), d--, m--) : a.get(d, m) === 1 ? d-- : m--;
    return c(-1, -1), o.reverse(), new $e(o, !1);
  }
}
class so {
  compute(t, n, r = zt.instance) {
    ...
    o.set(0, a(0, 0));
    const u = new Ou();
    u.set(0, o.get(0) === 0 ? null : new hs(null, 0, 0, o.get(0)));
    let h = 0;
    e: for (; ; ) {
      if (l++, !r.isValid())
        return $e.trivialTimedOut(i, s);
      const p = -Math.min(l, s.length + l % 2), v = Math.min(l, i.length + l % 2);
      for (h = p; h <= v; h += 2) {
        const w = h === v ? -1 : o.get(h + 1), _ = h === p ? -1 : o.get(h - 1) + 1, x = Math.min(Math.max(w, _), i.length), y = x - h;
        if (x > i.length || y > s.length)
          continue;
        const b = a(x, y);
        o.set(h, b);
        const L = x === w ? u.get(h + 1) : u.get(h - 1);
        if (u.set(h, b !== x ? new hs(L, x, y, b - x) : L), o.get(h) === i.length && o.get(h) - h === s.length)
          break e;
      }
    }
    let c = u.get(h);
    ...
    for (; ; ) {
      const p = c ? c.x + c.length : 0, v = c ? c.y + c.length : 0;
      if ((p !== m || v !== g) && d.push(new Q(new W(p, m), new W(v, g))), !c)
        break;
...
class _n {
  ...
  translateOffset(t, n = "right") {
    const r = $t(this.firstElementOffsetByLineIdx, (s) => s <= t), i = t - this.firstElementOffsetByLineIdx[r];
    return new K(this.range.startLineNumber + r, 1 + this.lineStartOffsets[r] + i + (i === 0 && n === "left" ? 0 : this.trimmedWsLengthsByLineIdx[r]));
  }
  translateRange(t) {
  ...
  findWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !$n(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && $n(this.elements[n - 1]); )
      n--;
    let r = t;
    for (; r < this.elements.length && $n(this.elements[r]); )
      r++;
    return new W(n, r);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = Lt(this.firstElementOffsetByLineIdx, (i) => i <= t.start) ?? 0, r = _u(this.firstElementOffsetByLineIdx, (i) => t.endExclusive <= i) ?? this.elements.length;
    return new W(n, r);
  }
}
function $n(e) {
...
function ms(e) {
  return e === 10 ? 8 : e === 13 ? 7 : lr(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : e === -1 ? 3 : e === 44 || e === 59 ? 5 : 4;
}
function $u(e, t, n, r, i, s) {
  let { moves: a, excludedChanges: l } = qu(e, t, n, s);
  if (!s.isValid())
    return [];
  const o = e.filter((h) => !l.has(h)), u = ju(o, r, i, t, n, s);
  return Pu(a, u), a = Wu(a), a = a.filter((h) => {
    const c = h.original.toOffsetRange().slice(t).map((m) => m.trim());
    return c.join(`
`).length >= 15 && Uu(c, (m) => m.length >= 2) >= 2;
  }), a = Hu(e, a), a;
}
function Uu(e, t) {
  let n = 0;
...
function qu(e, t, n, r) {
  const i = [], s = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new Ut(o.original, t, o)), a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new Ut(o.modified, n, o))), l = /* @__PURE__ */ new Set();
  for (const o of s) {
    let u = -1, h;
    for (const c of a) {
    ...
    if (u > 0.9 && h && (a.delete(h), i.push(new Ne(o.range, h.range)), l.add(o.source), l.add(h.source)), !r.isValid())
...
function ju(e, t, n, r, i, s) {
  ...
  for (const d of e)
    for (let m = d.original.startLineNumber; m < d.original.endLineNumberExclusive - 2; m++) {
      ...
      l.add(g, { range: new $(m, m + 3) });
    }
  const o = [];
  e.sort(sn((d) => d.modified.startLineNumber, an));
  for (const d of e) {
    let m = [];
    for (let g = d.modified.startLineNumber; g < d.modified.endLineNumberExclusive - 2; g++) {
      const p = `${n[g - 1]}:${n[g + 1 - 1]}:${n[g + 2 - 1]}`, v = new $(g, g + 3), w = [];
      l.forEach(p, ({ range: _ }) => {
        for (const y of m)
          if (y.originalLineRange.endLineNumberExclusive + 1 === _.endLineNumberExclusive && y.modifiedLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive) {
            y.originalLineRange = new $(y.originalLineRange.startLineNumber, _.endLineNumberExclusive), y.modifiedLineRange = new $(y.modifiedLineRange.startLineNumber, v.endLineNumberExclusive), w.push(y);
            return;
          }
        const x = {
          modifiedLineRange: v,
  ...
  o.sort(Iu(sn((d) => d.modifiedLineRange.length, an)));
  const u = new Pe(), h = new Pe();
  for (const d of o) {
    const m = d.modifiedLineRange.startLineNumber - d.originalLineRange.startLineNumber, g = u.subtractFrom(d.modifiedLineRange), p = h.subtractFrom(d.originalLineRange).getWithDelta(m), v = g.getIntersection(p);
    for (const w of v.ranges) {
      if (w.length < 3)
        continue;
      const _ = w, x = w.delta(-m);
      a.push(new Ne(x, _)), u.addRange(_), h.addRange(x);
    }
  }
  a.sort(sn((d) => d.original.startLineNumber, an));
  const c = new Cn(e);
  for (let d = 0; d < a.length; d++) {
    const m = a[d], g = c.findLastMonotonous((L) => L.original.startLineNumber <= m.original.startLineNumber), p = Lt(e, (L) => L.modified.startLineNumber <= m.modified.startLineNumber), v = Math.max(m.original.startLineNumber - g.original.startLineNumber, m.modified.startLineNumber - p.modified.startLineNumber), w = c.findLastMonotonous((L) => L.original.startLineNumber < m.original.endLineNumberExclusive), _ = Lt(e, (L) => L.modified.startLineNumber < m.modified.endLineNumberExclusive), x = Math.max(w.original.endLineNumberExclusive - m.original.endLineNumberExclusive, _.modified.endLineNumberExclusive - m.modified.endLineNumberExclusive);
    let y;
    for (y = 0; y < v; y++) {
      const L = m.original.startLineNumber - y - 1, S = m.modified.startLineNumber - y - 1;
      if (L > r.length || S > i.length || u.contains(S) || h.contains(L) || !gs(r[L - 1], i[S - 1], s))
        break;
    }
    y > 0 && (h.addRange(new $(m.original.startLineNumber - y, m.original.startLineNumber)), u.addRange(new $(m.modified.startLineNumber - y, m.modified.startLineNumber)));
    let b;
    for (b = 0; b < x; b++) {
    ...
    b > 0 && (h.addRange(new $(m.original.endLineNumberExclusive, m.original.endLineNumberExclusive + b)), u.addRange(new $(m.modified.endLineNumberExclusive, m.modified.endLineNumberExclusive + b))), (y > 0 || b > 0) && (a[d] = new Ne(new $(m.original.startLineNumber - y, m.original.endLineNumberExclusive + b), new $(m.modified.startLineNumber - y, m.modified.endLineNumberExclusive + b)));
  }
  return a;
}
function gs(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const i = new so().compute(new _n([e], new z(1, 1, 1, e.length), !1), new _n([t], new z(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function Hu(e, t) {
  const n = new Cn(e);
  return t = t.filter((r) => {
    const i = n.findLastMonotonous((l) => l.original.startLineNumber < r.original.endLineNumberExclusive) || new Ne(new $(1, 1), new $(1, 1)), s = Lt(e, (l) => l.modified.startLineNumber < r.modified.endLineNumberExclusive);
    return i !== s;
  }), t;
}
function ps(e, t, n) {
  let r = n;
  return r = bs(e, t, r), r = bs(e, t, r), r = zu(e, t, r), r;
}
function bs(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let s = 1; s < n.length; s++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (u = 1; u <= o && !(e.getElement(l.seq1Range.start - u) !== e.getElement(l.seq1Range.endExclusive - u) || t.getElement(l.seq2Range.start - u) !== t.getElement(l.seq2Range.endExclusive - u)); u++)
        ;
      if (u--, u === o) {
        r[r.length - 1] = new Q(new W(a.seq1Range.start, l.seq1Range.endExclusive - o), new W(a.seq2Range.start, l.seq2Range.endExclusive - o));
        continue;
      }
      l = l.delta(-u);
    }
  ...
  for (let s = 0; s < r.length - 1; s++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (u = 0; u < o && !(!e.isStronglyEqual(l.seq1Range.start + u, l.seq1Range.endExclusive + u) || !t.isStronglyEqual(l.seq2Range.start + u, l.seq2Range.endExclusive + u)); u++)
        ;
      if (u === o) {
        r[s + 1] = new Q(new W(l.seq1Range.start + o, a.seq1Range.endExclusive), new W(l.seq2Range.start + o, a.seq2Range.endExclusive));
        continue;
      }
      u > 0 && (l = l.delta(u));
    }
...
function zu(e, t, n) {
  ...
  for (let r = 0; r < n.length; r++) {
    ...
    s.seq1Range.isEmpty ? n[r] = vs(s, e, t, l, o) : s.seq2Range.isEmpty && (n[r] = vs(s.swap(), t, e, o, l).swap());
  }
  return n;
}
  ...
  function a(o, u) {
    ...
    for (; r.length > 0; ) {
      ...
      if (!(v.seq1Range.intersects(d.seq1Range) || v.seq2Range.intersects(d.seq2Range)))
        break;
      const _ = e.findWordContaining(v.seq1Range.start), x = t.findWordContaining(v.seq2Range.start), y = new Q(_, x), b = y.intersect(v);
      if (g += b.seq1Range.length, p += b.seq2Range.length, d = d.join(y), d.seq1Range.endExclusive >= v.seq1Range.endExclusive)
        r.shift();
      else
        break;
    }
...
function Yu(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < r.length; u++) {
      let d = function(g, p) {
        const v = new W(c.seq1Range.endExclusive, h.seq1Range.start);
        if (e.countLinesIn(v) > 5 || v.length > 500)
          return !1;
        const _ = e.getText(v).trim();
        if (_.length > 20 || _.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const x = e.countLinesIn(g.seq1Range), y = g.seq1Range.length, b = t.countLinesIn(g.seq2Range), L = g.seq2Range.length, S = e.countLinesIn(p.seq1Range), M = p.seq1Range.length, F = t.countLinesIn(p.seq2Range), O = p.seq2Range.length, C = 2 * 40 + 50;
        function N(k) {
          return Math.min(k, C);
        }
        return Math.pow(Math.pow(N(x * 40 + y), 1.5) + Math.pow(N(b * 40 + L), 1.5), 1.5) + Math.pow(Math.pow(N(S * 40 + M), 1.5) + Math.pow(N(F * 40 + O), 1.5), 1.5) > (C ** 1.5) ** 1.5 * 1.3;
      };
      var l = d;
  ...
  return Tu(r, (o, u, h) => {
    let c = u;
    function d(_) {
      return _.length > 0 && _.trim().length <= 3 && u.seq1Range.length + u.seq2Range.length > 100;
    }
    ...
    const v = Q.fromOffsetPairs(o ? o.getEndExclusives() : Me.zero, h ? h.getStarts() : Me.max), w = c.intersect(v);
...
class xs {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : ys(this.lines[t - 1]), r = t === this.lines.length ? 0 : ys(this.lines[t]);
    return 1e3 - (n + r);
  }
  getText(t) {
...
class Zu {
  constructor() {
    this.dynamicProgrammingDiffing = new Vu(), this.myersDiffingAlgorithm = new so();
  }
  computeDiff(t, n, r) {
    if (t.length <= 1 && Eu(t, n, (b, L) => b === L))
      return new rn([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new rn([
        new Be(new $(1, t.length + 1), new $(1, n.length + 1), [
          new ke(new z(1, 1, t.length, t[t.length - 1].length + 1), new z(1, 1, n.length, n[n.length - 1].length + 1))
        ])
      ], [], !1);
    const i = r.maxComputationTimeMs === 0 ? zt.instance : new Fu(r.maxComputationTimeMs), s = !r.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function l(b) {
      let L = a.get(b);
      return L === void 0 && (L = a.size, a.set(b, L)), L;
    }
    const o = t.map((b) => l(b.trim())), u = n.map((b) => l(b.trim())), h = new xs(o, t), c = new xs(u, n), d = h.length + c.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, c, i, (b, L) => t[b] === n[L] ? n[L].length === 0 ? 0.1 : 1 + Math.log(1 + n[L].length) : 0.99) : this.myersDiffingAlgorithm.compute(h, c, i);
    let m = d.diffs, g = d.hitTimeout;
    m = ps(h, c, m), m = Qu(h, c, m);
    const p = [], v = (b) => {
      if (s)
        for (let L = 0; L < b; L++) {
          const S = w + L, M = _ + L;
          if (t[S] !== n[M]) {
            const F = this.refineDiff(t, n, new Q(new W(S, S + 1), new W(M, M + 1)), i, s);
    ...
    let w = 0, _ = 0;
    for (const b of m) {
      wn(() => b.seq1Range.start - w === b.seq2Range.start - _);
      const L = b.seq1Range.start - w;
      v(L), w = b.seq1Range.endExclusive, _ = b.seq2Range.endExclusive;
      const S = this.refineDiff(t, n, b, i, s);
      S.hitTimeout && (g = !0);
    ...
    const x = ws(p, t, n);
    let y = [];
    return r.computeMoves && (y = this.computeMoves(x, t, n, o, u, i, s)), wn(() => {
      function b(S, M) {
        if (S.lineNumber < 1 || S.lineNumber > M.length)
          return !1;
        const F = M[S.lineNumber - 1];
        return !(S.column < 1 || S.column > F.length + 1);
      }
      function L(S, M) {
        return !(S.startLineNumber < 1 || S.startLineNumber > M.length + 1 || S.endLineNumberExclusive < 1 || S.endLineNumberExclusive > M.length + 1);
      }
      for (const S of x) {
        if (!S.innerChanges)
          return !1;
        for (const M of S.innerChanges)
          if (!(b(M.modifiedRange.getStartPosition(), n) && b(M.modifiedRange.getEndPosition(), n) && b(M.originalRange.getStartPosition(), t) && b(M.originalRange.getEndPosition(), t)))
            return !1;
        if (!L(S.modified, n) || !L(S.original, t))
          return !1;
      }
      return !0;
    }), new rn(x, y, g);
  ...
  computeMoves(t, n, r, i, s, a, l) {
    return $u(t, n, r, i, s, a).map((h) => {
      const c = this.refineDiff(n, r, new Q(h.original.toOffsetRange(), h.modified.toOffsetRange()), a, l), d = ws(c.mappings, n, r, !0);
      return new wu(h, d);
    });
  }
  refineDiff(t, n, r, i, s) {
    const l = ec(r).toRangeMapping2(t, n), o = new _n(t, l.originalRange, s), u = new _n(n, l.modifiedRange, s), h = o.length + u.length < 500 ? this.dynamicProgrammingDiffing.compute(o, u, i) : this.myersDiffingAlgorithm.compute(o, u, i);
    let c = h.diffs;
    return c = ps(o, u, c), c = Ju(o, u, c), c = Gu(o, u, c), c = Yu(o, u, c), {
      mappings: c.map((m) => new ke(o.translateRange(m.seq1Range), u.translateRange(m.seq2Range))),
...
function ws(e, t, n, r = !1) {
  const i = [];
  for (const s of Mu(e.map((a) => Ku(a, t, n)), (a, l) => a.original.overlapOrTouch(l.original) || a.modified.overlapOrTouch(l.modified))) {
    const a = s[0], l = s[s.length - 1];
    i.push(new Be(a.original.join(l.original), a.modified.join(l.modified), s.map((o) => o.innerChanges[0])));
  }
  return wn(() => !r && i.length > 0 && (i[0].modified.startLineNumber !== i[0].original.startLineNumber || n.length - i[i.length - 1].modified.endLineNumberExclusive !== t.length - i[i.length - 1].original.endLineNumberExclusive) ? !1 : eo(i, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
...
function Ku(e, t, n) {
  ...
  const s = new $(e.originalRange.startLineNumber + r, e.originalRange.endLineNumber + 1 + i), a = new $(e.modifiedRange.startLineNumber + r, e.modifiedRange.endLineNumber + 1 + i);
  return new Be(s, a, [e]);
}
function ec(e) {
  return new Ne(new $(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new $(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
}
const _s = {
  getLegacy: () => new Su(),
  getDefault: () => new Zu()
...
class Le {
  ...
  static toRGBA(t) {
    ...
    if (r === 0)
      ...
      a = Le._hue2rgb(h, u, n + 1 / 3), l = Le._hue2rgb(h, u, n), o = Le._hue2rgb(h, u, n - 1 / 3);
    }
...
class vt {
  ...
  static fromRGBA(t) {
    ...
    let u;
    return l === 0 ? u = 0 : s === n ? u = ((r - i) / l % 6 + 6) % 6 : s === r ? u = (i - n) / l + 2 : u = (n - r) / l + 4, new vt(Math.round(u * 60), o, s, t.a);
  }
...
let Ln = class re {
  ...
  equals(t) {
    return !!t && ae.equals(this.rgba, t.rgba) && Le.equals(this.hsla, t.hsla) && vt.equals(this.hsva, t.hsva);
  }
  /**
  ...
  getRelativeLuminance() {
    const t = re._relativeLuminanceForComponent(this.rgba.r), n = re._relativeLuminanceForComponent(this.rgba.g), r = re._relativeLuminanceForComponent(this.rgba.b), i = 0.2126 * t + 0.7152 * n + 0.0722 * r;
    return et(i, 4);
  }
  ...
  lighten(t) {
    return new re(new Le(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
  }
  darken(t) {
    return new re(new Le(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
  }
  transparent(t) {
    ...
    return new re(new ae(n, r, i, s * t));
  }
  isTransparent() {
  ...
  opposite() {
    return new re(new ae(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  makeOpaque(t) {
    if (this.isOpaque() || t.rgba.a !== 1)
      return this;
    const { r: n, g: r, b: i, a: s } = this.rgba;
    return new re(new ae(t.rgba.r - s * (t.rgba.r - n), t.rgba.g - s * (t.rgba.g - r), t.rgba.b - s * (t.rgba.b - i), 1));
  }
  toString() {
  ...
  static {
    this.white = new re(new ae(255, 255, 255, 1));
  }
  static {
    this.black = new re(new ae(0, 0, 0, 1));
  }
  static {
    this.red = new re(new ae(255, 0, 0, 1));
  }
  static {
    this.blue = new re(new ae(0, 0, 255, 1));
  }
  static {
    this.green = new re(new ae(0, 255, 0, 1));
  }
  static {
    this.cyan = new re(new ae(0, 255, 255, 1));
  }
  static {
    this.lightgrey = new re(new ae(211, 211, 211, 1));
  }
  static {
    this.transparent = new re(new ae(0, 0, 0, 0));
  }
};
(function(e) {
  (function(t) {
    (function(n) {
      ...
      function c(m) {
        ...
        if (g === 0 || m.charCodeAt(0) !== 35)
          return null;
        if (g === 7) {
          const p = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)), v = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)), w = 16 * d(m.charCodeAt(5)) + d(m.charCodeAt(6));
          return new e(new ae(p, v, w, 1));
        }
        if (g === 9) {
          const p = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)), v = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)), w = 16 * d(m.charCodeAt(5)) + d(m.charCodeAt(6)), _ = 16 * d(m.charCodeAt(7)) + d(m.charCodeAt(8));
          return new e(new ae(p, v, w, _ / 255));
        }
        if (g === 4) {
          const p = d(m.charCodeAt(1)), v = d(m.charCodeAt(2)), w = d(m.charCodeAt(3));
          return new e(new ae(16 * p + p, 16 * v + v, 16 * w + w));
        }
        if (g === 5) {
          const p = d(m.charCodeAt(1)), v = d(m.charCodeAt(2)), w = d(m.charCodeAt(3)), _ = d(m.charCodeAt(4));
          return new e(new ae(16 * p + p, 16 * v + v, 16 * w + w, (16 * _ + _) / 255));
        }
        return null;
      }
      n.parseHex = c;
...
function tc(e, t) {
  if (!e)
    return;
  const n = Ln.Format.CSS.parseHex(t);
  if (n)
    return {
      range: e,
...
function Ls(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const i = t[0].values(), s = ao(i);
  return {
    range: e,
    color: Br(s[0], s[1], s[2], n ? s[3] : 1)
  };
}
function Ns(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const i = t[0].values(), s = ao(i), a = new Ln(new Le(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1));
  return {
    range: e,
    color: Br(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a)
  };
}
function Tt(e, t) {
...
class me {
  ...
  constructor(t, n) {
    this._state = 0, this._results = [], this._error = null, this._onReturn = n, this._onStateChanged = new _e(), queueMicrotask(async () => {
      const r = {
...
class fc {
  ...
  onEvents(t) {
    ...
    const n = t.changes;
    for (const r of n)
      this._acceptDeleteRange(r.range), this._acceptInsertText(new K(r.range.startLineNumber, r.range.startColumn), r.text);
...
class hc {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new dc(Te.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class dc extends fc {
  ...
  findMatches(t) {
    ...
    for (let r = 0; r < this._lines.length; r++) {
      const i = this._lines[r], s = this.offsetAt(new K(r + 1, 1)), a = i.matchAll(t);
      for (const l of a)
  ...
  getWordAtPosition(t, n) {
    const r = Or(t.column, no(n), this._lines[t.lineNumber - 1], 0);
...
class mc {
  ...
  async $computeUnicodeHighlights(t, n, r) {
    ...
    return i ? xu.computeUnicodeHighlights(i, n, r) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  async $computeDiff(t, n, r, i) {
    ...
    return !s || !a ? null : ln.computeDiff(s, a, r, i);
  }
  static computeDiff(t, n, r, i) {
    const s = i === "advanced" ? _s.getDefault() : _s.getLegacy(), a = t.getLinesContent(), l = n.getLinesContent(), o = s.computeDiff(a, l, r), u = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function h(c) {
      return c.map((d) => [d.original.startLineNumber, d.original.endLineNumberExclusive, d.modified.startLineNumber, d.modified.endLineNumberExclusive, d.innerChanges?.map((m) => [
  ...
  async $computeMoreMinimalEdits(t, n, r) {
    ...
    for (let { range: o, text: u, eol: h } of n) {
      ...
      if (u = u.replace(/\r\n|\n|\r/g, i.eol), c === u)
        continue;
      if (Math.max(u.length, c.length) > ln._diffLimit) {
        s.push({ range: o, text: u });
        continue;
      }
      const d = Ul(c, u, r), m = i.offsetAt(z.lift(o).getStartPosition());
      for (const g of d) {
        const p = i.positionAt(m + g.originalStart), v = i.positionAt(m + g.originalStart + g.originalLength), w = {
  ...
  async $textualSuggest(t, n, r, i) {
    const s = new Mn(), a = new RegExp(r, i), l = /* @__PURE__ */ new Set();
    e: for (const o of t) {
      const u = this._getModel(o);
      if (u) {
        for (const h of u.words(a))
          if (!(h === n || !isNaN(Number(h))) && (l.add(h), l.size > ln._suggestionsLimit))
            break e;
      }
    }
  ...
  async $navigateValueSet(t, n, r, i, s) {
    ...
    return Vr.INSTANCE.navigateValueSet(n, o, u, h, r);
  }
}
class ln extends mc {
  constructor(t, n) {
  ...
  $loadForeignModule(t, n, r) {
    const a = {
      host: cu(r, (l, o) => this._host.$fhr(l, o)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(a, n), Promise.resolve(rs(this._foreignModule))) : new Promise((l, o) => {
      const u = (h) => {
        this._foreignModule = h.create(a, n), l(rs(this._foreignModule));
      };
      import(`${Ja.asBrowserUri(`${t}.js`).toString(!0)}`).then(u).catch(o);
    });
  }
...
typeof importScripts == "function" && (globalThis.monaco = iu());
let ur = !1;
function lo(e) {
  if (ur)
    return;
  ...
  function g() {
    ...
    if (r < e.length && (e.charCodeAt(r) === 69 || e.charCodeAt(r) === 101))
      if (r++, (r < e.length && e.charCodeAt(r) === 43 || e.charCodeAt(r) === 45) && r++, r < e.length && dt(e.charCodeAt(r))) {
        ...
        c = 3;
    return e.substring(x, y);
  }
  function p() {
    let x = "", y = r;
    for (; ; ) {
      if (r >= n) {
        x += e.substring(y, r), c = 2;
        break;
      }
...
`;
          ...
          case 117:
            const S = d(4);
            S >= 0 ? x += String.fromCharCode(S) : c = 4;
            break;
          default:
            c = 5;
        }
  ...
  function v() {
    ...
    if (Un(x)) {
      do
        r++, i += String.fromCharCode(x), x = e.charCodeAt(r);
      while (Un(x));
      return a = 15;
    }
    if (Pt(x))
      return r++, i += String.fromCharCode(x), x === 13 && e.charCodeAt(r) === 10 && (r++, i += `
`), l++, u = r, a = 14;
    switch (x) {
      case 123:
        return r++, a = 1;
      ...
      case 47:
        ...
        if (e.charCodeAt(r + 1) === 42) {
          ...
          for (; r < b; ) {
            ...
            r++, Pt(S) && (S === 13 && e.charCodeAt(r) === 10 && r++, l++, u = r);
          }
          return L || (r++, c = 1), i = e.substring(y, r), a = 13;
        }
        return i += String.fromCharCode(x), r++, a = 16;
      case 45:
        if (i += String.fromCharCode(x), r++, r === n || !dt(e.charCodeAt(r)))
          return a = 16;
      case 48:
      case 49:
      case 50:
...
var we = new Array(20).fill(0).map((e, t) => " ".repeat(t)), mt = 200, Rs = {
  " ": {
...
function pc(e, t, n) {
  let r, i, s, a, l;
  if (t) {
    for (a = t.offset, l = a + t.length, s = a; s > 0 && !Es(e, s - 1); )
      s--;
    let b = l;
    for (; b < e.length && !Es(e, b); )
      b++;
    i = e.substring(s, b), r = bc(i, n);
  } else
    i = e, r = 0, s = 0, a = 0, l = e.length;
  const o = vc(n, e), u = gc.includes(o);
  let h = 0, c = 0, d;
  n.insertSpaces ? d = we[n.tabSize || 4] ?? gt(we[1], n.tabSize || 4) : d = "	";
  const m = d === "	" ? "	" : " ";
  let g = $r(i, !1), p = !1;
  function v() {
    if (h > 1)
      return gt(o, h) + gt(d, r + c);
    const b = d.length * (r + c);
    return !u || b > Rs[m][o].length ? o + gt(d, r + c) : b <= 0 ? o : Rs[m][o][b];
  }
  function w() {
    let b = g.scan();
    for (h = 0; b === 15 || b === 14; )
  ...
  const _ = [];
  function x(b, L, S) {
    !p && (!t || L < l && S > a) && e.substring(L, S) !== b && _.push({ offset: L, length: S - L, content: b });
  }
  let y = w();
  if (n.keepLines && h > 0 && x(gt(o, h), 0, 0), y !== 17) {
    let b = g.getTokenOffset() + s, L = d.length * r < 20 && n.insertSpaces ? we[d.length * r] : gt(d, r);
    x(L, s, b);
  }
  for (; y !== 17; ) {
    let b = g.getTokenOffset() + g.getTokenLength() + s, L = w(), S = "", M = !1;
    for (; h === 0 && (L === 12 || L === 13); ) {
      let O = g.getTokenOffset() + s;
      x(we[1], b, O), b = g.getTokenOffset() + g.getTokenLength() + s, M = L === 12, S = M ? v() : "", L = w();
    }
    if (L === 2)
      y !== 1 && c--, n.keepLines && h > 0 || !n.keepLines && y !== 1 ? S = v() : n.keepLines && (S = we[1]);
    else if (L === 4)
      y !== 3 && c--, n.keepLines && h > 0 || !n.keepLines && y !== 3 ? S = v() : n.keepLines && (S = we[1]);
    else {
      switch (y) {
        case 3:
        case 1:
          c++, n.keepLines && h > 0 || !n.keepLines ? S = v() : S = we[1];
          break;
        case 5:
          n.keepLines && h > 0 || !n.keepLines ? S = v() : S = we[1];
          break;
        case 12:
          S = v();
          break;
        case 13:
          ...
          break;
        case 6:
          n.keepLines && h > 0 ? S = v() : M || (S = we[1]);
          break;
        case 10:
          n.keepLines && h > 0 ? S = v() : L === 6 && !M && (S = "");
          break;
        case 7:
        case 8:
        case 9:
        ...
        case 2:
        case 4:
          n.keepLines && h > 0 ? S = v() : (L === 12 || L === 13) && !M ? S = we[1] : L !== 5 && L !== 17 && (p = !0);
          break;
        case 16:
          p = !0;
          break;
    ...
    L === 17 && (n.keepLines && h > 0 ? S = v() : S = n.insertFinalNewline ? o : "");
...
function wc(e, t, n = Nn.DEFAULT) {
  ...
  function l(N) {
    return N ? (k) => N(k, r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter()) : () => !0;
  }
  function o(N) {
    return N ? (k) => N(k, r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter(), () => i.slice()) : () => !0;
  }
  const u = a(t.onObjectBegin), h = o(t.onObjectProperty), c = s(t.onObjectEnd), d = a(t.onArrayBegin), m = s(t.onArrayEnd), g = o(t.onLiteralValue), p = l(t.onSeparator), v = s(t.onComment), w = l(t.onError), _ = n && n.disallowComments, x = n && n.allowTrailingComma;
  function y() {
    for (; ; ) {
      const N = r.scan();
  ...
  return y(), r.getToken() === 17 ? n.allowEmptyContent ? !0 : (b(4, [], []), !1) : C() ? (r.getToken() !== 17 && b(9, [], []), !0) : (b(4, [], []), !1);
}
var rt = $r, Ms;
(function(e) {
...
var _c = xc, Lc = co, Nc = uo, Sc = cr, Ts;
(function(e) {
...
(function(e) {
  function t(r, i) {
    return r === Number.MAX_VALUE && (r = An.MAX_VALUE), i === Number.MAX_VALUE && (i = An.MAX_VALUE), { line: r, character: i };
  }
  e.create = t;
  function n(r) {
    let i = r;
...
(function(e) {
  function t(r, i, s, a) {
    if (A.uinteger(r) && A.uinteger(i) && A.uinteger(s) && A.uinteger(a))
      return { start: Y.create(r, i), end: Y.create(s, a) };
    if (Y.is(r) && Y.is(i))
  ...
  function n(r) {
    let i = r;
    return A.objectLiteral(i) && Y.is(i.start) && Y.is(i.end);
  }
  e.is = n;
})(q || (q = {}));
var Nt;
...
(function(e) {
  ...
  function n(r) {
    const i = r;
    return A.objectLiteral(i) && q.is(i.range) && hr.is(i.color);
  }
  e.is = n;
})(Ds || (Ds = {}));
var Os;
(function(e) {
  ...
  function n(r) {
    const i = r;
    return A.objectLiteral(i) && A.string(i.label) && (A.undefined(i.textEdit) || Ve.is(i)) && (A.undefined(i.additionalTextEdits) || A.typedArray(i.additionalTextEdits, Ve.is));
  }
  e.is = n;
})(Os || (Os = {}));
var Ot;
...
(function(e) {
  ...
  function n(r) {
    let i = r;
    return A.defined(i) && Nt.is(i.location) && A.string(i.message);
  }
  e.is = n;
})(dr || (dr = {}));
var xe;
...
(function(e) {
  ...
  function i(s) {
    const a = s;
    return Ve.is(a) && (mr.is(a.annotationId) || At.is(a.annotationId));
  }
  e.is = i;
})(qs || (qs = {}));
var gr;
(function(e) {
  ...
  function n(r) {
    let i = r;
    return A.defined(i) && yr.is(i.textDocument) && Array.isArray(i.edits);
  }
  e.is = n;
})(gr || (gr = {}));
var pr;
(function(e) {
  ...
  function n(r) {
    let i = r;
    return i && i.kind === "create" && A.string(i.uri) && (i.options === void 0 || (i.options.overwrite === void 0 || A.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || A.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || At.is(i.annotationId));
  }
  e.is = n;
})(pr || (pr = {}));
var br;
(function(e) {
  ...
  function n(r) {
    let i = r;
    return i && i.kind === "rename" && A.string(i.oldUri) && A.string(i.newUri) && (i.options === void 0 || (i.options.overwrite === void 0 || A.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || A.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || At.is(i.annotationId));
  }
  e.is = n;
})(br || (br = {}));
var vr;
(function(e) {
  ...
  function n(r) {
    let i = r;
    return i && i.kind === "delete" && A.string(i.uri) && (i.options === void 0 || (i.options.recursive === void 0 || A.boolean(i.options.recursive)) && (i.options.ignoreIfNotExists === void 0 || A.boolean(i.options.ignoreIfNotExists))) && (i.annotationId === void 0 || At.is(i.annotationId));
  }
  e.is = n;
})(vr || (vr = {}));
var xr;
(function(e) {
  function t(n) {
    let r = n;
    return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every((i) => A.string(i.kind) ? pr.is(i) || br.is(i) || vr.is(i) : gr.is(i)));
  }
  e.is = t;
})(xr || (xr = {}));
var js;
...
(function(e) {
  function t(n) {
    let r = n;
    return !!r && A.objectLiteral(r) && (jt.is(r.contents) || kn.is(r.contents) || A.typedArray(r.contents, kn.is)) && (n.range === void 0 || q.is(n.range));
  }
  e.is = t;
})(Ys || (Ys = {}));
var Zs;
...
(function(e) {
  ...
  function n(r) {
    let i = r;
    return A.defined(i) && A.typedArray(i.diagnostics, Ue.is) && (i.only === void 0 || A.typedArray(i.only, A.string)) && (i.triggerKind === void 0 || i.triggerKind === Rn.Invoked || i.triggerKind === Rn.Automatic);
  }
  e.is = n;
})(oa || (oa = {}));
var la;
(function(e) {
  ...
  function n(r) {
    let i = r;
    return i && A.string(i.title) && (i.diagnostics === void 0 || A.typedArray(i.diagnostics, Ue.is)) && (i.kind === void 0 || A.string(i.kind)) && (i.edit !== void 0 || i.command !== void 0) && (i.command === void 0 || St.is(i.command)) && (i.isPreferred === void 0 || A.boolean(i.isPreferred)) && (i.edit === void 0 || xr.is(i.edit));
  }
  e.is = n;
})(la || (la = {}));
var ua;
(function(e) {
  ...
  function n(r) {
    let i = r;
    return A.defined(i) && q.is(i.range) && (A.undefined(i.command) || St.is(i.command));
  }
  e.is = n;
})(ua || (ua = {}));
var ca;
...
(function(e) {
  ...
  function n(r) {
    const i = r;
    return A.objectLiteral(i) && (i.tooltip === void 0 || A.string(i.tooltip) || jt.is(i.tooltip)) && (i.location === void 0 || Nt.is(i.location)) && (i.command === void 0 || St.is(i.command));
  }
  e.is = n;
})(Lr || (Lr = {}));
var xa;
(function(e) {
  ...
  function n(r) {
    const i = r;
    return A.objectLiteral(i) && Y.is(i.position) && (A.string(i.label) || A.typedArray(i.label, Lr.is)) && (i.kind === void 0 || _r.is(i.kind)) && i.textEdits === void 0 || A.typedArray(i.textEdits, Ve.is) && (i.tooltip === void 0 || A.string(i.tooltip) || jt.is(i.tooltip)) && (i.paddingLeft === void 0 || A.boolean(i.paddingLeft)) && (i.paddingRight === void 0 || A.boolean(i.paddingRight));
  }
  e.is = n;
})(xa || (xa = {}));
var ya;
...
(function(e) {
  function t(n) {
    const r = n;
    return A.objectLiteral(r) && fr.is(r.uri) && A.string(r.name);
  }
  e.is = t;
})(Aa || (Aa = {}));
var ka;
...
var Ra = class Nr {
  ...
  update(t, n) {
    for (let r of t)
      if (Nr.isIncremental(r)) {
        const i = ho(r.range), s = this.offsetAt(i.start), a = this.offsetAt(i.end);
  ...
  getLineOffsets() {
    return this._lineOffsets === void 0 && (this._lineOffsets = Ea(this._content, !0)), this._lineOffsets;
  }
  positionAt(t) {
...
(function(e) {
  ...
  e.update = n;
  function r(i, s) {
    let a = i.getText(), l = Sr(s.map(Ec), (h, c) => {
      let d = h.range.start.line - c.range.start.line;
      return d === 0 ? h.range.start.character - c.range.start.character : d;
    }), o = 0;
    const u = [];
...
var Mc = /{([^}]+)}/g;
function Cc(e, t) {
  return Object.keys(t).length === 0 ? e : e.replace(Mc, (n, r) => t[r] ?? n);
}
var Tc = {
...
var Oc = {
  "http://json-schema.org/draft-03/schema#": Re.v3,
  "http://json-schema.org/draft-04/schema#": Re.v4,
  "http://json-schema.org/draft-06/schema#": Re.v6,
  "http://json-schema.org/draft-07/schema#": Re.v7,
  "https://json-schema.org/draft/2019-09/schema": Re.v2019_09,
  "https://json-schema.org/draft/2020-12/schema": Re.v2020_12
}, Ta = class {
  constructor(e) {
    this.schemaDraft = e;
  }
  ...
  include(t) {
    return (this.focusOffset === -1 || go(t, this.focusOffset)) && t !== this.exclude;
  }
  newSub() {
    return new mo(-1, this.exclude);
  }
}, Wt = class {
  constructor() {
  }
...
var po = class {
  ...
  validate(e, t, n = xe.Warning, r) {
    if (this.root && t) {
      const i = new ce();
      return oe(this.root, t, i, Wt.instance, new Ta(r ?? Pa(t))), i.problems.map((s) => {
        const a = q.create(e.positionAt(s.location.offset), e.positionAt(s.location.offset + s.location.length));
        return Ue.create(a, s.message, s.severity ?? n, s.code);
      });
    }
  }
  getMatchingSchemas(e, t = -1, n) {
    if (this.root && e) {
      const r = new Bc(t, n), i = Pa(e), s = new Ta(i);
      return oe(this.root, e, new ce(), r, s), r.schemas;
    }
    return [];
  }
};
function Pa(e, t = Re.v2020_12) {
  let n = e.$schema;
  return n ? Oc[n] ?? t : t;
}
function oe(e, t, n, r, i) {
  ...
  function a() {
    ...
    if (Array.isArray(t.type) ? t.type.some(c) || n.problems.push({
      ...
      for (const _ of t.allOf) {
        const x = new ce(), y = r.newSub();
        oe(s, ge(_), x, y, i), n.merge(x), r.merge(y);
      }
    const d = ge(t.not);
    if (d) {
      const _ = new ce(), x = r.newSub();
      oe(s, d, _, x, i), _.hasProblems() || n.problems.push({
        location: { offset: s.offset, length: s.length },
        message: t.errorMessage || E("Matches a schema that is not allowed.")
      });
      for (const y of x.schemas)
    ...
    const m = (_, x) => {
      ...
      let b;
      for (const L of _) {
        const S = ge(L), M = new ce(), F = r.newSub();
        if (oe(s, S, M, F, i), M.hasProblems() || y.push(S), !b)
          b = { schema: S, validationResult: M, matchingSchemas: F };
        else if (!x && !M.hasProblems() && !b.validationResult.hasProblems())
          b.matchingSchemas.merge(F), b.validationResult.propertiesMatches += M.propertiesMatches, b.validationResult.propertiesValueMatches += M.propertiesValueMatches, b.validationResult.mergeProcessedProperties(M);
        else {
          const O = M.compare(b.validationResult);
          O > 0 ? b = { schema: S, validationResult: M, matchingSchemas: F } : O === 0 && (b.matchingSchemas.merge(F), b.validationResult.mergeEnumValues(M));
        }
      }
      return y.length > 1 && x && n.problems.push({
    ...
    const g = (_) => {
      ...
      const b = ge(_), L = new ce(), S = r.newSub();
      oe(s, b, L, S, i), r.merge(S), n.mergeProcessedProperties(L), L.hasProblems() ? y && g(y) : x && g(x);
    }, v = ge(t.if);
    if (v && p(v, ge(t.then), ge(t.else)), Array.isArray(t.enum)) {
      const _ = it(s);
      let x = !1;
      for (const y of t.enum)
        if (wt(_, y)) {
          x = !0;
          break;
        }
      n.enumValues = t.enum, n.enumValueMatch = x, x || n.problems.push({
        location: { offset: s.offset, length: s.length },
    ...
    if (Se(t.const)) {
      const _ = it(s);
      wt(_, t.const) ? n.enumValueMatch = !0 : (n.problems.push({
        location: { offset: s.offset, length: s.length },
        code: H.EnumValueMismatch,
  ...
  function l(c) {
    ...
    ue(v) && d <= v && n.problems.push({
      location: { offset: c.offset, length: c.length },
      message: E("Value is below the exclusive minimum of {0}.", v)
    });
    const w = g(t.maximum, t.exclusiveMaximum);
    ue(w) && d >= w && n.problems.push({
      location: { offset: c.offset, length: c.length },
      message: E("Value is above the exclusive maximum of {0}.", w)
    });
    const _ = p(t.minimum, t.exclusiveMinimum);
    ue(_) && d < _ && n.problems.push({
      location: { offset: c.offset, length: c.length },
      message: E("Value is below the minimum of {0}.", _)
    });
    const x = p(t.maximum, t.exclusiveMaximum);
    ue(x) && d > x && n.problems.push({
      location: { offset: c.offset, length: c.length },
      message: E("Value is above the maximum of {0}.", x)
    });
  }
  function o(c) {
    if (ue(t.minLength) && Ps(c.value) < t.minLength && n.problems.push({
      location: { offset: c.offset, length: c.length },
      message: E("String is shorter than the minimum length of {0}.", t.minLength)
    }), ue(t.maxLength) && Ps(c.value) > t.maxLength && n.problems.push({
      location: { offset: c.offset, length: c.length },
      message: E("String is longer than the maximum length of {0}.", t.maxLength)
    }), fo(t.pattern) && (Sn(t.pattern)?.test(c.value) || n.problems.push({
      location: { offset: c.offset, length: c.length },
  ...
  function u(c) {
    let d, m;
    i.schemaDraft >= Re.v2020_12 ? (d = t.prefixItems, m = Array.isArray(t.items) ? void 0 : t.items) : (d = Array.isArray(t.items) ? t.items : void 0, m = Array.isArray(t.items) ? t.additionalItems : t.items);
    let g = 0;
    if (d !== void 0) {
      const w = Math.min(d.length, c.items.length);
      for (; g < w; g++) {
        const _ = d[g], x = ge(_), y = new ce(), b = c.items[g];
        b && (oe(b, x, y, r, i), n.mergePropertyMatch(y)), n.processedProperties.add(String(g));
      }
    }
    ...
    const p = ge(t.contains);
    if (p) {
      let w = 0;
      for (let _ = 0; _ < c.items.length; _++) {
        const x = c.items[_], y = new ce();
        oe(x, p, y, Wt.instance, i), y.hasProblems() || (w++, i.schemaDraft >= Re.v2020_12 && n.processedProperties.add(String(_)));
      }
      w === 0 && !ue(t.minContains) && n.problems.push({
        location: { offset: c.offset, length: c.length },
        message: t.errorMessage || E("Array does not contain required item.")
      }), ue(t.minContains) && w < t.minContains && n.problems.push({
        location: { offset: c.offset, length: c.length },
        message: t.errorMessage || E("Array has too few items that match the contains contraint. Expected {0} or more.", t.minContains)
      }), ue(t.maxContains) && w > t.maxContains && n.problems.push({
        location: { offset: c.offset, length: c.length },
      ...
      for (let w = 0; w < c.items.length; w++) {
        if (!n.processedProperties.has(String(w)))
          if (v === !1)
            ...
            const _ = new ce();
            oe(c.items[w], t.unevaluatedItems, _, r, i), n.mergePropertyMatch(_);
          }
        n.processedProperties.add(String(w)), n.propertiesValueMatches++;
      }
    if (ue(t.minItems) && c.items.length < t.minItems && n.problems.push({
      location: { offset: c.offset, length: c.length },
      message: E("Array has too few items. Expected {0} or more.", t.minItems)
    }), ue(t.maxItems) && c.items.length > t.maxItems && n.problems.push({
      location: { offset: c.offset, length: c.length },
  ...
  function h(c) {
    ...
    for (const x of c.properties) {
      const y = x.keyNode.value;
      d[y] = x.valueNode, m.add(y);
    }
    if (Array.isArray(t.required)) {
      for (const x of t.required)
        if (!d[x]) {
          const y = c.parent && c.parent.type === "property" && c.parent.keyNode, b = y ? { offset: y.offset, length: y.length } : { offset: c.offset, length: 1 };
          n.problems.push({
            location: b,
            message: E('Missing property "{0}".', x)
          });
        }
    }
    const g = (x) => {
      m.delete(x), n.processedProperties.add(x);
    };
    if (t.properties)
      for (const x of Object.keys(t.properties)) {
        g(x);
        const y = t.properties[x], b = d[x];
        if (b)
          if (Ie(y))
            if (y)
              ...
              n.problems.push({
                ...
                message: t.errorMessage || E("Property {0} is not allowed.", x)
              });
            }
          else {
            const L = new ce();
            oe(b, y, L, r, i), n.mergePropertyMatch(L);
          }
      }
    if (t.patternProperties)
      for (const x of Object.keys(t.patternProperties)) {
        const y = Sn(x);
        if (y) {
          const b = [];
          for (const L of m)
            if (y.test(L)) {
              ...
              if (S) {
                ...
                if (Ie(M))
                  ...
                  const F = new ce();
                  oe(S, M, F, r, i), n.mergePropertyMatch(F);
                }
              }
            }
          b.forEach(g);
        ...
        if (!n.processedProperties.has(y)) {
          ...
          if (b) {
            if (v === !1) {
              ...
              const L = new ce();
              oe(b, v, L, r, i), n.mergePropertyMatch(L);
            }
          }
        }
      x.forEach(g);
    }
    if (ue(t.maxProperties) && c.properties.length > t.maxProperties && n.problems.push({
      location: { offset: c.offset, length: c.length },
      message: E("Object has more properties than limit of {0}.", t.maxProperties)
    }), ue(t.minProperties) && c.properties.length < t.minProperties && n.problems.push({
      location: { offset: c.offset, length: c.length },
      message: E("Object has fewer properties than the required number of {0}", t.minProperties)
    }), t.dependentRequired)
      for (const x in t.dependentRequired) {
        const y = d[x], b = t.dependentRequired[x];
        y && Array.isArray(b) && _(x, b);
      }
    if (t.dependentSchemas)
      for (const x in t.dependentSchemas) {
        const y = d[x], b = t.dependentSchemas[x];
        y && Xe(b) && _(x, b);
      }
    if (t.dependencies)
      for (const x in t.dependencies)
        d[x] && _(x, t.dependencies[x]);
    const w = ge(t.propertyNames);
    if (w)
      for (const x of c.properties) {
        const y = x.keyNode;
        y && oe(y, w, n, Wt.instance, i);
      }
    function _(x, y) {
      if (Array.isArray(y))
        for (const b of y)
          d[b] ? n.propertiesValueMatches++ : n.problems.push({
            location: { offset: c.offset, length: c.length },
            message: E("Object is missing property {0} required by property {1}.", b, x)
          });
      else {
        const b = ge(y);
        if (b) {
          const L = new ce();
          oe(c, b, L, r, i), n.mergePropertyMatch(L);
        }
      }
    }
  }
...
function Uc(e, t) {
  const n = [];
  let r = -1;
  const i = e.getText(), s = rt(i, !1), a = t && t.collectComments ? [] : void 0;
  function l() {
    for (; ; ) {
      const L = s.scan();
      switch (h(), L) {
  ...
  function o(L, S, M, F, O = xe.Error) {
    if (n.length === 0 || M !== r) {
      const C = q.create(e.positionAt(M), e.positionAt(F));
      n.push(Ue.create(C, L, O, S, e.languageId)), r = M;
    }
  }
  function u(L, S, M = void 0, F = [], O = []) {
    ...
    if (o(L, S, C, N), M && c(M, !1), F.length + O.length > 0) {
      let k = s.getToken();
      for (; k !== 17; ) {
        if (F.indexOf(k) !== -1) {
          l();
          break;
        } else if (O.indexOf(k) !== -1)
          break;
        k = l();
      }
    }
  ...
  function c(L, S) {
    return L.length = s.getTokenOffset() + s.getTokenLength() - L.offset, S && l(), L;
  }
  function d(L) {
    if (s.getToken() !== 3)
      return;
    const S = new Ic(L, s.getTokenOffset());
    l();
    let M = !1;
    for (; s.getToken() !== 4 && s.getToken() !== 17; ) {
      if (s.getToken() === 5) {
        M || u(E("Value expected"), H.ValueExpected);
        const O = s.getTokenOffset();
        if (l(), s.getToken() === 4) {
          M && o(E("Trailing comma"), H.TrailingComma, O, O + 1);
          continue;
        }
      } else M && u(E("Expected comma"), H.CommaExpected);
      const F = x(S);
      F ? S.items.push(F) : u(E("Value expected"), H.ValueExpected, void 0, [], [
        4,
        5
        /* Json.SyntaxKind.CommaToken */
      ]), M = !0;
    }
    return s.getToken() !== 4 ? u(E("Expected comma or closing bracket"), H.CommaOrCloseBacketExpected, S) : c(S, !0);
  }
  const m = new qn(void 0, 0, 0);
  function g(L, S) {
    const M = new Vc(L, s.getTokenOffset(), m);
    let F = v(M);
    if (!F)
      if (s.getToken() === 16) {
        u(E("Property keys must be doublequoted"), H.PropertyKeysMustBeDoublequoted);
        const C = new qn(M, s.getTokenOffset(), s.getTokenLength());
        C.value = s.getTokenValue(), F = C, l();
      } else
        return;
    if (M.keyNode = F, F.value !== "//") {
      const C = S[F.value];
      C ? (o(E("Duplicate object key"), H.DuplicateKey, M.keyNode.offset, M.keyNode.offset + M.keyNode.length, xe.Warning), Xe(C) && o(E("Duplicate object key"), H.DuplicateKey, C.keyNode.offset, C.keyNode.offset + C.keyNode.length, xe.Warning), S[F.value] = !0) : S[F.value] = M;
    }
    if (s.getToken() === 6)
      M.colonOffset = s.getTokenOffset(), l();
    ...
    const O = x(M);
    return O ? (M.valueNode = O, M.length = O.offset + O.length - M.offset, M) : u(E("Value expected"), H.ValueExpected, M, [], [
      2,
      5
      /* Json.SyntaxKind.CommaToken */
    ]);
  ...
  function p(L) {
    if (s.getToken() !== 1)
      return;
    const S = new Dc(L, s.getTokenOffset()), M = /* @__PURE__ */ Object.create(null);
    l();
    let F = !1;
    for (; s.getToken() !== 2 && s.getToken() !== 17; ) {
      if (s.getToken() === 5) {
        ...
        if (l(), s.getToken() === 2) {
          F && o(E("Trailing comma"), H.TrailingComma, C, C + 1);
          continue;
        }
      } else F && u(E("Expected comma"), H.CommaExpected);
      const O = g(S, M);
      O ? S.properties.push(O) : u(E("Property expected"), H.PropertyExpected, void 0, [], [
        2,
        5
        /* Json.SyntaxKind.CommaToken */
      ]), F = !0;
    }
    return s.getToken() !== 2 ? u(E("Expected comma or closing brace"), H.CommaOrCloseBraceExpected, S) : c(S, !0);
  }
  function v(L) {
    if (s.getToken() !== 10)
      return;
    const S = new qn(L, s.getTokenOffset());
    return S.value = s.getTokenValue(), c(S, !0);
  }
  function w(L) {
    if (s.getToken() !== 11)
      return;
    const S = new Fc(L, s.getTokenOffset());
    if (s.getTokenError() === 0) {
      const M = s.getTokenValue();
      try {
        const F = JSON.parse(M);
        if (!ue(F))
          return u(E("Invalid number format."), H.Undefined, S);
        S.value = F;
      } catch {
        return u(E("Invalid number format."), H.Undefined, S);
      }
      S.isInteger = M.indexOf(".") === -1;
    }
    return c(S, !0);
  }
  function _(L) {
    switch (s.getToken()) {
      case 7:
        return c(new Pc(L, s.getTokenOffset()), !0);
      case 8:
        return c(new Ma(L, !0, s.getTokenOffset()), !0);
      case 9:
        return c(new Ma(L, !1, s.getTokenOffset()), !0);
      default:
        return;
    }
  }
  function x(L) {
    return d(L) || p(L) || v(L) || w(L) || _(L);
  }
  let y;
  return l() !== 17 && (y = x(y), y ? s.getToken() !== 17 && u(E("End of file expected."), H.Undefined) : u(E("Expected a JSON object, array or literal."), H.Undefined)), new po(y, n, a);
}
function Rr(e, t, n) {
  if (e !== null && typeof e == "object") {
    const r = t + "	";
...
`;
      for (let s = 0; s < e.length; s++)
        i += r + Rr(e[s], r, n), s < e.length - 1 && (i += ","), i += `
`;
      return i += t + "]", i;
    } else {
...
`;
      for (let a = 0; a < i.length; a++) {
        const l = i[a];
        s += r + JSON.stringify(l) + ": " + Rr(e[l], r, n), a < i.length - 1 && (s += ","), s += `
`;
      }
      return s += t + "}", s;
    }
...
var qc = class {
  ...
  doComplete(e, t, n) {
    ...
    const u = /* @__PURE__ */ new Map(), h = {
      add: (c) => {
        ...
        if (m)
          ...
          c.textEdit = Ve.replace(o, c.insertText), c.label = d, u.set(d, c), r.items.push(c);
        }
      },
      setAsIncomplete: () => {
        r.isIncomplete = !0;
    ...
    return this.schemaService.getSchemaForResource(e.uri, n).then((c) => {
      ...
      if (a && a.type === "object") {
        ...
        let _ = "";
        m && (_ = this.evaluateSeparatorAfter(e, e.offsetAt(o.end))), c ? this.getPropertyCompletions(c, n, a, m, _, h) : this.getSchemaLessPropertyCompletions(n, a, g, h);
        const x = kr(a);
        this.contributions.forEach((y) => {
          const b = y.collectPropertyCompletions(e.uri, x, l, m, _ === "", h);
          b && d.push(b);
      ...
      const v = {};
      return c ? this.getValueCompletions(c, n, a, s, e, h, v) : this.getSchemaLessValueCompletions(n, a, s, e, h), this.contributions.length > 0 && this.getContributedValueCompletions(n, a, s, e, h, d), this.promiseConstructor.all(d).then(() => {
        if (h.getNumberOfProposals() === 0) {
          let w = s;
          a && (a.type === "string" || a.type === "number" || a.type === "boolean" || a.type === "null") && (w = a.offset + a.length);
          const _ = this.evaluateSeparatorAfter(e, w);
          this.addFillerValueCompletions(v, _, h);
        }
        return r;
      });
    });
      ...
      if (l.node === n && !l.inverted) {
        ...
        o && Object.keys(o).forEach((h) => {
          ...
          if (typeof c == "object" && !c.deprecationMessage && !c.doNotSuggest) {
            ...
            c.suggestSortText !== void 0 && (d.sortText = c.suggestSortText), d.insertText && qt(d.insertText, `$1${i}`) && (d.command = {
              title: "Suggest",
        ...
        if (typeof u == "object" && !u.deprecationMessage && !u.doNotSuggest) {
          const h = (c, d = void 0) => {
            ...
            u.suggestSortText !== void 0 && (m.sortText = u.suggestSortText), m.insertText && qt(m.insertText, `$1${i}`) && (m.command = {
              title: "Suggest",
              command: "editor.action.triggerSuggest"
            }), s.add(m);
          };
  ...
  getSchemaLessValueCompletions(e, t, n, r, i) {
    ...
    const a = this.evaluateSeparatorAfter(r, s), l = (o) => {
      o.parent && !go(o.parent, n, !0) && i.add({
          ...
          if (n.type === "array" && d.schema.items) {
            ...
            if (d.schema.uniqueItems) {
              ...
              n.children.forEach((p) => {
                p.type !== "array" && p.type !== "object" && g.add(this.getLabelForValue(it(p)));
              }), m = {
                ...s,
                add(p) {
          ...
          if (o !== void 0) {
            ...
            if (d.schema.patternProperties && !m) {
              for (const g of Object.keys(d.schema.patternProperties))
                if (Sn(g)?.test(o)) {
                  m = !0;
                  const v = d.schema.patternProperties[g];
                  this.addSchemaValueCompletions(v, h, s, a);
                }
            }
...
` + m) + d + t, o = o || u, h = u.replace(/[\n]/g, "");
  ...
  collectTypes(e, t) {
    if (Array.isArray(e.enum) || Se(e.const))
      return;
    const n = e.type;
  ...
  getInsertTextForSnippetValue(e, t) {
    return Rr(e, "", (r) => typeof r == "string" && r[0] === "^" ? r.substr(1) : JSON.stringify(r)) + t;
  }
...
\r\v":{[,]}`.indexOf(r.charAt(n)) === -1; )
  ...
  findItemAtOffset(e, t, n) {
    const r = rt(t.getText(), !0), i = e.items;
  ...
  doHover(e, t, n) {
    ...
    return this.schemaService.getSchemaForResource(e.uri, n).then((u) => {
      if (u && i) {
        ...
        let c, d, m, g;
        h.every((v) => {
          if (v.node === i && !v.inverted && v.schema && (c = c || v.schema.title, d = d || v.schema.markdownDescription || jn(v.schema.description), v.schema.enum)) {
            const w = v.schema.enum.indexOf(it(i));
            v.schema.markdownEnumDescriptions ? m = v.schema.markdownEnumDescriptions[w] : v.schema.enumDescriptions && (m = jn(v.schema.enumDescriptions[w])), m && (g = v.schema.enum[w], typeof g != "string" && (g = JSON.stringify(g)));
          }
          return !0;
        });
        let p = "";
        return c && (p = jn(c)), d && (p.length > 0 && (p += `
...
var Hc = class {
  ...
  configure(e) {
    e && (this.validationEnabled = e.validate !== !1, this.commentSeverity = e.allowComments ? void 0 : xe.Error);
  }
  doValidation(e, t, n, r) {
    ...
    const i = [], s = {}, a = (o) => {
      ...
      let u = n?.trailingCommas ? Yt(n.trailingCommas) : xe.Error, h = n?.comments ? Yt(n.comments) : this.commentSeverity, c = n?.schemaValidation ? Yt(n.schemaValidation) : xe.Warning, d = n?.schemaRequest ? Yt(n.schemaRequest) : xe.Warning;
      if (o) {
        const m = (g, p) => {
          if (t.root && d) {
            const v = t.root, w = v.type === "object" ? v.properties[0] : void 0;
            if (w && w.keyNode.value === "$schema") {
              const _ = w.valueNode || w, x = q.create(e.positionAt(_.offset), e.positionAt(_.offset + _.length));
              a(Ue.create(x, g, d, p));
            } else {
              const _ = q.create(e.positionAt(v.offset), e.positionAt(v.offset + 1));
              a(Ue.create(_, g, d, p));
            }
          }
        };
        if (o.errors.length)
          ...
          const g = t.validate(e, o.schema, c, n?.schemaDraft);
          g && g.forEach(a);
        }
        bo(o.schema) && (h = void 0), vo(o.schema) && (u = void 0);
      }
      ...
      if (typeof h == "number") {
        ...
        t.comments.forEach((g) => {
          a(Ue.create(g, m, h, H.CommentNotPermitted));
        });
      }
      return i;
    };
...
var Ia = 48, Gc = 57, Jc = 65, Zt = 97, Xc = 102;
function te(e) {
  return e < Ia ? 0 : e <= Gc ? e - Ia : (e < Zt && (e += Zt - Jc), e >= Zt && e <= Xc ? e - Zt + 10 : 0);
}
function Qc(e) {
  if (e[0] === "#")
    switch (e.length) {
...
var Yc = class {
  ...
  findDocumentSymbols(e, t, n = { resultLimit: Number.MAX_VALUE }) {
    ...
    const s = e.uri;
    if ((s === "vscode://defaultsettings/keybindings.json" || qt(s.toLowerCase(), "/user/keybindings.json")) && r.type === "array") {
      const c = [];
      for (const d of r.items)
        if (d.type === "object") {
          for (const m of d.properties)
            if (m.keyNode.value === "key" && m.valueNode) {
              const g = Nt.create(e.uri, He(e, d));
              if (c.push({ name: Fa(m.valueNode), kind: Ce.Function, location: g }), i--, i <= 0)
    ...
    const u = [], h = (c, d) => {
      c.type === "array" ? c.items.forEach((m) => {
        ...
        if (g)
          if (i > 0) {
            i--;
            const p = Nt.create(e.uri, He(e, m)), v = d ? d + "." + m.keyNode.value : m.keyNode.value;
            u.push({ name: this.getKeyLabel(m), kind: this.getSymbolKind(g.type), location: p, containerName: d }), a.push({ node: g, containerName: v });
          } else
            o = !0;
      });
    };
    ...
    if ((s === "vscode://defaultsettings/keybindings.json" || qt(s.toLowerCase(), "/user/keybindings.json")) && r.type === "array") {
      ...
      for (const d of r.items)
        if (d.type === "object") {
          for (const m of d.properties)
            if (m.keyNode.value === "key" && m.valueNode) {
              const g = He(e, d), p = He(e, m.keyNode);
              if (c.push({ name: Fa(m.valueNode), kind: Ce.Function, range: g, selectionRange: p }), i--, i <= 0)
                return n && n.onResultLimitExceeded && n.onResultLimitExceeded(s), c;
            }
        }
      return c;
    ...
    const h = (c, d) => {
      c.type === "array" ? c.items.forEach((m, g) => {
        if (m)
          if (i > 0) {
            i--;
            const p = He(e, m), v = p, _ = { name: String(g), kind: this.getSymbolKind(m.type), range: p, selectionRange: v, children: [] };
            d.push(_), l.push({ result: _.children, node: m });
          } else
            u = !0;
      }) : c.type === "object" && c.properties.forEach((m) => {
        const g = m.valueNode;
        if (g)
          if (i > 0) {
            i--;
            const p = He(e, m), v = He(e, m.keyNode), w = [], _ = { name: this.getKeyLabel(m), kind: this.getSymbolKind(g.type), range: p, selectionRange: v, children: w, detail: this.getDetail(g) };
            d.push(_), l.push({ result: w, node: g });
          } else
            u = !0;
      });
    };
  ...
  getColorPresentations(e, t, n, r) {
    ...
    let u;
    return n.alpha === 1 ? u = `#${o(s)}${o(a)}${o(l)}` : u = `#${o(s)}${o(a)}${o(l)}${o(Math.round(n.alpha * 255))}`, i.push({ label: u, textEdit: Ve.replace(r, JSON.stringify(u)) }), i;
  }
};
function He(e, t) {
...
for (const e in Er.schemas) {
  const t = Er.schemas[e];
...
(() => {
  var e = { 470: (i) => {
            ...
            if (m !== p - 1 && g === 2) {
              if (c.length < 2 || d !== 2 || c.charCodeAt(c.length - 1) !== 46 || c.charCodeAt(c.length - 2) !== 46) {
                if (c.length > 2) {
                  var v = c.lastIndexOf("/");
                  if (v !== c.length - 1) {
                    v === -1 ? (c = "", d = 0) : d = (c = c.slice(0, v)).length - 1 - c.lastIndexOf("/"), m = p, g = 0;
                    continue;
                  }
    ...
    var l = { resolve: function() {
      ...
      for (var c = o.length, d = c - h, m = 1; m < u.length && u.charCodeAt(m) === 47; ++m)
        ;
      for (var g = u.length - m, p = d < g ? d : g, v = -1, w = 0; w <= p; ++w) {
        if (w === p) {
          if (g > p) {
            ...
            d > p && (o.charCodeAt(h + w) === 47 ? v = w : w === 0 && (v = 0));
          break;
        }
        var _ = o.charCodeAt(h + w);
        if (_ !== u.charCodeAt(m + w))
          break;
        _ === 47 && (v = w);
      }
      var x = "";
      for (w = h + v + 1; w <= c; ++w)
        w !== c && o.charCodeAt(w) !== 47 || (x.length === 0 ? x += ".." : x += "/..");
      return x.length > 0 ? x + u.slice(m + v) : (m += v, u.charCodeAt(m) === 47 && ++m, u.slice(m));
      ...
      if (u !== void 0 && u.length > 0 && u.length <= o.length) {
        ...
        for (h = o.length - 1; h >= 0; --h) {
          ...
          if (v === 47) {
            ...
            p === -1 && (m = !1, p = h + 1), g >= 0 && (v === u.charCodeAt(g) ? --g == -1 && (d = h) : (g = -1, d = p));
        }
      ...
      d ? (u.root = "/", h = 1) : h = 0;
      for (var m = -1, g = 0, p = -1, v = !0, w = o.length - 1, _ = 0; w >= h; --w)
        if ((c = o.charCodeAt(w)) !== 47)
          p === -1 && (v = !1, p = w + 1), c === 46 ? m === -1 ? m = w : _ !== 1 && (_ = 1) : m !== -1 && (_ = -1);
        else if (!v) {
          g = w + 1;
          break;
        }
      return m === -1 || p === -1 || _ === 0 || _ === 1 && m === p - 1 && m === g + 1 ? p !== -1 && (u.base = u.name = g === 0 && d ? o.slice(1, p) : o.slice(g, p)) : (g === 0 && d ? (u.name = o.slice(1, m), u.base = o.slice(1, p)) : (u.name = o.slice(g, m), u.base = o.slice(g, p)), u.ext = o.slice(m, p)), g > 0 ? u.dir = o.slice(0, g - 1) : d && (u.dir = "/"), u;
  ...
  (() => {
    ...
    class d {
      ...
      query;
      fragment;
      constructor(N, k, R, I, T, P = !1) {
        typeof N == "object" ? (this.scheme = N.scheme || u, this.authority = N.authority || u, this.path = N.path || u, this.query = N.query || u, this.fragment = N.fragment || u) : (this.scheme = /* @__PURE__ */ function(D, B) {
          return D || B ? D : "file";
        }(N, P), this.authority = k || u, this.path = function(D, B) {
          switch (D) {
            case "https":
            case "http":
            case "file":
      ...
      with(N) {
        if (!N)
          return this;
        let { scheme: k, authority: R, path: I, query: T, fragment: P } = N;
        return k === void 0 ? k = this.scheme : k === null && (k = u), R === void 0 ? R = this.authority : R === null && (R = u), I === void 0 ? I = this.path : I === null && (I = u), T === void 0 ? T = this.query : T === null && (T = u), P === void 0 ? P = this.fragment : P === null && (P = u), k === this.scheme && R === this.authority && I === this.path && T === this.query && P === this.fragment ? this : new g(k, R, I, T, P);
      }
      static parse(N, k = !1) {
        const R = c.exec(N);
        return R ? new g(R[2] || u, L(R[4] || u), L(R[5] || u), L(R[7] || u), L(R[9] || u), k) : new g(u, u, u, u, u);
      }
      static file(N) {
        let k = u;
        if (i && (N = N.replace(/\\/g, h)), N[0] === h && N[1] === h) {
          const R = N.indexOf(h, 2);
          R === -1 ? (k = N.substring(2), N = h) : (k = N.substring(2, R), N = N.substring(R) || h);
        }
        return new g("file", k, N, u, u);
      }
      static from(N) {
        const k = new g(N.scheme, N.authority, N.path, N.query, N.fragment);
        return o(k, !0), k;
      }
      toString(N = !1) {
        return x(this, N);
      ...
      static revive(N) {
        if (N) {
          ...
          {
            const k = new g(N);
            return k._formatted = N.external, k._fsPath = N._sep === m ? N.fsPath : null, k;
          }
        }
        return N;
      }
    ...
    class g extends d {
      ...
      toString(N = !1) {
        return N ? x(this, !0) : (this._formatted || (this._formatted = x(this, !1)), this._formatted);
      }
      toJSON() {
        const N = { $mid: 1 };
        return this._fsPath && (N.fsPath = this._fsPath, N._sep = m), this._formatted && (N.external = this._formatted), this.path && (N.path = this.path), this.scheme && (N.scheme = this.scheme), this.authority && (N.authority = this.authority), this.query && (N.query = this.query), this.fragment && (N.fragment = this.fragment), N;
      }
    }
    ...
    function v(C, N, k) {
      ...
      for (let T = 0; T < C.length; T++) {
        const P = C.charCodeAt(T);
        if (P >= 97 && P <= 122 || P >= 65 && P <= 90 || P >= 48 && P <= 57 || P === 45 || P === 46 || P === 95 || P === 126 || N && P === 47 || k && P === 91 || k && P === 93 || k && P === 58)
          I !== -1 && (R += encodeURIComponent(C.substring(I, T)), I = -1), R !== void 0 && (R += C.charAt(T));
        else {
          R === void 0 && (R = C.substr(0, T));
          const D = p[P];
          D !== void 0 ? (I !== -1 && (R += encodeURIComponent(C.substring(I, T)), I = -1), R += D) : I === -1 && (I = T);
        }
      }
      return I !== -1 && (R += encodeURIComponent(C.substring(I))), R !== void 0 ? R : C;
    }
    function w(C) {
      let N;
      for (let k = 0; k < C.length; k++) {
        const R = C.charCodeAt(k);
        R === 35 || R === 63 ? (N === void 0 && (N = C.substr(0, k)), N += p[R]) : N !== void 0 && (N += C[k]);
      }
      return N !== void 0 ? N : C;
    }
    function _(C, N) {
      let k;
      return k = C.authority && C.path.length > 1 && C.scheme === "file" ? `//${C.authority}${C.path}` : C.path.charCodeAt(0) === 47 && (C.path.charCodeAt(1) >= 65 && C.path.charCodeAt(1) <= 90 || C.path.charCodeAt(1) >= 97 && C.path.charCodeAt(1) <= 122) && C.path.charCodeAt(2) === 58 ? C.path[1].toLowerCase() + C.path.substr(2) : C.path, i && (k = k.replace(/\//g, "\\")), k;
    }
    function x(C, N) {
      const k = N ? w : v;
      let R = "", { scheme: I, authority: T, path: P, query: D, fragment: B } = C;
      if (I && (R += I, R += ":"), (T || I === "file") && (R += h, R += h), T) {
        let j = T.indexOf("@");
        if (j !== -1) {
          const ee = T.substr(0, j);
          T = T.substr(j + 1), j = ee.lastIndexOf(":"), j === -1 ? R += k(ee, !1, !1) : (R += k(ee.substr(0, j), !1, !1), R += ":", R += k(ee.substr(j + 1), !1, !0)), R += "@";
        }
        T = T.toLowerCase(), j = T.lastIndexOf(":"), j === -1 ? R += k(T, !1, !0) : (R += k(T.substr(0, j), !1, !0), R += T.substr(j));
      }
      if (P) {
      ...
      return D && (R += "?", R += k(D, !1, !1)), B && (R += "#", R += N ? B : v(B, !1, !1)), R;
    }
    function y(C) {
      try {
        return decodeURIComponent(C);
      } catch {
        return C.length > 3 ? C.substr(0, 3) + y(C.substr(3)) : C;
      }
    }
    const b = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function L(C) {
      return C.match(b) ? C.replace(b, (N) => y(N)) : C;
    }
    var S = n(470);
    const M = S.posix || S, F = "/";
    var O;
    (function(C) {
      C.joinPath = function(N, ...k) {
        return N.with({ path: M.join(N.path, ...k) });
      }, C.resolvePath = function(N, ...k) {
        let R = N.path, I = !1;
        R[0] !== F && (R = F + R, I = !0);
        let T = M.resolve(R, ...k);
        ...
        if (N.path.length === 0 || N.path === F)
          return N;
        let k = M.dirname(N.path);
        return k.length === 1 && k.charCodeAt(0) === 46 && (k = ""), N.with({ path: k });
      }, C.basename = function(N) {
        return M.basename(N.path);
      }, C.extname = function(N) {
        return M.extname(N.path);
      };
    })(O || (O = {}));
  })(), xo = r;
})();
var { URI: kt, Utils: A1 } = xo;
function Kc(e, t) {
  if (typeof e != "string")
...
var e1 = "!", t1 = "/", n1 = class {
  constructor(e, t, n) {
    ...
    try {
      for (let r of e) {
        const i = r[0] !== e1;
        i || (r = r.substring(1)), r.length > 0 && (r[0] === t1 && (r = r.substring(1)), this.globWrappers.push({
          regexp: Kc("**/" + r, { extended: !0, globstar: !0 }),
          include: i
        }));
      }
      t && (t = yo(t), t.endsWith("/") || (t = t + "/"), this.folderUri = t);
    } catch {
  ...
  constructor(e, t, n) {
    this.service = e, this.uri = t, this.dependencies = /* @__PURE__ */ new Set(), this.anchors = void 0, n && (this.unresolvedSchema = this.service.promise.resolve(new Ft(n)));
  }
  getUnresolvedSchema() {
  ...
  loadSchema(e) {
    if (!this.requestService) {
      const t = E("Unable to load schema from '{0}'. No schema request service available", It(e));
      return this.promise.resolve(new Ft({}, [t]));
    }
    return e.startsWith("http://json-schema.org/") && (e = "https" + e.substring(4)), this.requestService(e).then((t) => {
      if (!t) {
        const s = E("Unable to load schema from '{0}': No content.", It(e));
        return new Ft({}, [s]);
      }
      const n = [];
      t.charCodeAt(0) === 65279 && (n.push(E("Problem reading content from '{0}': UTF-8 with BOM detected, only UTF 8 is allowed.", It(e))), t = t.trimStart());
      let r = {};
      const i = [];
      return r = _c(t, i), i.length && n.push(E("Unable to parse content from '{0}': Parse error at offset {1}.", It(e), i[0].offset)), new Ft(r, n);
    }, (t) => {
      let n = t.toString();
      const r = t.toString().split("Error: ");
      return r.length > 1 && (n = r[1]), qt(n, ".") && (n = n.substr(0, n.length - 1)), new Ft({}, [E("Unable to load schema from '{0}': {1}.", It(e), n)]);
    });
  }
  resolveSchemaContent(e, t) {
    ...
    if (i === "http://json-schema.org/draft-03/schema")
      return this.promise.resolve(new Va({}, [E("Draft-03 schemas are not supported.")], [], i));
    let s = /* @__PURE__ */ new Set();
    const a = this.contextService, l = (g, p) => {
      p = decodeURIComponent(p);
      let v = g;
      return p[0] === "/" && (p = p.substring(1)), p.split("/").some((w) => (w = w.replace(/~1/g, "/").replace(/~0/g, "~"), v = v[w], !v)), v;
    }, o = (g, p, v) => (p.anchors || (p.anchors = m(g)), p.anchors.get(v)), u = (g, p) => {
      for (const v in p)
        p.hasOwnProperty(v) && v !== "id" && v !== "$id" && (g[v] = p[v]);
    }, h = (g, p, v, w) => {
      let _;
      w === void 0 || w.length === 0 ? _ = p : w.charAt(0) === "/" ? _ = l(p, w) : _ = o(p, v, w), _ ? u(g, _) : n.push(E("$ref '{0}' in '{1}' can not be resolved.", w || "", v.uri));
    }, c = (g, p, v, w) => {
      a && !/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(p) && (p = a.resolveRelativePath(p, w.uri)), p = ze(p);
      const _ = this.getOrAddSchemaHandle(p);
      return _.getUnresolvedSchema().then((x) => {
        if (w.dependencies.add(p), x.errors.length) {
          const y = v ? p + "#" + v : p;
          n.push(E("Problems loading reference '{0}': {1}", y, x.errors[0]));
        }
        return h(g, x.schema, _, v), d(g, x.schema, _);
      });
    }, d = (g, p, v) => {
      const w = [];
      return this.traverseNodes(g, (_) => {
        ...
        for (; _.$ref; ) {
          const y = _.$ref, b = y.split("#", 2);
          if (delete _.$ref, b[0].length > 0) {
            w.push(c(_, b[0], b[1], v));
            return;
          } else if (!x.has(y)) {
            const L = b[1];
            h(_, p, v, L), x.add(y);
      ...
      return this.traverseNodes(g, (v) => {
        const w = v.$id || v.id, _ = fo(w) && w.charAt(0) === "#" ? w.substring(1) : v.$anchor;
        _ && (p.has(_) ? n.push(E("Duplicate anchor declaration: '{0}'", _)) : p.set(_, v)), v.$recursiveAnchor && s.add("$recursiveAnchor"), v.$dynamicAnchor && s.add("$dynamicAnchor");
      }), p;
    };
    return d(r, r, t).then((g) => {
      let p = [];
      return s.size && p.push(E("The schema uses meta-schema features ({0}) that are not yet supported by the validator.", Array.from(s.keys()).join(", "))), new Va(r, n, p, i);
    });
  }
  traverseNodes(e, t) {
    if (!e || typeof e != "object")
  ...
  getAssociatedSchemas(e) {
    const t = /* @__PURE__ */ Object.create(null), n = [], r = yo(e);
  ...
  getMatchingSchemas(e, t, n) {
    if (n) {
      const r = n.id || "schemaservice://untitled/matchingSchemas/" + s1++;
  ...
  for (; l !== 17; ) {
    switch (l) {
      ...
      case 13: {
        ...
        a.getTokenError() === 1 && g + 1 < e.lineCount ? a.setPosition(e.offsetAt(Y.create(g + 1, 0))) : g < p && (o({ startLine: g, endLine: p, kind: Ot.Comment }), s = g);
        break;
      }
      case 12: {
        const p = e.getText().substr(a.getTokenOffset(), a.getTokenLength()).match(/^\/\/\s*#(region\b)|(endregion\b)/);
        if (p) {
          const v = e.positionAt(a.getTokenOffset()).line;
          if (p[1]) {
            const w = { startLine: v, endLine: v, kind: Ot.Region };
            i.push(w);
          } else {
            let w = i.length - 1;
            for (; w >= 0 && i[w].kind !== Ot.Region; )
              w--;
            if (w >= 0) {
              const _ = i[w];
              i.length = w, v > _.startLine && s !== _.startLine && (_.endLine = v, o(_), s = _.startLine);
            }
          }
        }
        break;
...
function o1(e, t, n) {
  function r(l) {
    ...
    for (let d = h.length - 1; d >= 0; d--)
      c = En.create(h[d], c);
    return c || (c = En.create(q.create(l, l))), c;
  }
  function i(l, o) {
    return q.create(e.positionAt(l), e.positionAt(o));
  }
  const s = rt(e.getText(), !0);
  function a(l, o) {
...
`,
  ...
  return Ac(e.getText(), r, i).map((s) => Ve.replace(q.create(e.positionAt(s.offset), e.positionAt(s.offset + s.length)), s.content));
}
var se;
(function(e) {
...
var Kt = class {
  ...
  addChildProperty(e) {
    if (e.parent = this, this.childrenProperties.length > 0) {
      let t = 0;
      e.noKeyName ? t = this.childrenProperties.length : t = u1(this.childrenProperties, e, l1), t < 0 && (t = t * -1 - 1), this.childrenProperties.splice(t, 0, e);
    } else
...
function c1(e, t) {
  ...
  }, r = Ee.applyEdits(e, Mr(e, n, void 0)), i = Ee.create("test://test.json", "json", 0, r), s = f1(i), a = h1(i, s), l = Mr(a, n, void 0), o = Ee.applyEdits(a, l);
  return [Ve.replace(q.create(Y.create(0, 0), e.positionAt(e.getText().length)), o)];
}
function f1(e) {
  const t = e.getText(), n = rt(t, !1);
  let r = new Kt(), i = r, s = r, a = r, l, o = 0, u = 0, h, c, d = -1, m = -1, g = 0, p = 0, v = [], w = !1, _ = !1;
  for (; (l = n.scan()) !== 17; ) {
    if (w === !0 && l !== 14 && l !== 15 && l !== 12 && l !== 13 && s.endLineNumber === void 0) {
      let x = n.getTokenStartLine();
      c === 2 || c === 4 ? a.endLineNumber = x - 1 : s.endLineNumber = x - 1, g = x, w = !1;
    }
    if (_ === !0 && l !== 14 && l !== 15 && l !== 12 && l !== 13 && (g = n.getTokenStartLine(), _ = !1), n.getTokenStartLine() !== o) {
      for (let x = o; x < n.getTokenStartLine(); x++) {
        const y = e.getText(q.create(Y.create(x, 0), Y.create(x + 1, 0))).length;
        u = u + y;
      }
    ...
    switch (l) {
      case 10: {
        if (h === void 0 || h === 1 || h === 5 && v[v.length - 1] === se.Object) {
          const x = new Kt(n.getTokenValue(), g);
          a = s, s = i.addChildProperty(x);
        }
        break;
      }
      case 3: {
        if (r.beginningLineNumber === void 0 && (r.beginningLineNumber = n.getTokenStartLine()), v[v.length - 1] === se.Object)
          i = s;
        else if (v[v.length - 1] === se.Array) {
          const x = new Kt(n.getTokenValue(), g);
          x.noKeyName = !0, a = s, s = i.addChildProperty(x), i = s;
        }
        v.push(se.Array), s.type = se.Array, g = n.getTokenStartLine(), g++;
        break;
      }
      case 1: {
        if (r.beginningLineNumber === void 0)
          ...
          const x = new Kt(n.getTokenValue(), g);
          x.noKeyName = !0, a = s, s = i.addChildProperty(x);
        }
        s.type = se.Object, v.push(se.Object), i = s, g = n.getTokenStartLine(), g++;
        break;
      }
      case 4: {
        p = n.getTokenStartLine(), v.pop(), s.endLineNumber === void 0 && (h === 2 || h === 4) && (s.endLineNumber = p - 1, s.lastProperty = !0, s.lineWhereToAddComma = d, s.indexWhereToAddComa = m, a = s, s = s ? s.parent : void 0, i = s), r.endLineNumber = p, g = p + 1;
        break;
      }
      case 2: {
        p = n.getTokenStartLine(), v.pop(), h !== 1 && (s.endLineNumber === void 0 && (s.endLineNumber = p - 1, s.lastProperty = !0, s.lineWhereToAddComma = d, s.indexWhereToAddComa = m), a = s, s = s ? s.parent : void 0, i = s), r.endLineNumber = n.getTokenStartLine(), g = p + 1;
        break;
      }
      case 5: {
        p = n.getTokenStartLine(), s.endLineNumber === void 0 && (v[v.length - 1] === se.Object || v[v.length - 1] === se.Array && (h === 2 || h === 4)) && (s.endLineNumber = p, s.commaIndex = n.getTokenOffset() - u, s.commaLine = p), (h === 2 || h === 4) && (a = s, s = s ? s.parent : void 0, i = s), g = p + 1;
        break;
      }
      case 13: {
        h === 5 && d === n.getTokenStartLine() && (v[v.length - 1] === se.Array && (c === 2 || c === 4) || v[v.length - 1] === se.Object) && (v[v.length - 1] === se.Array && (c === 2 || c === 4) || v[v.length - 1] === se.Object) && (s.endLineNumber = void 0, w = !0), (h === 1 || h === 3) && d === n.getTokenStartLine() && (_ = !0);
        break;
      }
    }
...
function h1(e, t) {
  ...
  for (Da(r, t, t.beginningLineNumber); r.length > 0; ) {
    ...
    for (let l = 0; l < s.length; l++) {
      const o = s[l], u = q.create(Y.create(o.beginningLineNumber, 0), Y.create(o.endLineNumber + 1, 0)), h = e.getText(u), c = Ee.create("test://test.json", "json", 0, h);
      if (o.lastProperty === !0 && l !== s.length - 1) {
        const g = o.lineWhereToAddComma - o.beginningLineNumber, p = o.indexWhereToAddComa, v = {
          range: q.create(Y.create(g, p), Y.create(g, p)),
          text: ","
        };
        Ee.update(c, [v], 1);
      } else if (o.lastProperty === !1 && l === s.length - 1) {
        const g = o.commaIndex, v = o.commaLine - o.beginningLineNumber, w = {
          range: q.create(Y.create(v, g), Y.create(v, g + 1)),
          text: ""
        };
        Ee.update(c, [w], 1);
      }
      const d = o.endLineNumber - o.beginningLineNumber + 1, m = {
        range: q.create(Y.create(a, 0), Y.create(a + d, 0)),
        text: c.getText()
      };
      Ee.update(n, [m], 1), Da(r, o, a), a = a + d;
    }
  }
  return n;
}
function Da(e, t, n) {
  if (t.childrenProperties.length !== 0)
    if (t.type === se.Object) {
      ...
      n = n + i, e.push(new _o(n, t.childrenProperties));
    } else t.type === se.Array && wo(e, t, n);
}
function wo(e, t, n) {
  for (const r of t.childrenProperties) {
    if (r.type === se.Object) {
      ...
      e.push(new _o(n + r.beginningLineNumber - t.beginningLineNumber + s, r.childrenProperties));
    }
    r.type === se.Array && wo(e, r, n + r.beginningLineNumber - t.beginningLineNumber);
  }
}
var _o = class {
  constructor(e, t) {
...
function Cr(e, t) {
  ...
  if (t && t.type === "object") {
    ...
    return i ? Cr(e, i) : null;
  }
  return null;
}
function p1(e) {
  return e === "#" ? [] : e[0] !== "#" || e[1] !== "/" ? null : e.substring(2).split(/\//).map(b1);
}
function b1(e) {
  return e.replace(/~1/g, "/").replace(/~0/g, "~");
}
function v1(e) {
  const t = e.promiseConstructor || Promise, n = new i1(e.schemaRequestService, e.workspaceContext, t);
  n.setSchemaContributions(Er);
  const r = new qc(n, e.contributions, t, e.clientCapabilities), i = new jc(n, e.contributions, t), s = new Yc(n), a = new Hc(n, t);
  return {
    configure: (l) => {
    ...
    getFoldingRanges: a1,
    getSelectionRanges: o1,
    findDefinition: () => Promise.resolve([]),
    findLinks: d1,
    format: (l, o, u) => Mr(l, u, o),
    sort: (l, o) => c1(l, o)
  };
}
var Lo;
typeof fetch < "u" && (Lo = function(e) {
  return fetch(e).then((t) => t.text());
});
var x1 = class {
  constructor(e, t) {
    this._ctx = e, this._languageSettings = t.languageSettings, this._languageId = t.languageId, this._languageService = v1({
      workspaceContext: {
      ...
      schemaRequestService: t.enableSchemaRequest ? Lo : void 0,
      clientCapabilities: Ar.LATEST
...
function No(e) {
  const t = [];
  for (const r of e)
    r.length === 0 || r.length === 1 && r.charCodeAt(0) === Wn || (r.length === 2 && r.charCodeAt(0) === Wn && r.charCodeAt(1) === Wn ? t.pop() : t.push(r));
