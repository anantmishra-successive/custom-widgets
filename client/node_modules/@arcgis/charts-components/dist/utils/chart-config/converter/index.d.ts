import { SupportedLayer, WebChart, WebGaugeChart } from '@arcgis/charts-spec';
 ...
 */
export declare function convertChartSpec<T extends WebChart | WebGaugeChart>(config?: T, layerOrLayerView?: FeatureLayerView | SupportedLayer): Promise<T>;
