...
import { SupportedCharts } from '../../utils';
import { SupportedLayer } from '@arcgis/charts-spec';
import { default as Sublayer } from '@arcgis/core/layers/support/Sublayer.js';
export declare const HTMLClasses: {
    readonly chartUIComponent: "chart-ui-component";
...
/**
 * Reorder the layer's `charts` array based on the updated model list.
 * @param layer The layer to update the `charts` array on.
 * @param chartList The list of charts to update the layer with.
 */
export declare function reorderChartListInLayer(layer: Sublayer | SupportedLayer | undefined, modelList: ChartModel[]): void;
