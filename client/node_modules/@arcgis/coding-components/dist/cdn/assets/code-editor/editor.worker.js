...
const It = "Canceled";
function Ar(e) {
  return e instanceof Rr ? !0 : e instanceof Error && e.name === It && e.message === It;
}
class Rr extends Error {
  constructor() {
    super(It), this.name = this.message;
  }
}
...
(function(e) {
  ...
  e.reduce = x;
  function* v(p, _, L = p.length) {
    for (_ < 0 && (_ += p.length), L < 0 ? L += p.length : L > p.length && (L = p.length); _ < L; _++)
      yield p[_];
  }
  e.slice = v;
  function S(p, _ = Number.POSITIVE_INFINITY) {
    const L = [];
    if (_ === 0)
      return [L, p];
...
class W {
  static {
    this.Undefined = new W(void 0);
  }
  constructor(t) {
    this.element = t, this.next = W.Undefined, this.prev = W.Undefined;
  }
}
class Mr {
  constructor() {
  ...
  _remove(t) {
    ...
    } else t.prev === W.Undefined && t.next === W.Undefined ? (this._first = W.Undefined, this._last = W.Undefined) : t.next === W.Undefined ? (this._last = this._last.prev, this._last.next = W.Undefined) : t.prev === W.Undefined && (this._first = this._first.next, this._first.prev = W.Undefined);
    this._size -= 1;
  }
  *[Symbol.iterator]() {
    let t = this._first;
...
(function(e) {
  ...
  function n(C) {
    return (w, E = null, R) => {
      ...
      return V = C((U) => {
        if (!P)
          return V ? V.dispose() : P = !0, w.call(E, U);
      }, null, R), P && V.dispose(), V;
    };
  }
  e.once = n;
  function s(C, w) {
  ...
  e.onceIf = s;
  function r(C, w, E) {
    return f((R, P = null, V) => C((U) => R.call(P, w(U)), null, V), E);
  }
  e.map = r;
  function i(C, w, E) {
    return f((R, P = null, V) => C((U) => {
      w(U), R.call(P, U);
    }, null, V), E);
  }
  e.forEach = i;
  function o(C, w, E) {
    return f((R, P = null, V) => C((U) => w(U) && R.call(P, U), null, V), E);
  }
  e.filter = o;
  function l(C) {
    return C;
  ...
  function u(...C) {
    return (w, E = null, R) => {
      const P = Er(...C.map((V) => V((U) => w.call(E, U))));
      return h(P, R);
    };
  }
  e.any = u;
  ...
  function f(C, w) {
    ...
    return w?.add(P), P.event;
  }
  function h(C, w) {
    return w instanceof Array ? w.push(C) : w && w.add(C), C;
  }
  function d(C, w, E = 100, R = !1, P = !1, V, U) {
    let Y, Z, Me, tt = 0, We;
    const Lr = {
      leakWarningThreshold: V,
      onWillAddFirstListener() {
        Y = C((vr) => {
          tt++, Z = w(Z, vr), R && !Me && (nt.fire(Z), Z = void 0), We = () => {
            const Nr = Z;
            Z = void 0, Me = void 0, (!R || tt > 1) && nt.fire(Nr), tt = 0;
          }, typeof E == "number" ? (clearTimeout(Me), Me = setTimeout(We, E)) : Me === void 0 && (Me = 0, queueMicrotask(We));
        });
      },
    ...
    return U?.add(nt), nt.event;
  }
  e.debounce = d;
  function m(C, w = 0, E) {
    return e.debounce(C, (R, P) => R ? (R.push(P), R) : [P], w, void 0, !0, void 0, E);
  }
  e.accumulate = m;
  function g(C, w = (R, P) => R === P, E) {
    let R = !0, P;
    return o(C, (V) => {
      const U = R || !w(V, P);
      return R = !1, P = V, U;
  ...
  e.split = b;
  function x(C, w = !1, E = [], R) {
    let P = E.slice(), V = C((Z) => {
      P ? P.push(Z) : Y.fire(Z);
    });
    R && R.add(V);
    const U = () => {
      P?.forEach((Z) => Y.fire(Z)), P = null;
    }, Y = new oe({
      onWillAddFirstListener() {
        V || (V = C((Z) => Y.fire(Z)), R && R.add(V));
      },
  ...
  class N {
    ...
    forEach(w) {
      return this.steps.push((E) => (w(E), E)), this;
    }
    filter(w) {
      return this.steps.push((E) => w(E) ? E : S), this;
    }
    reduce(w, E) {
      let R = E;
      return this.steps.push((P) => (R = w(R, P), R)), this;
    }
    latch(w = (E, R) => E === R) {
      let E = !0, R;
      return this.steps.push((P) => {
        const V = E || !w(P, R);
        return E = !1, R = P, V ? P : S;
      }), this;
    }
    evaluate(w) {
  ...
  function p(C, w, E = (R) => R) {
    const R = (...Y) => U.fire(E(...Y)), P = () => C.on(w, R), V = () => C.removeListener(w, R), U = new oe({ onWillAddFirstListener: P, onDidRemoveLastListener: V });
    return U.event;
  }
  e.fromNodeEventEmitter = p;
  function _(C, w, E = (R) => R) {
    const R = (...Y) => U.fire(E(...Y)), P = () => C.addEventListener(w, R), V = () => C.removeEventListener(w, R), U = new oe({ onWillAddFirstListener: P, onDidRemoveLastListener: V });
    return U.event;
  }
  ...
  class Q {
    constructor(w, E) {
      ...
      this.emitter = new oe(R), E && E.add(this.emitter);
    }
    beginUpdate(w) {
      this._counter++;
    }
  ...
  function q(C, w) {
    return new Q(C, w).emitter.event;
  }
  e.fromObservable = q;
  function F(C) {
    return (w, E, R) => {
      ...
      const U = {
        ...
        endUpdate() {
          P--, P === 0 && (C.reportChanges(), V && (V = !1, w.call(E)));
        },
      ...
      return R instanceof Ke ? R.add(Y) : Array.isArray(R) && R.push(Y), Y;
    };
  }
...
class bt {
  ...
  start(t) {
    this._stopWatch = new At(), this.listenerCount = t;
  }
  stop() {
    if (this._stopWatch) {
...
class nn {
  ...
  constructor(t, n, s = (nn._idPool++).toString(16).padStart(3, "0")) {
...
class oe {
  constructor(t) {
    this._size = 0, this._options = t, this._leakageMon = this._options?.leakWarningThreshold ? new nn(t?.onListenerError ?? Xe, this._options?.leakWarningThreshold ?? Pr) : void 0, this._perfMon = this._options?._profName ? new bt(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (t, n, s) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(l);
        const u = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], c = new Dr(`${l}. HINT: Stack shows most frequent listener (${u[1]}-times)`, u[0]);
        return (this._options?.onListenerError || Xe)(c), mt.None;
      }
      if (this._disposed)
        return mt.None;
      n && (t = t.bind(n));
      const r = new yt(t);
      let i;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = sn.create(), i = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof yt ? (this._deliveryQueue ??= new Vr(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._size++;
      const o = dt(() => {
        i?.(), this._removeListener(r);
      });
      return s instanceof Ke ? s.add(o) : Array.isArray(s) && s.push(o), o;
    }, this._event;
  }
  _removeListener(t) {
    ...
    if (this._size * Tr <= n.length) {
      ...
      for (let o = 0; o < n.length; o++)
        n[o] ? n[i++] = n[o] : r && (this._deliveryQueue.end--, i < this._deliveryQueue.i && this._deliveryQueue.i--);
      n.length = i;
    }
  }
  _deliver(t, n) {
    if (!t)
      return;
    const s = this._options?.onListenerError || Xe;
    if (!s) {
      t.value(n);
      return;
    }
   ...
   */
  fire(t) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof yt)
...
const Br = Zs() === "pseudo" || typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function fn(e, t) {
  let n;
  ...
  }), Br && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function z(e, t, ...n) {
  return fn(typeof e == "number" ? qr(e, t) : t, n);
}
function qr(e, t) {
  const n = Ir()?.[e];
  if (typeof n != "string") {
...
const Ie = "en";
let Bt = !1, qt = !1, Et = !1, Ks = !1, rn = !1, st, Mt = Ie, dn = Ie, Ur, ge;
const be = globalThis;
let ie;
typeof be.vscode < "u" && typeof be.vscode.process < "u" ? ie = be.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (ie = process);
const Hr = typeof ie?.versions?.electron == "string", $r = Hr && ie?.type === "renderer";
if (typeof ie == "object") {
  Bt = ie.platform === "win32", qt = ie.platform === "darwin", Et = ie.platform === "linux", Et && ie.env.SNAP && ie.env.SNAP_REVISION, ie.env.CI || ie.env.BUILD_ARTIFACTSTAGINGDIRECTORY, st = Ie, Mt = Ie;
  const e = ie.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      st = t.userLocale, dn = t.osLocale, Mt = t.resolvedLanguage || Ie, Ur = t.languagePack?.translationsConfigFile;
    } catch {
    }
  Ks = !0;
} else typeof navigator == "object" && !$r ? (ge = navigator.userAgent, Bt = ge.indexOf("Windows") >= 0, qt = ge.indexOf("Macintosh") >= 0, (ge.indexOf("Macintosh") >= 0 || ge.indexOf("iPad") >= 0 || ge.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Et = ge.indexOf("Linux") >= 0, ge?.indexOf("Mobi") >= 0, rn = !0, Mt = Zs() || Ie, st = navigator.language.toLowerCase(), dn = st) : console.error("Unable to resolve platform.");
const Ye = Bt, Wr = qt, zr = Ks, Or = rn, Gr = rn && typeof be.importScripts == "function", jr = Gr ? be.origin : void 0, me = ge, Xr = typeof be.postMessage == "function" && !be.importScripts;
(() => {
  if (Xr) {
    const e = [];
    ...
    return (n) => {
      ...
      e.push({
        id: s,
        callback: n
      }), be.postMessage({ vscodeScheduleAsyncWork: s }, "*");
    };
  }
  return (e) => setTimeout(e);
})();
const Qr = !!(me && me.indexOf("Chrome") >= 0);
me && me.indexOf("Firefox") >= 0;
!Qr && me && me.indexOf("Safari") >= 0;
me && me.indexOf("Edg/") >= 0;
...
class Jr {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = Yr) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
class Ce {
  ...
  static {
    this._locales = new mn(() => Object.keys(Ce.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
  }
  static getLocales() {
...
let qe;
const kt = globalThis.vscode;
if (typeof kt < "u" && typeof kt.process < "u") {
  const e = kt.process;
  qe = {
    get platform() {
      return e.platform;
...
} else typeof process < "u" && typeof process?.versions?.node == "string" ? qe = {
  get platform() {
  ...
  // Supported
  get platform() {
    return Ye ? "win32" : Wr ? "darwin" : "linux";
  },
  get arch() {
  },
  // Unsupported
...
const pt = qe.cwd, ii = qe.env, ai = qe.platform, oi = 65, li = 97, ui = 90, ci = 122, Re = 46, J = 47, te = 92, we = 58, hi = 63;
...
function xt(e, t, n, s) {
  ...
  for (let c = 0; c <= e.length; ++c) {
    ...
    if (s(u)) {
      if (!(o === c - 1 || l === 1)) if (l === 2) {
        if (r.length < 2 || i !== 2 || r.charCodeAt(r.length - 1) !== Re || r.charCodeAt(r.length - 2) !== Re) {
          if (r.length > 2) {
...
function sr(e, t) {
  ...
  const n = t.dir || t.root, s = t.base || `${t.name || ""}${di(t.ext)}`;
...
const K = {
  ...
  resolve(...e) {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      let i;
      if (r >= 0) {
        if (i = e[r], j(i, `paths[${r}]`), i.length === 0)
          continue;
      } else t.length === 0 ? i = pt() : (i = ii[`=${t}`] || pt(), (i === void 0 || i.slice(0, 2).toLowerCase() !== t.toLowerCase() && i.charCodeAt(2) === te) && (i = `${t}\\`));
      const o = i.length;
      let l = 0, u = "", c = !1;
      ...
      if (o === 1)
        ...
        if (c = !0, T(i.charCodeAt(1))) {
          ...
          l = 1;
      else Le(f) && i.charCodeAt(1) === we && (u = i.slice(0, 2), l = 2, o > 2 && T(i.charCodeAt(2)) && (c = !0, l = 3));
      if (u.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (T(i))
      if (r = !0, T(e.charCodeAt(1))) {
        ...
        n = 1;
    else Le(i) && e.charCodeAt(1) === we && (s = e.slice(0, 2), n = 2, t > 2 && T(e.charCodeAt(2)) && (r = !0, n = 3));
    let o = n < t ? xt(e.slice(n), !r, "\\", T) : "";
  ...
  isAbsolute(e) {
    ...
    t > 2 && Le(n) && e.charCodeAt(1) === we && T(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let i = 0; i < e.length; ++i) {
      const o = e[i];
      j(o, "path"), o.length > 0 && (t === void 0 ? t = n = o : t += `\\${o}`);
    }
    if (t === void 0)
      return ".";
    let s = !0, r = 0;
  ...
  relative(e, t) {
    ...
    if (n === s || (e = n.toLowerCase(), t = s.toLowerCase(), e === t))
      return "";
    let r = 0;
    for (; r < e.length && e.charCodeAt(r) === te; )
      r++;
    let i = e.length;
    for (; i - 1 > r && e.charCodeAt(i - 1) === te; )
      i--;
    const o = i - r;
    let l = 0;
    for (; l < t.length && t.charCodeAt(l) === te; )
      l++;
    let u = t.length;
    for (; u - 1 > l && t.charCodeAt(u - 1) === te; )
      u--;
    ...
    if (d !== f) {
      ...
      if (c > f) {
        if (t.charCodeAt(l + d) === te)
          return s.slice(l + d + 1);
        if (d === 2)
          return s.slice(l + d);
      }
      o > f && (e.charCodeAt(r + d) === te ? h = d : d === 2 && (h = 3)), h === -1 && (h = 0);
    }
    let m = "";
    for (d = r + h + 1; d <= i; ++d)
      (d === i || e.charCodeAt(d) === te) && (m += m.length === 0 ? ".." : "\\..");
    return l += h, m.length > 0 ? `${m}${s.slice(l, u)}` : (s.charCodeAt(l) === te && ++l, s.slice(l, u));
  },
  toNamespacedPath(e) {
    ...
    } else if (Le(t.charCodeAt(0)) && t.charCodeAt(1) === we && t.charCodeAt(2) === te)
      return `\\\\?\\${t}`;
    return e;
  },
  dirname(e) {
    ...
    } else Le(r) && e.charCodeAt(1) === we && (n = t > 2 && T(e.charCodeAt(2)) ? 3 : 2, s = n);
    let i = -1, o = !0;
    for (let l = t - 1; l >= s; --l)
      if (T(e.charCodeAt(l))) {
        if (!o) {
  ...
  basename(e, t) {
    t !== void 0 && j(t, "suffix"), j(e, "path");
    let n = 0, s = -1, r = !0, i;
    if (e.length >= 2 && Le(e.charCodeAt(0)) && e.charCodeAt(1) === we && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === we && Le(e.charCodeAt(0)) && (t = s = 2);
    for (let l = e.length - 1; l >= t; --l) {
      ...
      r === -1 && (i = !1, r = l + 1), u === Re ? n === -1 ? n = l : o !== 1 && (o = 1) : n !== -1 && (o = -1);
    }
  ...
  parse(e) {
    ...
    } else if (Le(r) && e.charCodeAt(1) === we) {
      if (n <= 2)
    ...
    for (; c >= s; --c) {
      ...
      l === -1 && (u = !1, l = c + 1), r === Re ? i === -1 ? i = c : f !== 1 && (f = 1) : i !== -1 && (f = -1);
    }
  ...
  resolve(...e) {
    ...
    for (let s = e.length - 1; s >= -1 && !n; s--) {
      const r = s >= 0 ? e[s] : mi();
      j(r, `paths[${s}]`), r.length !== 0 && (t = `${r}/${t}`, n = r.charCodeAt(0) === J);
    }
    return t = xt(t, !n, "/", Ht), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (j(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === J, n = e.charCodeAt(e.length - 1) === J;
    return e = xt(e, !t, "/", Ht), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
    return j(e, "path"), e.length > 0 && e.charCodeAt(0) === J;
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let n = 0; n < e.length; ++n) {
      const s = e[n];
      j(s, "path"), s.length > 0 && (t === void 0 ? t = s : t += `/${s}`);
    }
    return t === void 0 ? "." : ee.normalize(t);
  },
  relative(e, t) {
    if (j(e, "from"), j(t, "to"), e === t || (e = ee.resolve(e), t = ee.resolve(t), e === t))
      return "";
    ...
    if (c === l)
      if (o > l) {
        ...
        if (c === 0)
          return t.slice(i + c);
      } else r > l && (e.charCodeAt(n + c) === J ? u = c : c === 0 && (u = 0));
    let f = "";
    for (c = n + u + 1; c <= s; ++c)
  ...
  extname(e) {
    ...
    for (let o = e.length - 1; o >= 0; --o) {
      ...
      s === -1 && (r = !1, s = o + 1), l === Re ? t === -1 ? t = o : i !== 1 && (i = 1) : t !== -1 && (i = -1);
    }
  ...
  parse(e) {
    ...
    for (; u >= s; --u) {
      ...
      o === -1 && (l = !1, o = u + 1), f === Re ? r === -1 ? r = u : c !== 1 && (c = 1) : r !== -1 && (c = -1);
    }
    if (o !== -1) {
      const f = i === 0 && n ? 1 : i;
...
ee.win32 = K.win32 = K;
ee.posix = K.posix = ee;
xe ? K.normalize : ee.normalize;
const gi = xe ? K.join : ee.join;
xe ? K.resolve : ee.resolve;
xe ? K.relative : ee.relative;
xe ? K.dirname : ee.dirname;
xe ? K.basename : ee.basename;
xe ? K.extname : ee.extname;
xe ? K.sep : ee.sep;
const bi = /^\w[\w\d+.-]*$/, _i = /^\//, pi = /^\/\//;
function xi(e, t) {
  if (!e.scheme && t)
    throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`);
  if (e.scheme && !bi.test(e.scheme))
    throw new Error("[UriError]: Scheme contains illegal characters.");
  if (e.path) {
    if (e.authority) {
      if (!_i.test(e.path))
        throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
    } else if (pi.test(e.path))
...
class ne {
  ...
  constructor(t, n, s, r, i, o = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || $, this.authority = t.authority || $, this.path = t.path || $, this.query = t.query || $, this.fragment = t.fragment || $) : (this.scheme = wi(t, o), this.authority = n || $, this.path = Li(this.scheme, s || $), this.query = r || $, this.fragment = i || $, xi(this, o));
  }
  // ---- filesystem path -----------------------
  /**
  ...
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = $), s === void 0 ? s = this.authority : s === null && (s = $), r === void 0 ? r = this.path : r === null && (r = $), i === void 0 ? i = this.query : i === null && (i = $), o === void 0 ? o = this.fragment : o === null && (o = $), n === this.scheme && s === this.authority && r === this.path && i === this.query && o === this.fragment ? this : new ke(n, s, r, i, o);
  }
  // ---- parse & validate ------------------------
  /**
  ...
  static parse(t, n = !1) {
    const s = vi.exec(t);
    return s ? new ke(s[2] || $, rt(s[4] || $), rt(s[5] || $), rt(s[7] || $), rt(s[9] || $), n) : new ke($, $, $, $, $);
  }
  /**
  ...
  static file(t) {
    let n = $;
    if (Ye && (t = t.replace(/\\/g, ce)), t[0] === ce && t[1] === ce) {
      const s = t.indexOf(ce, 2);
      s === -1 ? (n = t.substring(2), t = ce) : (n = t.substring(2, s), t = t.substring(s) || ce);
    }
    return new ke("file", n, t, $, $);
  }
  /**
  ...
  static joinPath(t, ...n) {
    ...
    let s;
    return Ye && t.scheme === "file" ? s = ne.file(K.join($t(t, !0), ...n)).path : s = ee.join(t.path, ...n), t.with({ path: s });
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new ke(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === rr ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
}
const rr = Ye ? 1 : void 0;
class ke extends ne {
  constructor() {
  ...
  toString(t = !1) {
    return t ? Wt(this, !0) : (this._formatted || (this._formatted = Wt(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: 1
...
function Ni(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const s = e.charCodeAt(n);
    s === 35 || s === 63 ? (t === void 0 && (t = e.substr(0, n)), t += ir[s]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function $t(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === 47 && (e.path.charCodeAt(1) >= 65 && e.path.charCodeAt(1) <= 90 || e.path.charCodeAt(1) >= 97 && e.path.charCodeAt(1) <= 122) && e.path.charCodeAt(2) === 58 ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, Ye && (n = n.replace(/\//g, "\\")), n;
}
function Wt(e, t) {
  const n = t ? Ni : gn;
  let s = "", { scheme: r, authority: i, path: o, query: l, fragment: u } = e;
  if (r && (s += r, s += ":"), (i || r === "file") && (s += ce, s += ce), i) {
    let c = i.indexOf("@");
    if (c !== -1) {
  ...
  return l && (s += "?", s += n(l, !1, !1)), u && (s += "#", s += t ? u : gn(u, !1, !1)), s;
}
function ar(e) {
  try {
...
function rt(e) {
  return e.match(bn) ? e.replace(bn, (t) => ar(t)) : e;
}
var Ae;
(function(e) {
...
class Ci {
  ...
  get _remoteResourcesPath() {
    return ee.join(this._serverRootPath, Ae.vscodeRemoteResource);
  }
  rewrite(t) {
    if (this._delegate)
      try {
    ...
    return typeof i == "string" && (o += `&${Si}=${encodeURIComponent(i)}`), ne.from({
      scheme: Or ? this._preferredWebSchema : Ae.vscodeRemoteResource,
      authority: `${s}:${r}`,
...
const Ai = new Ci(), Ri = "vscode-app";
class wt {
  static {
    this.FALLBACK_AUTHORITY = Ri;
  }
  /**
   ...
   */
  uriToBrowserUri(t) {
    return t.scheme === Ae.vscodeRemote ? Ai.rewrite(t) : (
      // ...only ever for `file` resources
      t.scheme === Ae.file && // ...and we run in native environments
      (zr || // ...or web worker extensions on desktop
      jr === `${Ae.vscodeFileResource}://${wt.FALLBACK_AUTHORITY}`) ? t.with({
  ...
  toUri(t, n) {
    ...
    if (globalThis._VSCODE_FILE_ROOT) {
      ...
      if (/^\w[\w\d+.-]*:\/\//.test(s))
        return ne.joinPath(ne.parse(s, !0), t);
      const r = gi(s, t);
      return ne.file(r);
    }
    return ne.parse(n.toUrl(t));
  }
}
const or = new wt();
var _n;
(function(e) {
  ...
  function s(i) {
    let o;
    typeof i == "string" ? o = new URL(i).searchParams : i instanceof URL ? o = i.searchParams : ne.isUri(i) && (o = new URL(i.toString(!0)).searchParams);
    const l = o?.get(n);
    if (l)
      return t.get(l);
  }
...
const Pt = "default", yi = "$initialize";
class Ei {
...
class Fi {
  ...
  sendMessage(t, n, s) {
    ...
    return new Promise((i, o) => {
      this._pendingReplies[r] = {
        resolve: i,
        reject: o
      }, this._send(new Ei(this._workerId, r, t, n, s));
    });
  }
  listen(t, n, s) {
    let r = null;
    const i = new oe({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, i), this._send(new Mi(this._workerId, r, t, n, s));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(r), this._send(new Pi(this._workerId, r)), r = null;
      }
    });
    return i.event;
  }
  ...
  createProxyToRemoteChannel(t, n) {
    const s = {
      get: (r, i) => (typeof i == "string" && !r[i] && (ur(i) ? r[i] = (o) => this.listen(t, i, o) : lr(i) ? r[i] = this.listen(t, i, void 0) : i.charCodeAt(0) === 36 && (r[i] = async (...o) => (await n?.(), this.sendMessage(t, i, o)))), r[i])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((r) => {
      this._send(new pn(this._workerId, n, r, void 0));
    }, (r) => {
      r.detail instanceof Error && (r.detail = hn(r.detail)), this._send(new pn(this._workerId, n, void 0, hn(r)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, s = this._handler.handleEvent(t.channel, t.eventName, t.arg)((r) => {
      this._send(new ki(this._workerId, n, r));
    });
...
class Di {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new Fi({
      sendMessage: (s, r) => {
        t(s, r);
      },
  ...
  _handleMessage(t, n, s) {
    ...
    const r = t === Pt ? this._requestHandler : this._localChannels.get(t);
    if (!r)
  ...
  async initialize(t, n, s) {
    ...
    return n && (typeof n.baseUrl < "u" && delete n.baseUrl, typeof n.paths < "u" && typeof n.paths.vs < "u" && delete n.paths.vs, typeof n.trustedTypesPolicy < "u" && delete n.trustedTypesPolicy, n.catchError = !0, globalThis.require.config(n)), import(`${or.asBrowserUri(`${s}.js`).toString(!0)}`).then((i) => {
...
function Ti(e, t) {
  ...
  for (let n = 0, s = e.length; n < s; n++)
    t = xn(e.charCodeAt(n), t);
  return t;
}
function Ft(e, t, n = 32) {
  const s = n - t, r = ~((1 << s) - 1);
  return (e << t | (r & e) >>> s) >>> 0;
}
function wn(e, t = 0, n = e.byteLength, s = 0) {
  for (let r = 0; r < n; r++)
    e[t + r] = s;
}
function Vi(e, t, n = "0") {
...
function ze(e, t = 32) {
  return e instanceof ArrayBuffer ? Array.from(new Uint8Array(e)).map((n) => n.toString(16).padStart(2, "0")).join("") : Vi((e >>> 0).toString(16), t / 4);
}
class cr {
  static {
  ...
  digest() {
    ...
    )), this._totalLen += this._buffLen, this._wrapUp()), ze(this._h0) + ze(this._h1) + ze(this._h2) + ze(this._h3) + ze(this._h4);
  }
  _wrapUp() {
  ...
  _step() {
    const t = cr._bigBlock32, n = this._buffDV;
    for (let h = 0; h < 64; h += 4)
      t.setUint32(h, n.getUint32(h, !1), !1);
    for (let h = 64; h < 320; h += 4)
      t.setUint32(h, Ft(t.getUint32(h - 12, !1) ^ t.getUint32(h - 32, !1) ^ t.getUint32(h - 56, !1) ^ t.getUint32(h - 64, !1), 1), !1);
    let s = this._h0, r = this._h1, i = this._h2, o = this._h3, l = this._h4, u, c, f;
    for (let h = 0; h < 80; h++)
      h < 20 ? (u = r & i | ~r & o, c = 1518500249) : h < 40 ? (u = r ^ i ^ o, c = 1859775393) : h < 60 ? (u = r & i | r & o | i & o, c = 2400959708) : (u = r ^ i ^ o, c = 3395469782), f = Ft(s, 5) + u + l + c + t.getUint32(h * 4, !1) & 4294967295, l = o, o = i, i = Ft(r, 30), r = s, s = f;
...
function Ii(e, t, n) {
  return new Se(new Ln(e), new Ln(t)).ComputeDiff(n).changes;
}
class Pe {
  static Assert(t, n) {
    if (!t)
...
class Se {
  ...
  constructor(t, n, s = null) {
    ...
    const [r, i, o] = Se._getElements(t), [l, u, c] = Se._getElements(n);
  ...
  ElementsAreStrictEqual(t, n) {
    if (!this.ElementsAreEqual(t, n))
      return !1;
    const s = Se._getStrictElement(this._originalSequence, t), r = Se._getStrictElement(this._modifiedSequence, n);
    return s === r;
  }
  ...
  ComputeDiffRecursive(t, n, s, r, i) {
    ...
    if (t > n || s > r) {
      let h;
      return s <= r ? (Pe.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), h = [
        new ve(t, 0, s, r - s + 1)
      ]) : t <= n ? (Pe.Assert(s === r + 1, "modifiedStart should only be one more than modifiedEnd"), h = [
        new ve(t, n - t + 1, s, 0)
      ]) : (Pe.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), Pe.Assert(s === r + 1, "modifiedStart should only be one more than modifiedEnd"), h = []), h;
    }
    ...
    if (!i[0]) {
      ...
      let d = [];
      return i[0] ? d = [
        new ve(c + 1, n - (c + 1) + 1, f + 1, r - (f + 1) + 1)
      ] : d = this.ComputeDiffRecursive(c + 1, n, f + 1, r, i), this.ConcatenateChanges(h, d);
    }
    return [
      new ve(t, n - t + 1, s, r - s + 1)
    ];
  }
  WALKTRACE(t, n, s, r, i, o, l, u, c, f, h, d, m, g, b, x, v, S) {
    let N = null, p = null, _ = new vn(), L = n, A = s, y = m[0] - x[0] - r, B = -1073741824, Q = this.m_forwardHistory.length - 1;
    do {
      const q = y + t;
      q === L || q < A && c[q - 1] < c[q + 1] ? (h = c[q + 1], g = h - y - r, h < B && _.MarkNextChange(), B = h, _.AddModifiedElement(h + 1, g), y = q + 1 - t) : (h = c[q - 1] + 1, g = h - y - r, h < B && _.MarkNextChange(), B = h - 1, _.AddOriginalElement(h, g + 1), y = q - 1 - t), Q >= 0 && (c = this.m_forwardHistory[Q], t = c[0], L = 1, A = c.length - 1);
    } while (--Q >= -1);
    if (N = _.getReverseChanges(), S[0]) {
      let q = m[0] + 1, F = x[0] + 1;
      if (N !== null && N.length > 0) {
        const C = N[N.length - 1];
        q = Math.max(q, C.getOriginalEnd()), F = Math.max(F, C.getModifiedEnd());
      }
      p = [
        new ve(q, d - q + 1, F, b - F + 1)
      ];
    } else {
      _ = new vn(), L = o, A = l, y = m[0] - x[0] - u, B = 1073741824, Q = v ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const q = y + i;
        q === L || q < A && f[q - 1] >= f[q + 1] ? (h = f[q + 1] - 1, g = h - y - u, h > B && _.MarkNextChange(), B = h + 1, _.AddOriginalElement(h + 1, g + 1), y = q + 1 - i) : (h = f[q - 1], g = h - y - u, h > B && _.MarkNextChange(), B = h, _.AddModifiedElement(h + 1, g + 1), y = q - 1 - i), Q >= 0 && (f = this.m_reverseHistory[Q], i = f[0], L = 1, A = f.length - 1);
      } while (--Q >= -1);
      p = _.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, s, r, i, o, l) {
    ...
    const g = n - t + (r - s), b = g + 1, x = new Int32Array(b), v = new Int32Array(b), S = r - s, N = n - t, p = t - s, _ = n - r, A = (N - S) % 2 === 0;
    x[S] = t, v[N] = n, l[0] = !1;
    for (let y = 1; y <= g / 2 + 1; y++) {
      let B = 0, Q = 0;
      f = this.ClipDiagonalBound(S - y, y, S, b), h = this.ClipDiagonalBound(S + y, y, S, b);
      for (let F = f; F <= h; F += 2) {
        F === f || F < h && x[F - 1] < x[F + 1] ? u = x[F + 1] : u = x[F - 1] + 1, c = u - (F - S) - p;
        const C = u;
        for (; u < n && c < r && this.ElementsAreEqual(u + 1, c + 1); )
          u++, c++;
        if (x[F] = u, u + c > B + Q && (B = u, Q = c), !A && Math.abs(F - N) <= y - 1 && u >= v[F])
          return i[0] = u, o[0] = c, C <= v[F] && y <= 1448 ? this.WALKTRACE(S, f, h, p, N, d, m, _, x, v, u, n, i, c, r, o, A, l) : null;
      }
      const q = (B - t + (Q - s) - y) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(B, q))
        return l[0] = !0, i[0] = B, o[0] = Q, q > 0 && y <= 1448 ? this.WALKTRACE(S, f, h, p, N, d, m, _, x, v, u, n, i, c, r, o, A, l) : (t++, s++, [
          new ve(t, n - t + 1, s, r - s + 1)
        ]);
      d = this.ClipDiagonalBound(N - y, y, N, b), m = this.ClipDiagonalBound(N + y, y, N, b);
      for (let F = d; F <= m; F += 2) {
        F === d || F < m && v[F - 1] >= v[F + 1] ? u = v[F + 1] - 1 : u = v[F - 1], c = u - (F - N) - _;
        const C = u;
        for (; u > t && c > s && this.ElementsAreEqual(u, c); )
          u--, c--;
        if (v[F] = u, A && Math.abs(F - S) <= y && u <= x[F])
          return i[0] = u, o[0] = c, C >= x[F] && y <= 1448 ? this.WALKTRACE(S, f, h, p, N, d, m, _, x, v, u, n, i, c, r, o, A, l) : null;
      }
      if (y <= 1447) {
        let F = new Int32Array(h - f + 2);
        F[0] = S - f + 1, Fe.Copy2(x, f, F, 1, h - f + 1), this.m_forwardHistory.push(F), F = new Int32Array(m - d + 2), F[0] = N - d + 1, Fe.Copy2(v, d, F, 1, m - d + 1), this.m_reverseHistory.push(F);
      }
    }
    return this.WALKTRACE(S, f, h, p, N, d, m, _, x, v, u, n, i, c, r, o, A, l);
  }
  /**
  ...
  ConcatenateChanges(t, n) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], n[0], s)) {
      ...
      return Fe.Copy(t, 0, r, 0, t.length - 1), r[t.length - 1] = s[0], Fe.Copy(n, 1, r, t.length, n.length - 1), r;
    } else {
      const r = new Array(t.length + n.length);
      return Fe.Copy(t, 0, r, 0, t.length), Fe.Copy(n, 0, r, t.length, n.length), r;
    }
  }
  /**
  ...
  ChangesOverlap(t, n, s) {
    if (Pe.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), Pe.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (i = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart), s[0] = new ve(r, i, o, l), !0;
    } else
      return s[0] = null, !1;
  }
  /**
...
class H {
  ...
  with(t = this.lineNumber, n = this.column) {
    return t === this.lineNumber && n === this.column ? this : new H(t, n);
  }
  /**
...
class an {
  constructor(t) {
    const n = Nn(t);
    this._defaultValue = n, this._asciiMap = an._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
  }
...
class Lt {
  ...
  static computeLinks(t, n = Ui()) {
    ...
    for (let i = 1, o = t.getLineCount(); i <= o; i++) {
      ...
      let c = 0, f = 0, h = 0, d = 1, m = !1, g = !1, b = !1, x = !1;
      for (; c < u; ) {
        let v = !1;
        ...
        if (d === 13) {
          ...
          N === 1 && (r.push(Lt._createLink(s, l, i, f, c)), v = !0);
        } else if (d === 12) {
          let N;
          S === 91 ? (g = !0, N = 0) : N = s.get(S), N === 1 ? v = !0 : d = 13;
        } else
          d = n.nextState(d, S), d === 0 && (v = !0);
        v && (d = 1, m = !1, g = !1, x = !1, f = c + 1, h = S), c++;
      }
      d === 13 && r.push(Lt._createLink(s, l, i, f, u));
    }
    return r;
  }
}
...
const hr = Object.freeze(function(e, t) {
...
(function(e) {
  function t(n) {
    return n === e.None || n === e.Cancelled || n instanceof it ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function";
  }
...
class it {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? hr : (this._emitter || (this._emitter = new oe()), this._emitter.event);
  }
  dispose() {
...
class Wi {
  ...
  cancel() {
    this._token ? this._token instanceof it && this._token.cancel() : this._token = vt.Cancelled;
  }
  dispose(t = !1) {
    t && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof it && this._token.dispose() : this._token = vt.None;
  }
}
class ln {
  constructor() {
...
const at = new ln(), zt = new ln(), Ot = new ln(), zi = new Array(230), Oi = /* @__PURE__ */ Object.create(null), Gi = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const r of t) {
    ...
    if (s[o] || (s[o] = !0, Oi[l] = o, Gi[l.toLowerCase()] = o), !n[u]) {
      if (n[u] = !0, !c)
        throw new Error(`String representation missing for key code ${u} around scan code ${l}`);
      at.define(u, c), zt.define(u, d || c), Ot.define(u, m || d || c);
    }
    f && (zi[f] = u);
  }
})();
...
(function(e) {
  ...
  function i(l) {
    return zt.strToKeyCode(l) || Ot.strToKeyCode(l);
  }
...
class re extends k {
   ...
   */
  setEndPosition(t, n) {
    return this.getDirection() === 0 ? new re(this.startLineNumber, this.startColumn, t, n) : new re(t, n, this.startLineNumber, this.startColumn);
  }
  /**
  ...
  */
   ...
   */
  setStartPosition(t, n) {
    return this.getDirection() === 0 ? new re(t, n, this.endLineNumber, this.endColumn) : new re(this.endLineNumber, this.endColumn, t, n);
  }
  // ----
  /**
  ...
  static fromRange(t, n) {
    return n === 0 ? new re(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn) : new re(t.endLineNumber, t.endColumn, t.startLineNumber, t.startColumn);
  }
  /**
   * Create a `Selection` from an `ISelection`.
   */
  static liftSelection(t) {
    return new re(t.selectionStartLineNumber, t.selectionStartColumn, t.positionLineNumber, t.positionColumn);
  }
  /**
   * `a` equals `b`.
   */
  ...
  static createWithDirection(t, n, s, r, i) {
    return i === 0 ? new re(t, n, s, r) : new re(s, r, t, n);
  }
}
function Xi(e) {
...
class fr {
  ...
  registerFactory(t, n) {
    ...
    return this._factories.set(t, s), dt(() => {
...
class Ne {
  static {
    this.Comment = new Ne("comment");
  }
  static {
    this.Imports = new Ne("imports");
  }
  static {
    this.Region = new Ne("region");
  }
  /**
...
class Nt {
  ...
  static getChannel(t) {
    return t.getChannel(Nt.CHANNEL_NAME);
  }
  static setChannel(t, n) {
    t.setChannel(Nt.CHANNEL_NAME, n);
  }
}
var As;
class ta {
...
function ua(e, t, n, s, r) {
  return oa(e, t, n, s, r) && la(e, t, n, s, r);
}
class ca {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (r === this._prevMatchStartIndex && i === this._prevMatchLength) {
        if (i === 0) {
          ni(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = r, this._prevMatchLength = i, !this._wordSeparators || ua(this._wordSeparators, t, n, r, i))
        return s;
    } while (s);
    return null;
  }
}
function ha(e, t = "Unreachable") {
  throw new Error(t);
}
function St(e) {
  if (!e()) {
    debugger;
    e(), Xe(new ae("Assertion Failed"));
  }
}
function dr(e, t) {
  let n = 0;
...
function un(e, t, n, s, r) {
  if (t = gr(t), r || (r = ft.first(br)), n.length > r.maxLen) {
    let c = e - r.maxLen / 2;
    return c < 0 ? c = 0 : s += c, n = n.substring(c, e + r.maxLen / 2), un(e, t, n, s, r);
  }
...
class ga {
  static computeUnicodeHighlights(t, n, s) {
    const r = s ? s.startLineNumber : 1, i = s ? s.endLineNumber : t.getLineCount(), o = new ks(n), l = o.getCandidateCodePoints();
    let u;
    l === "allNonBasicAscii" ? u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : u = new RegExp(`${ba(Array.from(l))}`, "g");
    const c = new ca(null, u), f = [];
    let h = !1, d, m = 0, g = 0, b = 0;
    e: for (let x = r, v = i; x <= v; x++) {
      const S = t.getLineContent(x), N = S.length;
      c.reset(0);
      do
        if (d = c.next(S), d) {
          let p = d.index, _ = d.index + d[0].length;
          if (p > 0) {
            const B = S.charCodeAt(p - 1);
            _t(B) && p--;
          }
          if (_ + 1 < N) {
            const B = S.charCodeAt(_ - 1);
            _t(B) && _++;
          }
          const L = S.substring(p, _);
          let A = un(p + 1, mr, S, 0);
          A && A.endColumn <= p + 1 && (A = null);
          const y = o.shouldHighlightNonBasicASCII(L, A ? A.word : null);
          if (y !== 0) {
            if (y === 3 ? m++ : y === 2 ? g++ : y === 1 ? b++ : ha(), f.length >= 1e3) {
              h = !0;
              break e;
            }
            f.push(new k(x, p + 1, x, _ + 1));
          }
        }
      while (d);
    }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (s.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 3: {
        const i = t.codePointAt(0), o = s.ambiguousCharacters.getPrimaryConfusable(i), l = Ce.getLocales().filter((u) => !Ce.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, u])).isAmbiguous(i));
...
class ks {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of Ee.codePoints)
        Ps(String.fromCodePoint(n)) || t.add(n);
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const o of n) {
        const l = o.codePointAt(0), u = ri(o);
        r = r || u, !u && !this.ambiguousCharacters.isAmbiguous(l) && !Ee.isInvisibleCharacter(l) && (i = !0);
      }
    return (
      /* Don't allow mixing weird looking characters with ASCII */
      !r && /* Is there an obviously weird looking character? */
      i ? 0 : this.options.invisibleCharacters && !Ps(t) && Ee.isInvisibleCharacter(s) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(s) ? 3 : 0
    );
  }
}
function Ps(e) {
...
class I {
   ...
   */
  join(t) {
    return new I(Math.min(this.start, t.start), Math.max(this.endExclusive, t.endExclusive));
  }
  /**
...
function Je(e, t, n = 0, s = e.length) {
  let r = n, i = s;
  for (; r < i; ) {
...
function Yt(e, t, n = 0, s = e.length) {
  let r = n, i = s;
  for (; r < i; ) {
    const o = Math.floor((r + i) / 2);
    t(e[o]) ? i = o : r = o + 1;
...
class de {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = Yt(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), s = Je(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === s)
  ...
  getUnion(t) {
    ...
    for (; s < this._normalizedRanges.length || r < t._normalizedRanges.length; ) {
      ...
      } else s < this._normalizedRanges.length ? (o = this._normalizedRanges[s], s++) : (o = t._normalizedRanges[r], r++);
   ...
   */
  subtractFrom(t) {
    const n = Yt(this._normalizedRanges, (o) => o.endLineNumberExclusive >= t.startLineNumber), s = Je(this._normalizedRanges, (o) => o.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === s)
      return new de([t]);
    const r = [];
    ...
    return i < t.endLineNumberExclusive && r.push(new D(i, t.endLineNumberExclusive)), new de(r);
  }
  toString() {
...
class ue {
  static inverse(t, n, s) {
    ...
    let i = 1, o = 1;
    for (const u of t) {
      const c = new ue(new D(i, u.original.startLineNumber), new D(o, u.modified.startLineNumber));
      c.modified.isEmpty || r.push(c), i = u.original.endLineNumberExclusive, o = u.modified.endLineNumberExclusive;
    }
    const l = new ue(new D(i, n + 1), new D(o, s + 1));
  ...
  static clip(t, n, s) {
    ...
    for (const i of t) {
      ...
      o && !o.isEmpty && l && !l.isEmpty && r.push(new ue(o, l));
    }
    return r;
  }
  constructor(t, n) {
  ...
  join(t) {
    return new ue(this.original.join(t.original), this.modified.join(t.modified));
  }
  /**
  ...
  */
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new he(new k(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new k(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new he(new k(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new k(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
  }
  /**
   * This method assumes that the LineRangeMapping describes a valid diff!
   * I.e. if one range is empty, the other range cannot be the entire document.
  ...
  */
  toRangeMapping2(t, n) {
    if (Fs(this.original.endLineNumberExclusive, t) && Fs(this.modified.endLineNumberExclusive, n))
      return new he(new k(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new k(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new he(k.fromPositions(new H(this.original.startLineNumber, 1), Te(new H(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), k.fromPositions(new H(this.modified.startLineNumber, 1), Te(new H(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new he(k.fromPositions(Te(new H(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), Te(new H(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), k.fromPositions(Te(new H(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), Te(new H(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new ae();
  }
}
function Te(e, t) {
...
class _e extends ue {
  ...
  flip() {
    return new _e(this.modified, this.original, this.innerChanges?.map((t) => t.flip()));
  }
...
class he {
  ...
  */
  toTextEdit(t) {
    ...
    return new xa(this.originalRange, n);
  }
}
const wa = 3;
class La {
  computeDiff(t, n, s) {
    ...
    for (const u of i.changes) {
      let c;
      u.originalEndLineNumber === 0 ? c = new D(u.originalStartLineNumber + 1, u.originalStartLineNumber + 1) : c = new D(u.originalStartLineNumber, u.originalEndLineNumber + 1);
      let f;
      u.modifiedEndLineNumber === 0 ? f = new D(u.modifiedStartLineNumber + 1, u.modifiedStartLineNumber + 1) : f = new D(u.modifiedStartLineNumber, u.modifiedEndLineNumber + 1);
      let h = new _e(c, f, u.charChanges?.map((d) => new he(new k(d.originalStartLineNumber, d.originalStartColumn, d.originalEndLineNumber, d.originalEndColumn), new k(d.modifiedStartLineNumber, d.modifiedStartColumn, d.modifiedEndLineNumber, d.modifiedEndColumn))));
      l && (l.modified.endLineNumberExclusive === h.modified.startLineNumber || l.original.endLineNumberExclusive === h.original.startLineNumber) && (h = new _e(l.original.join(h.original), l.modified.join(h.modified), l.innerChanges && h.innerChanges ? l.innerChanges.concat(h.innerChanges) : void 0), o.pop()), o.push(h), l = h;
    }
    return St(() => dr(o, (u, c) => c.original.startLineNumber - u.original.endLineNumberExclusive === c.modified.startLineNumber - u.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    u.original.endLineNumberExclusive < c.original.startLineNumber && u.modified.endLineNumberExclusive < c.modified.startLineNumber)), new ot(o, [], i.quitEarly);
  }
}
function _r(e, t, n, s) {
  return new Se(e, t, n).ComputeDiff(s);
}
let Ds = class {
  constructor(t) {
    const n = [], s = [];
    for (let r = 0, i = t.length; r < i; r++)
      n[r] = Jt(t[r], 1), s[r] = Zt(t[r], 1);
...
function Na(e) {
  ...
  for (let s = 1, r = e.length; s < r; s++) {
    ...
    Math.min(o, l) < wa ? (n.originalLength = i.originalStart + i.originalLength - n.originalStart, n.modifiedLength = i.modifiedStart + i.modifiedLength - n.modifiedStart) : (t.push(i), n = i);
  }
  return t;
}
class Qe {
  ...
  static createFromDiffResult(t, n, s, r, i, o, l) {
    ...
    if (n.originalLength === 0 ? (u = s.getStartLineNumber(n.originalStart) - 1, c = 0) : (u = s.getStartLineNumber(n.originalStart), c = s.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (f = r.getStartLineNumber(n.modifiedStart) - 1, h = 0) : (f = r.getStartLineNumber(n.modifiedStart), h = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), o && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && i()) {
      ...
      if (m.getElements().length > 0 && g.getElements().length > 0) {
        let b = _r(m, g, i, !0).changes;
        l && (b = Na(b)), d = [];
        for (let x = 0, v = b.length; x < v; x++)
          d.push(Ue.createFromDiffChange(b[x], m, g));
      }
    }
    return new Qe(u, c, f, h, d);
  }
}
class Sa {
  constructor(t, n, s) {
    this.shouldComputeCharChanges = s.shouldComputeCharChanges, this.shouldPostProcessCharChanges = s.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = s.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = s.shouldMakePrettyDiff, this.originalLines = t, this.modifiedLines = n, this.original = new Ds(t), this.modified = new Ds(n), this.continueLineDiff = Ts(s.maxComputationTime), this.continueCharDiff = Ts(s.maxComputationTime === 0 ? 0 : Math.min(s.maxComputationTime, 5e3));
  }
  computeDiff() {
    ...
    const t = _r(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, s = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const l = [];
      for (let u = 0, c = n.length; u < c; u++)
        l.push(Qe.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[u], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: s,
        changes: l
      };
    ...
    for (let l = -1, u = n.length; l < u; l++) {
      ...
      for (; i < f && o < h; ) {
        ...
        if (d !== m) {
          {
            let g = Jt(d, 1), b = Jt(m, 1);
            for (; g > 1 && b > 1; ) {
              const x = d.charCodeAt(g - 2), v = m.charCodeAt(b - 2);
              if (x !== v)
                break;
              g--, b--;
            }
          ...
          {
            let g = Zt(d, 1), b = Zt(m, 1);
            const x = d.length + 1, v = m.length + 1;
            for (; g < x && b < v; ) {
            ...
            (g < x || b < v) && this._pushTrimWhitespaceCharChange(r, i + 1, g, x, o + 1, b, v);
          }
        }
        i++, o++;
      }
      c && (r.push(Qe.createFromDiffResult(this.shouldIgnoreTrimWhitespace, c, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += c.originalLength, o += c.modifiedLength);
    }
    return {
      quitEarly: s,
      changes: r
  ...
  _pushTrimWhitespaceCharChange(t, n, s, r, i, o, l) {
    if (this._mergeTrimWhitespaceCharChange(t, n, s, r, i, o, l))
      return;
    let u;
    this.shouldComputeCharChanges && (u = [new Ue(n, s, n, r, i, o, i, l)]), t.push(new Qe(n, n, i, i, u));
  }
...
class ct {
  ...
  filter(t) {
    return new ct((n) => this.iterate((s) => t(s) ? n(s) : !0));
  }
  map(t) {
    return new ct((n) => this.iterate((s) => n(t(s))));
  }
  findLast(t) {
    let n;
  ...
  findLastMaxBy(t) {
    let n, s = !0;
    return this.iterate((r) => ((s || Kt.isGreaterThan(t(r, n))) && (s = !1, n = r), !0)), n;
  }
}
class pe {
  static trivial(t, n) {
    return new pe([new G(I.ofLength(t.length), I.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new pe([new G(I.ofLength(t.length), I.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class G {
  static invert(t, n) {
    const s = [];
    return Ra(t, (r, i) => {
      s.push(G.fromOffsetPairs(r ? r.getEndExclusives() : fe.zero, i ? i.getStarts() : new fe(n, (r ? r.seq2Range.endExclusive - r.seq1Range.endExclusive : 0) + n)));
    }), s;
  }
  static fromOffsetPairs(t, n) {
    return new G(new I(t.offset1, n.offset1), new I(t.offset2, n.offset2));
  }
  static assertSorted(t) {
    let n;
    for (const s of t) {
  ...
  join(t) {
    return new G(this.seq1Range.join(t.seq1Range), this.seq2Range.join(t.seq2Range));
  }
  delta(t) {
    return t === 0 ? this : new G(this.seq1Range.delta(t), this.seq2Range.delta(t));
  }
  deltaStart(t) {
    return t === 0 ? this : new G(this.seq1Range.deltaStart(t), this.seq2Range.deltaStart(t));
  }
  deltaEnd(t) {
    return t === 0 ? this : new G(this.seq1Range.deltaEnd(t), this.seq2Range.deltaEnd(t));
  }
  intersect(t) {
...
class fe {
  static {
    this.zero = new fe(0, 0);
  }
  static {
    this.max = new fe(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
  }
  constructor(t, n) {
  ...
  delta(t) {
    return t === 0 ? this : new fe(this.offset1 + t, this.offset2 + t);
  }
  equals(t) {
...
class Pa {
  compute(t, n, s = et.instance, r) {
    if (t.length === 0 || n.length === 0)
      return pe.trivial(t, n);
    const i = new Tt(t.length, n.length), o = new Tt(t.length, n.length), l = new Tt(t.length, n.length);
    for (let g = 0; g < t.length; g++)
      for (let b = 0; b < n.length; b++) {
        if (!s.isValid())
          return pe.trivialTimedOut(t, n);
        const x = g === 0 ? 0 : i.get(g - 1, b), v = b === 0 ? 0 : i.get(g, b - 1);
        let S;
        t.getElement(g) === n.getElement(b) ? (g === 0 || b === 0 ? S = 0 : S = i.get(g - 1, b - 1), g > 0 && b > 0 && o.get(g - 1, b - 1) === 3 && (S += l.get(g - 1, b - 1)), S += r ? r(g, b) : 1) : S = -1;
        const N = Math.max(x, v, S);
        if (N === S) {
    ...
    function h(g, b) {
      (g + 1 !== c || b + 1 !== f) && u.push(new G(new I(g + 1, c), new I(b + 1, f))), c = g, f = b;
    }
    let d = t.length - 1, m = n.length - 1;
    for (; d >= 0 && m >= 0; )
      o.get(d, m) === 3 ? (h(d, m), d--, m--) : o.get(d, m) === 1 ? d-- : m--;
    return h(-1, -1), u.reverse(), new pe(u, !1);
  }
}
class pr {
  compute(t, n, s = et.instance) {
    if (t.length === 0 || n.length === 0)
      return pe.trivial(t, n);
    const r = t, i = n;
    function o(b, x) {
      for (; b < r.length && x < i.length && r.getElement(b) === i.getElement(x); )
        b++, x++;
      return b;
    }
    let l = 0;
    ...
    u.set(0, o(0, 0));
    const c = new Da();
    c.set(0, u.get(0) === 0 ? null : new Vs(null, 0, 0, u.get(0)));
    let f = 0;
    e: for (; ; ) {
      if (l++, !s.isValid())
        return pe.trivialTimedOut(r, i);
      const b = -Math.min(l, i.length + l % 2), x = Math.min(l, r.length + l % 2);
      for (f = b; f <= x; f += 2) {
        const v = f === x ? -1 : u.get(f + 1), S = f === b ? -1 : u.get(f - 1) + 1, N = Math.min(Math.max(v, S), r.length), p = N - f;
        if (N > r.length || p > i.length)
          continue;
        const _ = o(N, p);
        u.set(f, _);
        const L = N === v ? c.get(f + 1) : c.get(f - 1);
        if (c.set(f, _ !== N ? new Vs(L, N, p, _ - N) : L), u.get(f) === r.length && u.get(f) - f === i.length)
          break e;
      }
    }
    let h = c.get(f);
    ...
    for (; ; ) {
      ...
      if ((b !== m || x !== g) && d.push(new G(new I(b, m), new I(x, g))), !h)
        break;
      m = h.x, g = h.y, h = h.prev;
    }
    return d.reverse(), new pe(d, !1);
  }
}
class Vs {
  constructor(t, n, s, r) {
...
class Ct {
  ...
  getBoundaryScore(t) {
    const n = Bs(t > 0 ? this.elements[t - 1] : -1), s = Bs(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && s === 8)
      return 0;
    if (n === 8)
      return 150;
    let r = 0;
    return n !== s && (r += 10, n === 0 && s === 1 && (r += 1)), r += Is(n), r += Is(s), r;
  }
  translateOffset(t, n = "right") {
    const s = Je(this.firstElementOffsetByLineIdx, (i) => i <= t), r = t - this.firstElementOffsetByLineIdx[s];
    return new H(this.range.startLineNumber + s, 1 + this.lineStartOffsets[s] + r + (r === 0 && n === "left" ? 0 : this.trimmedWsLengthsByLineIdx[s]));
  }
  translateRange(t) {
  ...
  findWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !Vt(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && Vt(this.elements[n - 1]); )
      n--;
    let s = t;
    for (; s < this.elements.length && Vt(this.elements[s]); )
      s++;
    return new I(n, s);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = $e(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0, s = pa(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new I(n, s);
  }
}
function Vt(e) {
...
function Bs(e) {
  return e === 10 ? 8 : e === 13 ? 7 : en(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : e === -1 ? 3 : e === 44 || e === 59 ? 5 : 4;
}
function Va(e, t, n, s, r, i) {
  let { moves: o, excludedChanges: l } = Ba(e, t, n, i);
  if (!i.isValid())
    return [];
  const u = e.filter((f) => !l.has(f)), c = qa(u, s, r, t, n, i);
  return Ea(o, c), o = Ua(o), o = o.filter((f) => {
...
function Ba(e, t, n, s) {
  const r = [], i = e.filter((u) => u.modified.isEmpty && u.original.length >= 3).map((u) => new Ze(u.original, t, u)), o = new Set(e.filter((u) => u.original.isEmpty && u.modified.length >= 3).map((u) => new Ze(u.modified, n, u))), l = /* @__PURE__ */ new Set();
  for (const u of i) {
    let c = -1, f;
    for (const h of o) {
    ...
    if (c > 0.9 && f && (o.delete(f), r.push(new ue(u.range, f.range)), l.add(u.source), l.add(f.source)), !s.isValid())
...
function qa(e, t, n, s, r, i) {
  ...
  for (const d of e) {
    ...
    for (let g = d.modified.startLineNumber; g < d.modified.endLineNumberExclusive - 2; g++) {
      const b = `${n[g - 1]}:${n[g + 1 - 1]}:${n[g + 2 - 1]}`, x = new D(g, g + 3), v = [];
      l.forEach(b, ({ range: S }) => {
        for (const p of m)
          if (p.originalLineRange.endLineNumberExclusive + 1 === S.endLineNumberExclusive && p.modifiedLineRange.endLineNumberExclusive + 1 === x.endLineNumberExclusive) {
            p.originalLineRange = new D(p.originalLineRange.startLineNumber, S.endLineNumberExclusive), p.modifiedLineRange = new D(p.modifiedLineRange.startLineNumber, x.endLineNumberExclusive), v.push(p);
            return;
          }
        const N = {
          modifiedLineRange: x,
  ...
  u.sort(Ma(lt((d) => d.modifiedLineRange.length, ut)));
  const c = new de(), f = new de();
  for (const d of u) {
    const m = d.modifiedLineRange.startLineNumber - d.originalLineRange.startLineNumber, g = c.subtractFrom(d.modifiedLineRange), b = f.subtractFrom(d.originalLineRange).getWithDelta(m), x = g.getIntersection(b);
    for (const v of x.ranges) {
      if (v.length < 3)
        continue;
      const S = v, N = v.delta(-m);
      o.push(new ue(N, S)), c.addRange(S), f.addRange(N);
    }
  }
  o.sort(lt((d) => d.original.startLineNumber, ut));
  const h = new Rt(e);
  for (let d = 0; d < o.length; d++) {
    const m = o[d], g = h.findLastMonotonous((L) => L.original.startLineNumber <= m.original.startLineNumber), b = $e(e, (L) => L.modified.startLineNumber <= m.modified.startLineNumber), x = Math.max(m.original.startLineNumber - g.original.startLineNumber, m.modified.startLineNumber - b.modified.startLineNumber), v = h.findLastMonotonous((L) => L.original.startLineNumber < m.original.endLineNumberExclusive), S = $e(e, (L) => L.modified.startLineNumber < m.modified.endLineNumberExclusive), N = Math.max(v.original.endLineNumberExclusive - m.original.endLineNumberExclusive, S.modified.endLineNumberExclusive - m.modified.endLineNumberExclusive);
    let p;
    for (p = 0; p < x; p++) {
      const L = m.original.startLineNumber - p - 1, A = m.modified.startLineNumber - p - 1;
      if (L > s.length || A > r.length || c.contains(A) || f.contains(L) || !qs(s[L - 1], r[A - 1], i))
        break;
    }
    p > 0 && (f.addRange(new D(m.original.startLineNumber - p, m.original.startLineNumber)), c.addRange(new D(m.modified.startLineNumber - p, m.modified.startLineNumber)));
    let _;
    for (_ = 0; _ < N; _++) {
      const L = m.original.endLineNumberExclusive + _, A = m.modified.endLineNumberExclusive + _;
      if (L > s.length || A > r.length || c.contains(A) || f.contains(L) || !qs(s[L - 1], r[A - 1], i))
        break;
    }
    _ > 0 && (f.addRange(new D(m.original.endLineNumberExclusive, m.original.endLineNumberExclusive + _)), c.addRange(new D(m.modified.endLineNumberExclusive, m.modified.endLineNumberExclusive + _))), (p > 0 || _ > 0) && (o[d] = new ue(new D(m.original.startLineNumber - p, m.original.endLineNumberExclusive + _), new D(m.modified.startLineNumber - p, m.modified.endLineNumberExclusive + _)));
  }
  return o;
}
function qs(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new pr().compute(new Ct([e], new k(1, 1, 1, e.length), !1), new Ct([t], new k(1, 1, 1, t.length), !1), n);
  let i = 0;
...
function Ha(e, t) {
  const n = new Rt(e);
  return t = t.filter((s) => {
    const r = n.findLastMonotonous((l) => l.original.startLineNumber < s.original.endLineNumberExclusive) || new ue(new D(1, 1), new D(1, 1)), i = $e(e, (l) => l.modified.startLineNumber < s.modified.endLineNumberExclusive);
    return r !== i;
  }), t;
}
function Us(e, t, n) {
  let s = n;
  return s = Hs(e, t, s), s = Hs(e, t, s), s = $a(e, t, s), s;
}
function Hs(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let i = 1; i < n.length; i++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (c = 1; c <= u && !(e.getElement(l.seq1Range.start - c) !== e.getElement(l.seq1Range.endExclusive - c) || t.getElement(l.seq2Range.start - c) !== t.getElement(l.seq2Range.endExclusive - c)); c++)
        ;
      if (c--, c === u) {
        s[s.length - 1] = new G(new I(o.seq1Range.start, l.seq1Range.endExclusive - u), new I(o.seq2Range.start, l.seq2Range.endExclusive - u));
        continue;
      }
      l = l.delta(-c);
    }
  ...
  for (let i = 0; i < s.length - 1; i++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (c = 0; c < u && !(!e.isStronglyEqual(l.seq1Range.start + c, l.seq1Range.endExclusive + c) || !t.isStronglyEqual(l.seq2Range.start + c, l.seq2Range.endExclusive + c)); c++)
        ;
      if (c === u) {
        s[i + 1] = new G(new I(l.seq1Range.start + u, o.seq1Range.endExclusive), new I(l.seq2Range.start + u, o.seq2Range.endExclusive));
        continue;
      }
      c > 0 && (l = l.delta(c));
    }
...
function $a(e, t, n) {
  ...
  for (let s = 0; s < n.length; s++) {
    const r = s > 0 ? n[s - 1] : void 0, i = n[s], o = s + 1 < n.length ? n[s + 1] : void 0, l = new I(r ? r.seq1Range.endExclusive + 1 : 0, o ? o.seq1Range.start - 1 : e.length), u = new I(r ? r.seq2Range.endExclusive + 1 : 0, o ? o.seq2Range.start - 1 : t.length);
    i.seq1Range.isEmpty ? n[s] = $s(i, e, t, l, u) : i.seq2Range.isEmpty && (n[s] = $s(i.swap(), t, e, u, l).swap());
  }
  return n;
}
...
function Wa(e, t, n) {
  ...
  for (const r of n) {
    ...
    r.seq1Range.start - i.seq1Range.endExclusive <= 2 || r.seq2Range.start - i.seq2Range.endExclusive <= 2 ? s[s.length - 1] = new G(i.seq1Range.join(r.seq1Range), i.seq2Range.join(r.seq2Range)) : s.push(r);
  }
  return s;
}
function za(e, t, n) {
  const s = G.invert(n, e.length), r = [];
  let i = new fe(0, 0);
  function o(u, c) {
    ...
    for (; s.length > 0; ) {
      ...
      if (!(x.seq1Range.intersects(d.seq1Range) || x.seq2Range.intersects(d.seq2Range)))
        break;
      const S = e.findWordContaining(x.seq1Range.start), N = t.findWordContaining(x.seq2Range.start), p = new G(S, N), _ = p.intersect(x);
      if (g += _.seq1Range.length, b += _.seq2Range.length, d = d.join(p), d.seq1Range.endExclusive >= x.seq1Range.endExclusive)
        s.shift();
      else
        break;
    }
...
function Ga(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < s.length; u++) {
      let h = function(m, g) {
        const b = new I(f.seq1Range.endExclusive, c.seq1Range.start);
        return e.getText(b).replace(/\s/g, "").length <= 4 && (m.seq1Range.length + m.seq2Range.length > 5 || g.seq1Range.length + g.seq2Range.length > 5);
      };
      var o = h;
...
function ja(e, t, n) {
  ...
  do {
    ...
    for (let c = 1; c < s.length; c++) {
      let d = function(g, b) {
        const x = new I(h.seq1Range.endExclusive, f.seq1Range.start);
        if (e.countLinesIn(x) > 5 || x.length > 500)
          return !1;
        const S = e.getText(x).trim();
        if (S.length > 20 || S.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const N = e.countLinesIn(g.seq1Range), p = g.seq1Range.length, _ = t.countLinesIn(g.seq2Range), L = g.seq2Range.length, A = e.countLinesIn(b.seq1Range), y = b.seq1Range.length, B = t.countLinesIn(b.seq2Range), Q = b.seq2Range.length, q = 2 * 40 + 50;
        function F(C) {
          return Math.min(C, q);
        }
        return Math.pow(Math.pow(F(N * 40 + p), 1.5) + Math.pow(F(_ * 40 + L), 1.5), 1.5) + Math.pow(Math.pow(F(A * 40 + y), 1.5) + Math.pow(F(B * 40 + Q), 1.5), 1.5) > (q ** 1.5) ** 1.5 * 1.3;
      };
      var l = d;
      const f = s[c], h = u[u.length - 1];
      d(h, f) ? (i = !0, u[u.length - 1] = u[u.length - 1].join(f)) : u.push(f);
    }
    s = u;
  } while (r++ < 10 && i);
  const o = [];
  return ya(s, (u, c, f) => {
    ...
    const m = e.extendToFullLines(c.seq1Range), g = e.getText(new I(m.start, c.seq1Range.start));
    d(g) && (h = h.deltaStart(-g.length));
    const b = e.getText(new I(c.seq1Range.endExclusive, m.endExclusive));
    d(b) && (h = h.deltaEnd(b.length));
    const x = G.fromOffsetPairs(u ? u.getEndExclusives() : fe.zero, f ? f.getStarts() : fe.max), v = h.intersect(x);
...
class Xa {
  constructor() {
    this.dynamicProgrammingDiffing = new Pa(), this.myersDiffingAlgorithm = new pr();
  }
  computeDiff(t, n, s) {
    if (t.length <= 1 && Ca(t, n, (_, L) => _ === L))
      return new ot([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new ot([
        new _e(new D(1, t.length + 1), new D(1, n.length + 1), [
          new he(new k(1, 1, t.length, t[t.length - 1].length + 1), new k(1, 1, n.length, n[n.length - 1].length + 1))
        ])
      ], [], !1);
    const r = s.maxComputationTimeMs === 0 ? et.instance : new ka(s.maxComputationTimeMs), i = !s.ignoreTrimWhitespace, o = /* @__PURE__ */ new Map();
    function l(_) {
      let L = o.get(_);
      return L === void 0 && (L = o.size, o.set(_, L)), L;
    }
    const u = t.map((_) => l(_.trim())), c = n.map((_) => l(_.trim())), f = new Ws(u, t), h = new Ws(c, n), d = f.length + h.length < 1700 ? this.dynamicProgrammingDiffing.compute(f, h, r, (_, L) => t[_] === n[L] ? n[L].length === 0 ? 0.1 : 1 + Math.log(1 + n[L].length) : 0.99) : this.myersDiffingAlgorithm.compute(f, h, r);
    let m = d.diffs, g = d.hitTimeout;
    m = Us(f, h, m), m = Ga(f, h, m);
    const b = [], x = (_) => {
      if (i)
        for (let L = 0; L < _; L++) {
          const A = v + L, y = S + L;
          if (t[A] !== n[y]) {
            const B = this.refineDiff(t, n, new G(new I(A, A + 1), new I(y, y + 1)), r, i);
            for (const Q of B.mappings)
              b.push(Q);
            B.hitTimeout && (g = !0);
          }
        }
    ...
    let v = 0, S = 0;
    for (const _ of m) {
      St(() => _.seq1Range.start - v === _.seq2Range.start - S);
      const L = _.seq1Range.start - v;
      x(L), v = _.seq1Range.endExclusive, S = _.seq2Range.endExclusive;
      const A = this.refineDiff(t, n, _, r, i);
      A.hitTimeout && (g = !0);
      for (const y of A.mappings)
        b.push(y);
    }
    x(t.length - v);
    const N = Os(b, t, n);
    let p = [];
    return s.computeMoves && (p = this.computeMoves(N, t, n, u, c, r, i)), St(() => {
      function _(A, y) {
        if (A.lineNumber < 1 || A.lineNumber > y.length)
          return !1;
        const B = y[A.lineNumber - 1];
        return !(A.column < 1 || A.column > B.length + 1);
      }
      function L(A, y) {
        return !(A.startLineNumber < 1 || A.startLineNumber > y.length + 1 || A.endLineNumberExclusive < 1 || A.endLineNumberExclusive > y.length + 1);
      }
      for (const A of N) {
        if (!A.innerChanges)
          return !1;
        for (const y of A.innerChanges)
          if (!(_(y.modifiedRange.getStartPosition(), n) && _(y.modifiedRange.getEndPosition(), n) && _(y.originalRange.getStartPosition(), t) && _(y.originalRange.getEndPosition(), t)))
            return !1;
  ...
  computeMoves(t, n, s, r, i, o, l) {
    return Va(t, n, s, r, i, o).map((f) => {
      const h = this.refineDiff(n, s, new G(f.original.toOffsetRange(), f.modified.toOffsetRange()), o, l), d = Os(h.mappings, n, s, !0);
      return new _a(f, d);
    });
  }
  refineDiff(t, n, s, r, i) {
    const l = Ya(s).toRangeMapping2(t, n), u = new Ct(t, l.originalRange, i), c = new Ct(n, l.modifiedRange, i), f = u.length + c.length < 500 ? this.dynamicProgrammingDiffing.compute(u, c, r) : this.myersDiffingAlgorithm.compute(u, c, r);
    let h = f.diffs;
    return h = Us(u, c, h), h = za(u, c, h), h = Wa(u, c, h), h = ja(u, c, h), {
      mappings: h.map((m) => new he(u.translateRange(m.seq1Range), c.translateRange(m.seq2Range))),
...
function Ya(e) {
  return new ue(new D(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new D(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
}
const Gs = {
  getLegacy: () => new La(),
  getDefault: () => new Xa()
...
class X {
  constructor(t, n, s, r = 1) {
    this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, t)) | 0, this.g = Math.min(255, Math.max(0, n)) | 0, this.b = Math.min(255, Math.max(0, s)) | 0, this.a = ye(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
...
class le {
  constructor(t, n, s, r) {
    this._hslaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = ye(Math.max(Math.min(1, n), 0), 3), this.l = ye(Math.max(Math.min(1, s), 0), 3), this.a = ye(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
  ...
  static toRGBA(t) {
    ...
    if (s === 0)
      ...
      o = le._hue2rgb(f, c, n + 1 / 3), l = le._hue2rgb(f, c, n), u = le._hue2rgb(f, c, n - 1 / 3);
    }
    return new X(Math.round(o * 255), Math.round(l * 255), Math.round(u * 255), i);
  }
}
class Be {
  constructor(t, n, s, r) {
    this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = ye(Math.max(Math.min(1, n), 0), 3), this.v = ye(Math.max(Math.min(1, s), 0), 3), this.a = ye(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(t, n) {
  ...
  static fromRGBA(t) {
    ...
    let c;
    return l === 0 ? c = 0 : i === n ? c = ((s - r) / l % 6 + 6) % 6 : i === s ? c = (r - n) / l + 2 : c = (n - s) / l + 4, new Be(Math.round(c * 60), u, i, t.a);
  }
  // from http://www.rapidtables.com/convert/color/hsv-to-rgb.htm
  static toRGBA(t) {
    const { h: n, s, v: r, a: i } = t, o = r * s, l = o * (1 - Math.abs(n / 60 % 2 - 1)), u = r - o;
    let [c, f, h] = [0, 0, 0];
    return n < 60 ? (c = o, f = l) : n < 120 ? (c = l, f = o) : n < 180 ? (f = o, h = l) : n < 240 ? (f = l, h = o) : n < 300 ? (c = l, h = o) : n <= 360 && (c = o, h = l), c = Math.round((c + u) * 255), f = Math.round((f + u) * 255), h = Math.round((h + u) * 255), new X(c, f, h, i);
  }
}
class O {
  static fromHex(t) {
    return O.Format.CSS.parseHex(t) || O.red;
  }
  static equals(t, n) {
  ...
  equals(t) {
    return !!t && X.equals(this.rgba, t.rgba) && le.equals(this.hsla, t.hsla) && Be.equals(this.hsva, t.hsva);
  }
  /**
  ...
  getRelativeLuminance() {
    const t = O._relativeLuminanceForComponent(this.rgba.r), n = O._relativeLuminanceForComponent(this.rgba.g), s = O._relativeLuminanceForComponent(this.rgba.b), r = 0.2126 * t + 0.7152 * n + 0.0722 * s;
    return ye(r, 4);
  }
  ...
  lighten(t) {
    return new O(new le(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
  }
  darken(t) {
    return new O(new le(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
  }
  ...
  opposite() {
    return new O(new X(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  makeOpaque(t) {
    if (this.isOpaque() || t.rgba.a !== 1)
      return this;
    const { r: n, g: s, b: r, a: i } = this.rgba;
    return new O(new X(t.rgba.r - i * (t.rgba.r - n), t.rgba.g - i * (t.rgba.g - s), t.rgba.b - i * (t.rgba.b - r), 1));
  }
  toString() {
  ...
  static {
    this.white = new O(new X(255, 255, 255, 1));
  }
  static {
    this.black = new O(new X(0, 0, 0, 1));
  }
  static {
    this.red = new O(new X(255, 0, 0, 1));
  }
  static {
    this.blue = new O(new X(0, 0, 255, 1));
  }
  static {
    this.green = new O(new X(0, 255, 0, 1));
  }
  static {
    this.cyan = new O(new X(0, 255, 255, 1));
  }
  static {
    this.lightgrey = new O(new X(211, 211, 211, 1));
  }
  static {
    this.transparent = new O(new X(0, 0, 0, 0));
  }
}
(function(e) {
  (function(t) {
    (function(n) {
      ...
      function h(m) {
        ...
        if (g === 0 || m.charCodeAt(0) !== 35)
          return null;
        if (g === 7) {
          const b = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)), x = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)), v = 16 * d(m.charCodeAt(5)) + d(m.charCodeAt(6));
          return new e(new X(b, x, v, 1));
        }
        if (g === 9) {
          const b = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)), x = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)), v = 16 * d(m.charCodeAt(5)) + d(m.charCodeAt(6)), S = 16 * d(m.charCodeAt(7)) + d(m.charCodeAt(8));
          return new e(new X(b, x, v, S / 255));
        }
        if (g === 4) {
          const b = d(m.charCodeAt(1)), x = d(m.charCodeAt(2)), v = d(m.charCodeAt(3));
          return new e(new X(16 * b + b, 16 * x + x, 16 * v + v));
        }
        if (g === 5) {
          const b = d(m.charCodeAt(1)), x = d(m.charCodeAt(2)), v = d(m.charCodeAt(3)), S = d(m.charCodeAt(4));
          return new e(new X(16 * b + b, 16 * x + x, 16 * v + v, (16 * S + S) / 255));
        }
        return null;
      }
      n.parseHex = h;
...
function Ja(e, t) {
  if (!e)
    return;
  const n = O.Format.CSS.parseHex(t);
  if (n)
    return {
      range: e,
      color: cn(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
    };
}
function js(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), i = xr(r);
  return {
    range: e,
    color: cn(i[0], i[1], i[2], n ? i[3] : 1)
  };
}
function Xs(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), i = xr(r), o = new O(new le(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1));
  return {
    range: e,
    color: cn(o.rgba.r, o.rgba.g, o.rgba.b, o.rgba.a)
  };
}
function je(e, t) {
...
function Za(e) {
  const t = [], s = je(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (s.length > 0)
    for (const r of s) {
...
const Qs = new RegExp("\\bMARK:\\s*(.*)$", "d"), e1 = /^-+|-+$/g;
function t1(e, t) {
  let n = [];
...
function wr(e) {
  ...
  return e = e.replace(e1, ""), { text: e, hasSeparatorLine: t };
}
var Ys;
(function(e) {
  async function t(s) {
...
class se {
  ...
  static {
    this.EMPTY = se.fromArray([]);
  }
  constructor(t, n) {
    this._state = 0, this._results = [], this._error = null, this._onReturn = n, this._onStateChanged = new oe(), queueMicrotask(async () => {
      const s = {
...
class l1 {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new u1(ne.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class u1 extends o1 {
  ...
  findMatches(t) {
    ...
    for (let s = 0; s < this._lines.length; s++) {
      const r = this._lines[s], i = this.offsetAt(new H(s + 1, 1)), o = r.matchAll(t);
      for (const l of o)
  ...
  getWordAtPosition(t, n) {
    const s = un(t.column, gr(n), this._lines[t.lineNumber - 1], 0);
...
class c1 {
  constructor() {
    this._workerTextModelSyncServer = new l1();
  }
  dispose() {
  }
  _getModel(t) {
  ...
  async $computeUnicodeHighlights(t, n, s) {
    ...
    return r ? ga.computeUnicodeHighlights(r, n, s) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  async $computeDiff(t, n, s, r) {
    ...
    return !i || !o ? null : ht.computeDiff(i, o, s, r);
  }
  static computeDiff(t, n, s, r) {
    const i = r === "advanced" ? Gs.getDefault() : Gs.getLegacy(), o = t.getLinesContent(), l = n.getLinesContent(), u = i.computeDiff(o, l, s), c = u.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function f(h) {
      return h.map((d) => [d.original.startLineNumber, d.original.endLineNumberExclusive, d.modified.startLineNumber, d.modified.endLineNumberExclusive, d.innerChanges?.map((m) => [
  ...
  async $computeMoreMinimalEdits(t, n, s) {
    ...
    for (let { range: u, text: c, eol: f } of n) {
      ...
      if (c = c.replace(/\r\n|\n|\r/g, r.eol), h === c)
        continue;
      if (Math.max(c.length, h.length) > ht._diffLimit) {
        i.push({ range: u, text: c });
        continue;
      }
      const d = Ii(h, c, s), m = r.offsetAt(k.lift(u).getStartPosition());
      for (const g of d) {
        const b = r.positionAt(m + g.originalStart), x = r.positionAt(m + g.originalStart + g.originalLength), v = {
  ...
  async $textualSuggest(t, n, s, r) {
    const i = new At(), o = new RegExp(s, r), l = /* @__PURE__ */ new Set();
    e: for (const u of t) {
      const c = this._getModel(u);
      if (c) {
        for (const f of c.words(o))
          if (!(f === n || !isNaN(Number(f))) && (l.add(f), l.size > ht._suggestionsLimit))
            break e;
      }
    }
  ...
  async $navigateValueSet(t, n, s, r, i) {
    ...
    return on.INSTANCE.navigateValueSet(n, u, c, f, s);
  }
}
class ht extends c1 {
  constructor(t, n) {
  ...
  $loadForeignModule(t, n, s) {
    const o = {
      host: aa(s, (l, u) => this._host.$fhr(l, u)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(o, n), Promise.resolve(Rs(this._foreignModule))) : new Promise((l, u) => {
      const c = (f) => {
        this._foreignModule = f.create(o, n), l(Rs(this._foreignModule));
      };
      import(`${or.asBrowserUri(`${t}.js`).toString(!0)}`).then(c).catch(u);
    });
  }
...
typeof importScripts == "function" && (globalThis.monaco = ea());
let tn = !1;
function h1(e) {
  if (tn)
    return;
