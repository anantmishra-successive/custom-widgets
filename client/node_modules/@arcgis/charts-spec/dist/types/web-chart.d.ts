import type { GaugeChartSubTypes, SizePolicyScaleTypes, WebChartCalendarBinningOffsetUnits, WebChartCalendarBinningUnits, WebChartDataTransformations, WebChartDirectionalDataOrder, WebChartFixedDateBinningUnits, WebChartLabelBehavior, WebChartLegendPositions, WebChartNullPolicyTypes, WebChartOrderSeriesBy, WebChartPredefinedLabelsDataOrder, WebChartRadarChartAxisLabelsOrientation, WebChartStackedKinds, WebChartTemporalBinningTypes, WebChartTimeAggregationTypes, WebChartTypes } from "./chart-object-literals";
import type { TimeIntervalInfo } from "./data-source";
import type { RESTUnits } from "./rest-js-object-literals";
import type { Color, IDrawingInfo, IEnvelope, IExtent, IFeatureLayer, IPoint, IPolygon, IPolygonWithCurves, IPolyline, ISimpleFillSymbol, ISimpleLineSymbol, ISimpleMarkerSymbol, IStatisticDefinition, ITextSymbol } from "./rest-js-types";
/**
 * Version of the current specification.
 */
export declare const WebChartCurrentVersion = "23.2.0";
/**
 ...
 */
export type WebChartTextSymbol = Omit<ITextSymbol, "angle" | "style" | "xoffset" | "yoffset"> & {
    /**
...
export interface WebChartAxis {
     ...
     */
    dateBaseInterval?: TimeIntervalInfo;
}
/**
 ...
 *
 * @remarks The former `orderByFields` property is replaced by the `orderOptions` property of `WebChart`.
 */
export type WebChartSeriesQuery = Omit<WebChartQuery, "distance" | "gdbVersion" | "geometry" | "num" | "objectIds" | "orderByFields" | "spatialRelationship" | "start" | "timeExtent" | "units">;
/**
 * JSON representation of filters applied to the data
 */
export type WebChartDataFilters = Pick<WebChartQuery, "distance" | "gdbVersion" | "geometry" | "objectIds" | "spatialRelationship" | "timeExtent" | "units" | "where">;
/**
...
/**
 * Represents the properties related to the the fixed-date temporal binning. It currently covers the same scope as `WebChartDateBinning`.
 */
export interface WebChartFixedDateBinning extends WebChartDateBinning {
    type: typeof WebChartTemporalBinningTypes.FixedDateBased;
    /**
     * The unit of time to use to bin the temporal data.
     */
    unit?: WebChartFixedDateBinningUnits;
}
/**
 * Represents the properties related to the calendar-based temporal binning. It supports the same properties as `WebChartDateBinning` and adds some.
 */
export interface WebChartCalendarBasedBinning extends WebChartDateBinning {
    type: typeof WebChartTemporalBinningTypes.CalendarBased;
    /**
     * The unit of time to use to bin the temporal data.
     */
    unit?: WebChartCalendarBinningUnits;
    /**
     ...
     */
    offset?: {
        unit: WebChartCalendarBinningOffsetUnits;
        size: number;
    };
    /**
     * Defines the [IANA time zone](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) used for temporal bin calculations
     */
    outTimeZone?: string;
}
/**
...
export interface WebChartTemporalSeries {
     ...
     * If set to `false` the `binCount` and `unit` properties can be used to set the date axis base interval.
     * @default true
     */
    binTemporalData?: boolean;
    /**
     * Defines the pattern to apply to bin the data.
     * The "fixedDateBased" type will make the bins start at the beginning of the given period (1st of the week, 1st of the month, 1st or the day, etc.)
     * The "calendarBased" type will make the bins start at the data set first entry (e.g. it the first date is 1/18/20 and the binning is done by month, the bins
     * will go from the 18th to a month to the 17th of the next month).
     */
...
export interface WebChartBarChartSeries extends WebChartSeries, WebChartTemporalSeries {
    ...
    /**
     * When true or undefined (default), the labels displayed within a small stacked column are hidden to avoid cluttering.
     * When false, all the data labels are displayed.
     * @default true
     */
    hideOversizedStackedLabels?: boolean;
    /**
     * When true, the labels displayed within a small column for sideBySide bar series are hidden to avoid cluttering.
     * When false or undefined (default), all the data labels are displayed.
     * @default false
     */
    hideOversizedSideBySideLabels?: boolean;
}
/**
...
export interface WebChartPieChartSeries extends WebChartSeries {
    ...
    fillSymbol?: ISimpleFillSymbol;
    /**
     * Indicates whether the category associated to a slice is to be displayed on its data label.
     ...
     * @default true
     */
    displayCategoryOnTooltip?: boolean;
    /**
 ...
 */
export interface WebChartLineChartSeries<SeriesType extends "lineSeries" | "radarSeries" = "lineSeries"> extends WebChartSeries, WebChartTemporalSeries {
    /**
    ...
    /**
     * Whether to connect the lines when there's a gap in the data.
     * Can be overridden by the temporal data setting `nullPolicy`.
     * @default true
     */
...
export type WebChartRadarChartSeries = WebChartLineChartSeries<"radarSeries">;
/**
...
export interface WebChart {
     ...
     * The default value for the horizontal axis is "rotate" except for Histogram, where the default is none.
     * @default "rotate"
     */
 ...
 */
export interface WebGaugeChart extends WebChart {
    /**
     * Represents the size of the hole in middle of the chart. The number is used as a percentage rather than a fixed value.
     * @default 50
     */
 ...
 */
export interface WebBoxPlot extends WebChart {
    /**
 ...
 */
export interface WebRadarChart extends WebChart {
    /**
