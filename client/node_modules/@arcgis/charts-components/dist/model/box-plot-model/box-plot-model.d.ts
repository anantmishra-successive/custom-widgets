...
import { Color, RESTSimpleLineSymbolStyle, WebChart, WebChartDataFilters } from '@arcgis/charts-spec';
...
import { ModelWithColorMatch, ModelWithDataLabels, ModelWithLegend, ModelWithRotation, ModelWithTooltips, ModelWithXYAxes, ModelWithYGuides } from '../mixins';
export declare class BoxPlotModel extends ChartModel {
    /**
     * Current configuration used for the box plot chart.
     */
    protected _config: ChartConfig<typeof ModelTypes.BoxPlot, WebChart>;
    ...
    setup(params: ModelParams<ChartConfig<typeof ModelTypes.BoxPlot>>): Promise<void>;
    /**
...
export interface BoxPlotModel extends ModelWithXYAxes, ModelWithLegend, ModelWithTooltips, ModelWithColorMatch, ModelWithRotation, ModelWithDataLabels, ModelWithYGuides {
}
