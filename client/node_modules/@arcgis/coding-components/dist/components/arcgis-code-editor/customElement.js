import { g as r, c as a } from "../../chunks/runtime.js";
import { i as d } from "../../chunks/monaco-importer.js";
import { Deferred as g, generateGuid as s, observeAncestorsMutation as B, getElementTheme as l } from "@arcgis/components-utils";
...
class I extends w {
  constructor() {
    super(...arguments), this._componentReadyDefer = new g(), this._disposables = [], this._monacoEditor = h(d), this.modelId = s(), this.value = "", this.arcgisSelectionChange = i({ bubbles: !1 }), this.arcgisValueChange = i({ bubbles: !1 });
  }
  static {
  ...
  loaded() {
    ...
    }), this._themeObserver = B(this.el, ["class"], () => this.updateTheme()), this.updateTheme(), new ResizeObserver(() => this._editorInstance?.layout()).observe(this.el), this.addCommonEditorActions();
  }
  ...
  _updateModelValue() {
    ...
    if (!A || A.getValue() === this.value)
      return;
    const o = A.getFullModelRange();
    this._editorInstance.executeEdits("", [{ range: o, text: this.value, forceMoveMarkers: !0 }]), this._editorInstance.pushUndoStop();
  }
  _updateModel() {
    if (!this._editorInstance)
      return;
  ...
  getUri() {
    return this.modelId ? c.parse(this.modelId) : c.parse("");
  }
  updateTheme() {
    const A = l(this.el) === "light" ? "vs" : "vs-dark";
    A !== this._currentTheme && (this._currentTheme = A, this._monacoEditor.setTheme(A));
  }
  addCommonEditorActions() {
    const A = this._editorInstance?.getAction("editor.action.fontZoomIn"), o = this._editorInstance?.getAction("editor.action.fontZoomOut");
    this._editorInstance?.addAction({
      ...
      keybindings: [n.CtrlCmd | t.Minus],
      contextMenuGroupId: "zooming",
      contextMenuOrder: 2,
      run: async () => await o?.run()
    });
  }
}
a("arcgis-code-editor", I);
export {
  I as ArcgisCodeEditor
};
