import { ColumnSeries, LineSeries, PieChart, PieSeries, XYChart } from '@amcharts/amcharts4/charts.js';
import { ListTemplate, Sprite } from '@amcharts/amcharts4/core.js';
 ...
 * @param chart
 */
export declare function switchElementsSelectionState(elements: ListTemplate<Sprite>, chart: PieChart | XYChart): Sprite[];
/**
