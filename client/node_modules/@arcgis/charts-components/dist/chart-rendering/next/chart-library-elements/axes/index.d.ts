...
import { List } from '@amcharts/amcharts5/.internal/core/util/List.js';
import { AxisRendererCircular, AxisRendererRadial } from '@amcharts/amcharts5/radar.js';
import { Axis, AxisRenderer, XYChart, AxisRendererX, AxisRendererY } from '@amcharts/amcharts5/xy.js';
import { TimeIntervalInfo, WebChart, WebChartAxis, WebChartDataTypes, WebChartLabelBehavior, WebChartTypes } from '@arcgis/charts-spec';
...
import { UpdateAxesProps } from '../../interfaces';
import { UpdateGaugeAxisProps } from './gauge/interfaces';
/**
 ...
 * @param props.externalAxisLabelFormatter The axis value formatter
