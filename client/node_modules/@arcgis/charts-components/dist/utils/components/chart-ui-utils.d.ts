...
import { NumericFieldsChangeProps } from '../../interfaces';
import { FormatKeys } from '../../model';
...
export declare const aggregationList: ("count" | "avg" | "max" | "min" | "percentile-continuous" | "sum" | "no_aggregation")[];
 ...
 * @param placement
 */
export declare function getPopoverOffsetDistance(placement: HTMLCalcitePopoverElement["placement"] | undefined): number;
/**
 ...
 * @param tooltip
 */
export declare const destroyActionTooltip: (tooltip: HTMLCalciteTooltipElement | undefined) => void;
/**
