...
const An = "Canceled";
function Ga(e) {
  return e instanceof Xa ? !0 : e instanceof Error && e.name === An && e.message === An;
}
...
class kt {
  ...
  add(t) {
    ...
    return this._isDisposed ? kt.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t;
  }
  /**
...
(function(e) {
  ...
  function n(E) {
    return (w, A = null, R) => {
      ...
      return F = E((U) => {
        if (!I)
          return F ? F.dispose() : I = !0, w.call(A, U);
      }, null, R), I && F.dispose(), F;
    };
  }
  e.once = n;
  function i(E, w) {
    return e.once(e.filter(E, w));
  }
  e.onceIf = i;
  function r(E, w, A) {
    return c((R, I = null, F) => E((U) => R.call(I, w(U)), null, F), A);
  }
  e.map = r;
  function s(E, w, A) {
    return c((R, I = null, F) => E((U) => {
      w(U), R.call(I, U);
    }, null, F), A);
  }
  e.forEach = s;
  function a(E, w, A) {
    return c((R, I = null, F) => E((U) => w(U) && R.call(I, U), null, F), A);
  }
  e.filter = a;
  function l(E) {
    return E;
  ...
  function o(...E) {
    return (w, A = null, R) => {
      const I = Ja(...E.map((F) => F((U) => w.call(A, U))));
      return d(I, R);
    };
  }
  e.any = o;
  ...
  function c(E, w) {
    ...
    return w?.add(I), I.event;
  }
  function d(E, w) {
    return w instanceof Array ? w.push(E) : w && w.add(E), E;
  }
  function m(E, w, A = 100, R = !1, I = !1, F, U) {
    let W, q, X, se = 0, _e;
    const mn = {
      leakWarningThreshold: F,
      onWillAddFirstListener() {
        W = E((Oa) => {
          se++, q = w(q, Oa), R && !X && (St.fire(q), q = void 0), _e = () => {
            const Va = q;
            q = void 0, X = void 0, (!R || se > 1) && St.fire(Va), se = 0;
          }, typeof A == "number" ? (clearTimeout(X), X = setTimeout(_e, A)) : X === void 0 && (X = 0, queueMicrotask(_e));
        });
      },
    ...
    return U?.add(St), St.event;
  }
  e.debounce = m;
  function f(E, w = 0, A) {
    return e.debounce(E, (R, I) => R ? (R.push(I), R) : [I], w, void 0, !0, void 0, A);
  }
  e.accumulate = f;
  function _(E, w = (R, I) => R === I, A) {
    let R = !0, I;
    return a(E, (F) => {
      const U = R || !w(F, I);
      return R = !1, I = F, U;
  ...
  e.split = g;
  function k(E, w = !1, A = [], R) {
    let I = A.slice(), F = E((q) => {
      I ? I.push(q) : W.fire(q);
    });
    R && R.add(F);
    const U = () => {
      I?.forEach((q) => W.fire(q)), I = null;
    }, W = new we({
      onWillAddFirstListener() {
        F || (F = E((q) => W.fire(q)), R && R.add(F));
      },
  ...
  function M(E, w, A = (R) => R) {
    const R = (...W) => U.fire(A(...W)), I = () => E.on(w, R), F = () => E.removeListener(w, R), U = new we({ onWillAddFirstListener: I, onDidRemoveLastListener: F });
    return U.event;
  }
  e.fromNodeEventEmitter = M;
  function D(E, w, A = (R) => R) {
    const R = (...W) => U.fire(A(...W)), I = () => E.addEventListener(w, R), F = () => E.removeEventListener(w, R), U = new we({ onWillAddFirstListener: I, onDidRemoveLastListener: F });
    return U.event;
  }
  e.fromDOMEventEmitter = D;
  function N(E) {
    return new Promise((w) => n(E)(w));
  }
  e.toPromise = N;
  function b(E) {
    const w = new we();
  ...
  class H {
    constructor(w, A) {
      ...
      this.emitter = new we(R), A && A.add(this.emitter);
    }
    beginUpdate(w) {
      this._counter++;
    }
  ...
  function S(E, w) {
    return new H(E, w).emitter.event;
  }
  e.fromObservable = S;
  function T(E) {
    return (w, A, R) => {
      ...
      const U = {
        ...
        endUpdate() {
          I--, I === 0 && (E.reportChanges(), F && (F = !1, w.call(A)));
        },
      ...
      return R instanceof kt ? R.add(W) : Array.isArray(R) && R.push(W), W;
    };
  }
...
class Ot {
  ...
  start(t) {
    this._stopWatch = new hn(), this.listenerCount = t;
  }
  stop() {
    if (this._stopWatch) {
...
class ci {
  ...
  constructor(t, n, i = (ci._idPool++).toString(16).padStart(3, "0")) {
...
class we {
  constructor(t) {
    this._size = 0, this._options = t, this._leakageMon = this._options?.leakWarningThreshold ? new ci(t?.onListenerError ?? gt, this._options?.leakWarningThreshold ?? Ka) : void 0, this._perfMon = this._options?._profName ? new Ot(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (t, n, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(l);
        const o = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], u = new to(`${l}. HINT: Stack shows most frequent listener (${o[1]}-times)`, o[0]);
        return (this._options?.onListenerError || gt)(u), Bt.None;
      }
      if (this._disposed)
        return Bt.None;
      n && (t = t.bind(n));
      const r = new fn(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = hi.create(), s = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof fn ? (this._deliveryQueue ??= new io(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._size++;
      const a = Pt(() => {
        s?.(), this._removeListener(r);
      });
      return i instanceof kt ? i.add(a) : Array.isArray(i) && i.push(a), a;
    }, this._event;
  }
  _removeListener(t) {
  ...
  _deliver(t, n) {
    if (!t)
      return;
    const i = this._options?.onListenerError || gt;
    if (!i) {
      t.value(n);
      return;
    }
   ...
   */
  fire(t) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof fn)
...
const so = da() === "pseudo" || typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function wi(e, t) {
  let n;
...
function J(e, t, ...n) {
  return wi(typeof e == "number" ? ao(e, t) : t, n);
}
function ao(e, t) {
  const n = ro()?.[e];
  if (typeof n != "string") {
...
const it = "en";
let Sn = !1, Ln = !1, pn = !1, ma = !1, di = !1, Lt, gn = it, vi = it, oo, Me;
const De = globalThis;
let pe;
typeof De.vscode < "u" && typeof De.vscode.process < "u" ? pe = De.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (pe = process);
const lo = typeof pe?.versions?.electron == "string", uo = lo && pe?.type === "renderer";
if (typeof pe == "object") {
  Sn = pe.platform === "win32", Ln = pe.platform === "darwin", pn = pe.platform === "linux", pn && pe.env.SNAP && pe.env.SNAP_REVISION, pe.env.CI || pe.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Lt = it, gn = it;
  const e = pe.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      Lt = t.userLocale, vi = t.osLocale, gn = t.resolvedLanguage || it, oo = t.languagePack?.translationsConfigFile;
    } catch {
    }
  ma = !0;
} else typeof navigator == "object" && !uo ? (Me = navigator.userAgent, Sn = Me.indexOf("Windows") >= 0, Ln = Me.indexOf("Macintosh") >= 0, (Me.indexOf("Macintosh") >= 0 || Me.indexOf("iPad") >= 0 || Me.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, pn = Me.indexOf("Linux") >= 0, Me?.indexOf("Mobi") >= 0, di = !0, gn = da() || it, Lt = navigator.language.toLowerCase(), vi = Lt) : console.error("Unable to resolve platform.");
const vt = Sn, co = Ln, ho = ma, mo = di, fo = di && typeof De.importScripts == "function", po = fo ? De.origin : void 0, Re = Me, go = typeof De.postMessage == "function" && !De.importScripts;
(() => {
  if (go) {
    const e = [];
    ...
    return (n) => {
      ...
      e.push({
        id: i,
        callback: n
      }), De.postMessage({ vscodeScheduleAsyncWork: i }, "*");
    };
  }
  return (e) => setTimeout(e);
})();
const bo = !!(Re && Re.indexOf("Chrome") >= 0);
Re && Re.indexOf("Firefox") >= 0;
!bo && Re && Re.indexOf("Safari") >= 0;
Re && Re.indexOf("Edg/") >= 0;
...
class wo {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = _o) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
class qe {
  ...
  static {
    this._locales = new yi(() => Object.keys(qe.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
  }
  static getLocales() {
...
let st;
const bn = globalThis.vscode;
if (typeof bn < "u" && typeof bn.process < "u") {
  const e = bn.process;
  st = {
    get platform() {
      return e.platform;
...
} else typeof process < "u" && typeof process?.versions?.node == "string" ? st = {
  get platform() {
  ...
  // Supported
  get platform() {
    return vt ? "win32" : co ? "darwin" : "linux";
  },
  get arch() {
  },
  // Unsupported
...
const jt = st.cwd, Lo = st.env, Co = st.platform, Eo = 65, Ro = 97, Mo = 90, No = 122, Ve = 46, ae = 47, ce = 92, Ue = 58, Do = 63;
...
function Io(e, t) {
  if (e === null || typeof e != "object")
    throw new ga(t, "Object", e);
}
function K(e, t) {
  if (typeof e != "string")
    throw new ga(t, "string", e);
}
const He = Co === "win32";
function V(e) {
  return e === ae || e === ce;
...
function ba(e, t) {
  Io(t, "pathObject");
  const n = t.dir || t.root, i = t.base || `${t.name || ""}${zo(t.ext)}`;
...
const le = {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      ...
      if (r >= 0) {
        if (s = e[r], K(s, `paths[${r}]`), s.length === 0)
          continue;
      } else t.length === 0 ? s = jt() : (s = Lo[`=${t}`] || jt(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === ce) && (s = `${t}\\`));
      const a = s.length;
      let l = 0, o = "", u = !1;
      ...
      if (a === 1)
        ...
        if (u = !0, V(s.charCodeAt(1))) {
          ...
          l = 1;
      else We(c) && s.charCodeAt(1) === Ue && (o = s.slice(0, 2), l = 2, a > 2 && V(s.charCodeAt(2)) && (u = !0, l = 3));
      if (o.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (V(s))
      if (r = !0, V(e.charCodeAt(1))) {
        ...
        n = 1;
    else We(s) && e.charCodeAt(1) === Ue && (i = e.slice(0, 2), n = 2, t > 2 && V(e.charCodeAt(2)) && (r = !0, n = 3));
    let a = n < t ? $t(e.slice(n), !r, "\\", V) : "";
  ...
  isAbsolute(e) {
    ...
    t > 2 && We(n) && e.charCodeAt(1) === Ue && V(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
  ...
  relative(e, t) {
    ...
    for (; r < e.length && e.charCodeAt(r) === ce; )
      r++;
    let s = e.length;
    for (; s - 1 > r && e.charCodeAt(s - 1) === ce; )
      s--;
    const a = s - r;
    let l = 0;
    for (; l < t.length && t.charCodeAt(l) === ce; )
      l++;
    let o = t.length;
    for (; o - 1 > l && t.charCodeAt(o - 1) === ce; )
      o--;
    ...
    if (m !== c) {
      ...
      if (u > c) {
        if (t.charCodeAt(l + m) === ce)
          return i.slice(l + m + 1);
        if (m === 2)
          return i.slice(l + m);
      }
      a > c && (e.charCodeAt(r + m) === ce ? d = m : m === 2 && (d = 3)), d === -1 && (d = 0);
    }
    let f = "";
    for (m = r + d + 1; m <= s; ++m)
      (m === s || e.charCodeAt(m) === ce) && (f += f.length === 0 ? ".." : "\\..");
    return l += d, f.length > 0 ? `${f}${i.slice(l, o)}` : (i.charCodeAt(l) === ce && ++l, i.slice(l, o));
  },
  toNamespacedPath(e) {
    ...
    } else if (We(t.charCodeAt(0)) && t.charCodeAt(1) === Ue && t.charCodeAt(2) === ce)
      return `\\\\?\\${t}`;
    return e;
  },
  dirname(e) {
    ...
    } else We(r) && e.charCodeAt(1) === Ue && (n = t > 2 && V(e.charCodeAt(2)) ? 3 : 2, i = n);
    let s = -1, a = !0;
    for (let l = t - 1; l >= i; --l)
      if (V(e.charCodeAt(l))) {
        if (!a) {
  ...
  basename(e, t) {
    ...
    let n = 0, i = -1, r = !0, s;
    if (e.length >= 2 && We(e.charCodeAt(0)) && e.charCodeAt(1) === Ue && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === Ue && We(e.charCodeAt(0)) && (t = i = 2);
    for (let l = e.length - 1; l >= t; --l) {
      ...
      r === -1 && (s = !1, r = l + 1), o === Ve ? n === -1 ? n = l : a !== 1 && (a = 1) : n !== -1 && (a = -1);
    }
  ...
  parse(e) {
    ...
    } else if (We(r) && e.charCodeAt(1) === Ue) {
      if (n <= 2)
    ...
    for (; u >= i; --u) {
      ...
      l === -1 && (o = !1, l = u + 1), r === Ve ? s === -1 ? s = u : c !== 1 && (c = 1) : s !== -1 && (c = -1);
    }
  ...
  resolve(...e) {
    ...
    for (let i = e.length - 1; i >= -1 && !n; i--) {
      const r = i >= 0 ? e[i] : Ho();
      K(r, `paths[${i}]`), r.length !== 0 && (t = `${r}/${t}`, n = r.charCodeAt(0) === ae);
    }
    return t = $t(t, !n, "/", En), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (K(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === ae, n = e.charCodeAt(e.length - 1) === ae;
    return e = $t(e, !t, "/", En), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
  ...
  relative(e, t) {
    if (K(e, "from"), K(t, "to"), e === t || (e = ue.resolve(e), t = ue.resolve(t), e === t))
      return "";
    ...
    if (u === l)
      if (a > l) {
        ...
        if (u === 0)
          return t.slice(s + u);
      } else r > l && (e.charCodeAt(n + u) === ae ? o = u : u === 0 && (o = 0));
    let c = "";
    for (u = n + o + 1; u <= i; ++u)
  ...
  parse(e) {
    ...
    for (; o >= i; --o) {
      ...
      a === -1 && (l = !1, a = o + 1), c === Ve ? r === -1 ? r = o : u !== 1 && (u = 1) : r !== -1 && (u = -1);
    }
    if (a !== -1) {
      const c = s === 0 && n ? 1 : s;
...
ue.win32 = le.win32 = le;
ue.posix = le.posix = ue;
He ? le.normalize : ue.normalize;
const Uo = He ? le.join : ue.join;
He ? le.resolve : ue.resolve;
He ? le.relative : ue.relative;
He ? le.dirname : ue.dirname;
He ? le.basename : ue.basename;
He ? le.extname : ue.extname;
He ? le.sep : ue.sep;
const Wo = /^\w[\w\d+.-]*$/, Fo = /^\//, Po = /^\/\//;
function Bo(e, t) {
  if (!e.scheme && t)
...
let Ce = class Mt {
  static isUri(t) {
    return t instanceof Mt ? !0 : t ? typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function" : !1;
  }
  /**
   * @internal
   */
  constructor(t, n, i, r, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || Y, this.authority = t.authority || Y, this.path = t.path || Y, this.query = t.query || Y, this.fragment = t.fragment || Y) : (this.scheme = qo(t, a), this.authority = n || Y, this.path = Oo(this.scheme, i || Y), this.query = r || Y, this.fragment = s || Y, Bo(this, a));
  }
  // ---- filesystem path -----------------------
  /**
  ...
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = Y), i === void 0 ? i = this.authority : i === null && (i = Y), r === void 0 ? r = this.path : r === null && (r = Y), s === void 0 ? s = this.query : s === null && (s = Y), a === void 0 ? a = this.fragment : a === null && (a = Y), n === this.scheme && i === this.authority && r === this.path && s === this.query && a === this.fragment ? this : new Je(n, i, r, s, a);
  }
  // ---- parse & validate ------------------------
  /**
  ...
  static parse(t, n = !1) {
    const i = Vo.exec(t);
    return i ? new Je(i[2] || Y, Ct(i[4] || Y), Ct(i[5] || Y), Ct(i[7] || Y), Ct(i[9] || Y), n) : new Je(Y, Y, Y, Y, Y);
  }
  /**
  ...
  static file(t) {
    let n = Y;
    if (vt && (t = t.replace(/\\/g, ke)), t[0] === ke && t[1] === ke) {
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return vt && t.scheme === "file" ? i = Mt.file(le.join(Rn(t, !0), ...n)).path : i = ue.join(t.path, ...n), t.with({ path: i });
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new Je(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === _a ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
};
const _a = vt ? 1 : void 0;
class Je extends Ce {
  constructor() {
  ...
  toString(t = !1) {
    return t ? Mn(this, !0) : (this._formatted || (this._formatted = Mn(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: 1
...
function va(e) {
  try {
    ...
    return e.length > 3 ? e.substr(0, 3) + va(e.substr(3)) : e;
  }
}
const Ti = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function Ct(e) {
  return e.match(Ti) ? e.replace(Ti, (t) => va(t)) : e;
}
var Oe;
(function(e) {
...
class Go {
  ...
  get _remoteResourcesPath() {
    return ue.join(this._serverRootPath, Oe.vscodeRemoteResource);
  }
  rewrite(t) {
    if (this._delegate)
      try {
    ...
    return typeof s == "string" && (a += `&${$o}=${encodeURIComponent(s)}`), Ce.from({
      scheme: mo ? this._preferredWebSchema : Oe.vscodeRemoteResource,
      authority: `${i}:${r}`,
...
const Xo = new Go(), Yo = "vscode-app";
class Gt {
  static {
    this.FALLBACK_AUTHORITY = Yo;
  }
  /**
   ...
   */
  uriToBrowserUri(t) {
    return t.scheme === Oe.vscodeRemote ? Xo.rewrite(t) : (
      // ...only ever for `file` resources
      t.scheme === Oe.file && // ...and we run in native environments
      (ho || // ...or web worker extensions on desktop
      po === `${Oe.vscodeFileResource}://${Gt.FALLBACK_AUTHORITY}`) ? t.with({
        scheme: Oe.vscodeFileResource,
        // We need to provide an authority here so that it can serve
        // as origin for network and loading matters in chromium.
        // If the URI is not coming with an authority already, we
        // add our own
        authority: t.authority || Gt.FALLBACK_AUTHORITY,
        query: null,
        fragment: null
      }) : t
    );
  ...
  toUri(t, n) {
    ...
    if (globalThis._VSCODE_FILE_ROOT) {
      ...
      if (/^\w[\w\d+.-]*:\/\//.test(i))
        return Ce.joinPath(Ce.parse(i, !0), t);
      const r = Uo(i, t);
      return Ce.file(r);
    }
    return Ce.parse(n.toUrl(t));
  }
}
const ya = new Gt();
var ki;
...
const _n = "default", Jo = "$initialize";
class Qo {
...
class tl {
  ...
  sendMessage(t, n, i) {
    ...
    return new Promise((s, a) => {
      this._pendingReplies[r] = {
        resolve: s,
        reject: a
      }, this._send(new Qo(this._workerId, r, t, n, i));
    });
  }
  listen(t, n, i) {
    let r = null;
    const s = new we({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, s), this._send(new Zo(this._workerId, r, t, n, i));
      },
      onDidRemoveLastListener: () => {
  ...
  createProxyToRemoteChannel(t, n) {
    const i = {
      get: (r, s) => (typeof s == "string" && !r[s] && (Ta(s) ? r[s] = (a) => this.listen(t, s, a) : xa(s) ? r[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === 36 && (r[s] = async (...a) => (await n?.(), this.sendMessage(t, s, a)))), r[s])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((r) => {
      this._send(new Ai(this._workerId, n, r, void 0));
    }, (r) => {
      r.detail instanceof Error && (r.detail = _i(r.detail)), this._send(new Ai(this._workerId, n, void 0, _i(r)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, i = this._handler.handleEvent(t.channel, t.eventName, t.arg)((r) => {
      this._send(new Ko(this._workerId, n, r));
    });
...
class nl {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new tl({
      sendMessage: (i, r) => {
        t(i, r);
      },
  ...
  _handleMessage(t, n, i) {
    ...
    const r = t === _n ? this._requestHandler : this._localChannels.get(t);
    if (!r)
  ...
  async initialize(t, n, i) {
    ...
    return n && (typeof n.baseUrl < "u" && delete n.baseUrl, typeof n.paths < "u" && typeof n.paths.vs < "u" && delete n.paths.vs, typeof n.trustedTypesPolicy < "u" && delete n.trustedTypesPolicy, n.catchError = !0, globalThis.require.config(n)), import(`${ya.asBrowserUri(`${i}.js`).toString(!0)}`).then((s) => {
...
function wn(e, t, n = 32) {
  const i = n - t, r = ~((1 << i) - 1);
  return (e << t | (r & e) >>> i) >>> 0;
}
function Li(e, t = 0, n = e.byteLength, i = 0) {
  for (let r = 0; r < n; r++)
    e[t + r] = i;
}
function rl(e, t, n = "0") {
...
function ht(e, t = 32) {
  return e instanceof ArrayBuffer ? Array.from(new Uint8Array(e)).map((n) => n.toString(16).padStart(2, "0")).join("") : rl((e >>> 0).toString(16), t / 4);
}
class ka {
  static {
  ...
  digest() {
    ...
    )), this._totalLen += this._buffLen, this._wrapUp()), ht(this._h0) + ht(this._h1) + ht(this._h2) + ht(this._h3) + ht(this._h4);
  }
  _wrapUp() {
    this._buff[this._buffLen++] = 128, Li(this._buff, this._buffLen), this._buffLen > 56 && (this._step(), Li(this._buff));
  ...
  _step() {
    const t = ka._bigBlock32, n = this._buffDV;
    for (let d = 0; d < 64; d += 4)
      t.setUint32(d, n.getUint32(d, !1), !1);
    for (let d = 64; d < 320; d += 4)
      t.setUint32(d, wn(t.getUint32(d - 12, !1) ^ t.getUint32(d - 32, !1) ^ t.getUint32(d - 56, !1) ^ t.getUint32(d - 64, !1), 1), !1);
    let i = this._h0, r = this._h1, s = this._h2, a = this._h3, l = this._h4, o, u, c;
    for (let d = 0; d < 80; d++)
      d < 20 ? (o = r & s | ~r & a, u = 1518500249) : d < 40 ? (o = r ^ s ^ a, u = 1859775393) : d < 60 ? (o = r & s | r & a | s & a, u = 2400959708) : (o = r ^ s ^ a, u = 3395469782), c = wn(i, 5) + o + l + u + t.getUint32(d * 4, !1) & 4294967295, l = a, a = s, s = wn(r, 30), r = i, i = c;
...
function sl(e, t, n) {
  return new Be(new Ci(e), new Ci(t)).ComputeDiff(n).changes;
}
class Qe {
  static Assert(t, n) {
    if (!t)
...
class Be {
  ...
  constructor(t, n, i = null) {
    ...
    const [r, s, a] = Be._getElements(t), [l, o, u] = Be._getElements(n);
  ...
  ElementsAreStrictEqual(t, n) {
    if (!this.ElementsAreEqual(t, n))
      return !1;
    const i = Be._getStrictElement(this._originalSequence, t), r = Be._getStrictElement(this._modifiedSequence, n);
    return i === r;
  }
  ...
  ComputeDiffRecursive(t, n, i, r, s) {
    ...
    if (t > n || i > r) {
      let d;
      return i <= r ? (Qe.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), d = [
        new Fe(t, 0, i, r - i + 1)
      ]) : t <= n ? (Qe.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), d = [
        new Fe(t, n - t + 1, i, 0)
      ]) : (Qe.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), Qe.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), d = []), d;
    }
    ...
    if (!s[0]) {
      ...
      let m = [];
      return s[0] ? m = [
        new Fe(u + 1, n - (u + 1) + 1, c + 1, r - (c + 1) + 1)
      ] : m = this.ComputeDiffRecursive(u + 1, n, c + 1, r, s), this.ConcatenateChanges(d, m);
    }
    return [
      new Fe(t, n - t + 1, i, r - i + 1)
    ];
  }
  WALKTRACE(t, n, i, r, s, a, l, o, u, c, d, m, f, _, g, k, y, v) {
    let L = null, M = null, D = new Ei(), N = n, b = i, p = f[0] - k[0] - r, x = -1073741824, H = this.m_forwardHistory.length - 1;
    do {
      const S = p + t;
      S === N || S < b && u[S - 1] < u[S + 1] ? (d = u[S + 1], _ = d - p - r, d < x && D.MarkNextChange(), x = d, D.AddModifiedElement(d + 1, _), p = S + 1 - t) : (d = u[S - 1] + 1, _ = d - p - r, d < x && D.MarkNextChange(), x = d - 1, D.AddOriginalElement(d, _ + 1), p = S - 1 - t), H >= 0 && (u = this.m_forwardHistory[H], t = u[0], N = 1, b = u.length - 1);
    } while (--H >= -1);
    if (L = D.getReverseChanges(), v[0]) {
      let S = f[0] + 1, T = k[0] + 1;
      if (L !== null && L.length > 0) {
        const E = L[L.length - 1];
        S = Math.max(S, E.getOriginalEnd()), T = Math.max(T, E.getModifiedEnd());
      }
      M = [
        new Fe(S, m - S + 1, T, g - T + 1)
      ];
    } else {
      D = new Ei(), N = a, b = l, p = f[0] - k[0] - o, x = 1073741824, H = y ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const S = p + s;
        S === N || S < b && c[S - 1] >= c[S + 1] ? (d = c[S + 1] - 1, _ = d - p - o, d > x && D.MarkNextChange(), x = d + 1, D.AddOriginalElement(d + 1, _ + 1), p = S + 1 - s) : (d = c[S - 1], _ = d - p - o, d > x && D.MarkNextChange(), x = d, D.AddModifiedElement(d + 1, _ + 1), p = S - 1 - s), H >= 0 && (c = this.m_reverseHistory[H], s = c[0], N = 1, b = c.length - 1);
      } while (--H >= -1);
      M = D.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, i, r, s, a, l) {
    ...
    const _ = n - t + (r - i), g = _ + 1, k = new Int32Array(g), y = new Int32Array(g), v = r - i, L = n - t, M = t - i, D = n - r, b = (L - v) % 2 === 0;
    k[v] = t, y[L] = n, l[0] = !1;
    for (let p = 1; p <= _ / 2 + 1; p++) {
      ...
      for (let T = c; T <= d; T += 2) {
        ...
        for (; o < n && u < r && this.ElementsAreEqual(o + 1, u + 1); )
          o++, u++;
        if (k[T] = o, o + u > x + H && (x = o, H = u), !b && Math.abs(T - L) <= p - 1 && o >= y[T])
          return s[0] = o, a[0] = u, E <= y[T] && p <= 1448 ? this.WALKTRACE(v, c, d, M, L, m, f, D, k, y, o, n, s, u, r, a, b, l) : null;
      }
      const S = (x - t + (H - i) - p) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(x, S))
        return l[0] = !0, s[0] = x, a[0] = H, S > 0 && p <= 1448 ? this.WALKTRACE(v, c, d, M, L, m, f, D, k, y, o, n, s, u, r, a, b, l) : (t++, i++, [
          new Fe(t, n - t + 1, i, r - i + 1)
        ]);
      m = this.ClipDiagonalBound(L - p, p, L, g), f = this.ClipDiagonalBound(L + p, p, L, g);
      for (let T = m; T <= f; T += 2) {
        T === m || T < f && y[T - 1] >= y[T + 1] ? o = y[T + 1] - 1 : o = y[T - 1], u = o - (T - L) - D;
        const E = o;
        for (; o > t && u > i && this.ElementsAreEqual(o, u); )
          o--, u--;
        if (y[T] = o, b && Math.abs(T - v) <= p && o <= k[T])
          return s[0] = o, a[0] = u, E >= k[T] && p <= 1448 ? this.WALKTRACE(v, c, d, M, L, m, f, D, k, y, o, n, s, u, r, a, b, l) : null;
      }
      if (p <= 1447) {
        let T = new Int32Array(d - c + 2);
        T[0] = v - c + 1, Ze.Copy2(k, c, T, 1, d - c + 1), this.m_forwardHistory.push(T), T = new Int32Array(f - m + 2), T[0] = L - m + 1, Ze.Copy2(y, m, T, 1, f - m + 1), this.m_reverseHistory.push(T);
      }
    }
    return this.WALKTRACE(v, c, d, M, L, m, f, D, k, y, o, n, s, u, r, a, b, l);
  }
  /**
  ...
  ChangesOverlap(t, n, i) {
    if (Qe.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), Qe.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart), i[0] = new Fe(r, s, a, l), !0;
    } else
      return i[0] = null, !1;
  }
  /**
...
let ee = class Ge {
  ...
  with(t = this.lineNumber, n = this.column) {
    return t === this.lineNumber && n === this.column ? this : new Ge(t, n);
  }
  /**
  ...
  static intersectRanges(t, n) {
    ...
    return i < l ? (i = l, r = o) : i === l && (r = Math.max(r, o)), s > u ? (s = u, a = c) : s === u && (a = Math.min(a, c)), i > s || i === s && r > a ? null : new te(i, r, s, a);
  }
  /**
      ...
      for (; u < o; ) {
        ...
        if (m === 13) {
          ...
          switch (v) {
            ...
            case 34:
            case 96:
              d === v ? L = 1 : d === 39 || d === 34 || d === 96 ? L = 0 : L = 1;
              break;
            case 42:
              L = d === 42 ? 1 : 0;
              break;
          ...
          L === 1 && (r.push(Xt._createLink(i, l, s, c, u)), y = !0);
        } else if (m === 12) {
          let L;
          v === 91 ? (_ = !0, L = 0) : L = i.get(v), L === 1 ? y = !0 : m = 13;
        } else
...
function cl(e) {
  return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : Xt.computeLinks(e);
}
class fi {
  constructor() {
...
class Nt {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? Aa : (this._emitter || (this._emitter = new we()), this._emitter.event);
  }
  dispose() {
...
class hl {
  ...
  cancel() {
    this._token ? this._token instanceof Nt && this._token.cancel() : this._token = Yt.Cancelled;
  }
  dispose(t = !1) {
    t && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof Nt && this._token.dispose() : this._token = Yt.None;
  }
}
class pi {
  constructor() {
...
const Dt = new pi(), Nn = new pi(), Dn = new pi(), dl = new Array(230), ml = /* @__PURE__ */ Object.create(null), fl = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const r of t) {
    ...
    if (i[a] || (i[a] = !0, ml[l] = a, fl[l.toLowerCase()] = a), !n[o]) {
      if (n[o] = !0, !u)
        throw new Error(`String representation missing for key code ${o} around scan code ${l}`);
      Dt.define(o, u), Nn.define(o, m || u), Dn.define(o, f || m || u);
    }
    c && (dl[c] = o);
  }
})();
...
(function(e) {
  function t(l) {
    return Dt.keyCodeToStr(l);
  }
  e.toString = t;
  function n(l) {
    return Dt.strToKeyCode(l);
  }
  e.fromString = n;
  function i(l) {
  ...
  function s(l) {
    return Nn.strToKeyCode(l) || Dn.strToKeyCode(l);
  }
...
class me extends G {
   ...
   */
  setEndPosition(t, n) {
    return this.getDirection() === 0 ? new me(this.startLineNumber, this.startColumn, t, n) : new me(t, n, this.startLineNumber, this.startColumn);
  }
  /**
  ...
  */
   ...
   */
  setStartPosition(t, n) {
    return this.getDirection() === 0 ? new me(t, n, this.endLineNumber, this.endColumn) : new me(this.endLineNumber, this.endColumn, t, n);
  }
  // ----
  /**
  ...
  static fromRange(t, n) {
    return n === 0 ? new me(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn) : new me(t.endLineNumber, t.endColumn, t.startLineNumber, t.startColumn);
  }
  /**
  ...
  static createWithDirection(t, n, i, r, s) {
    return s === 0 ? new me(t, n, i, r) : new me(i, r, t, n);
  }
}
function gl(e) {
...
class Sa {
  ...
  register(t, n) {
    return this._tokenizationSupports.set(t, n), this.handleChange([t]), Pt(() => {
...
class Tl {
  constructor() {
    this[Dr] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
  }
  clear() {
...
function Ml(e, t, n, i, r) {
  return El(e, t, n, i, r) && Rl(e, t, n, i, r);
}
class Nl {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          ko(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = r, this._prevMatchLength = s, !this._wordSeparators || Ml(this._wordSeparators, t, n, r, s))
        return i;
    } while (i);
    return null;
  }
}
function Dl(e, t = "Unreachable") {
  throw new Error(t);
}
function Qt(e) {
  if (!e()) {
    debugger;
    e(), gt(new be("Assertion Failed"));
  }
}
function La(e, t) {
  let n = 0;
...
function gi(e, t, n, i, r) {
  if (t = Ea(t), r || (r = Ft.first(Ra)), n.length > r.maxLen) {
    let u = e - r.maxLen / 2;
    return u < 0 ? u = 0 : i += u, n = n.substring(u, e + r.maxLen / 2), gi(e, t, n, i, r);
  }
...
class Ul {
  static computeUnicodeHighlights(t, n, i) {
    const r = i ? i.startLineNumber : 1, s = i ? i.endLineNumber : t.getLineCount(), a = new Wr(n), l = a.getCandidateCodePoints();
    let o;
    l === "allNonBasicAscii" ? o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${Wl(Array.from(l))}`, "g");
    const u = new Nl(null, o), c = [];
    let d = !1, m, f = 0, _ = 0, g = 0;
    e: for (let k = r, y = s; k <= y; k++) {
      const v = t.getLineContent(k), L = v.length;
      u.reset(0);
      do
        if (m = u.next(v), m) {
          ...
          if (p !== 0) {
            if (p === 3 ? f++ : p === 2 ? _++ : p === 1 ? g++ : Dl(), c.length >= 1e3) {
              d = !0;
              break e;
            }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (i.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 3: {
        const s = t.codePointAt(0), a = i.ambiguousCharacters.getPrimaryConfusable(s), l = qe.getLocales().filter((o) => !qe.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, o])).isAmbiguous(s));
...
function Wl(e, t) {
  return `[${vo(e.map((i) => String.fromCodePoint(i)).join(""))}]`;
}
class Wr {
  constructor(t) {
    this.options = t, this.allowedCodePoints = new Set(t.allowedCodePoints), this.ambiguousCharacters = qe.getInstance(new Set(t.allowedLocales));
  }
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const a of n) {
        const l = a.codePointAt(0), o = So(a);
        r = r || o, !o && !this.ambiguousCharacters.isAmbiguous(l) && !Ye.isInvisibleCharacter(l) && (s = !0);
      }
    return (
      /* Don't allow mixing weird looking characters with ASCII */
      !r && /* Is there an obviously weird looking character? */
      s ? 0 : this.options.invisibleCharacters && !Fr(t) && Ye.isInvisibleCharacter(i) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i) ? 3 : 0
    );
  }
}
function Fr(e) {
...
function yt(e, t, n = 0, i = e.length) {
  let r = n, s = i;
  for (; r < s; ) {
...
class dn {
  ...
  findLastMonotonous(t) {
    ...
    const n = yt(this._array, t, this._findLastMonotonousLastIdx);
...
class Ee {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = Wn(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), i = yt(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  intersects(t) {
    const n = lt(this._normalizedRanges, (i) => i.startLineNumber < t.endLineNumberExclusive);
   ...
   */
  subtractFrom(t) {
    const n = Wn(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), i = yt(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
      return new Ee([t]);
    const r = [];
    ...
    return s < t.endLineNumberExclusive && r.push(new O(s, t.endLineNumberExclusive)), new Ee(r);
  }
  toString() {
...
class ye {
  static inverse(t, n, i) {
    ...
    let s = 1, a = 1;
    for (const o of t) {
      const u = new ye(new O(s, o.original.startLineNumber), new O(a, o.modified.startLineNumber));
      u.modified.isEmpty || r.push(u), s = o.original.endLineNumberExclusive, a = o.modified.endLineNumberExclusive;
    }
    const l = new ye(new O(s, n + 1), new O(a, i + 1));
  ...
  static clip(t, n, i) {
    ...
    for (const s of t) {
      ...
      a && !a.isEmpty && l && !l.isEmpty && r.push(new ye(a, l));
    }
    return r;
  }
  constructor(t, n) {
  ...
  */
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new Ae(new G(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new G(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new Ae(new G(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new G(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
  }
  /**
   * This method assumes that the LineRangeMapping describes a valid diff!
   * I.e. if one range is empty, the other range cannot be the entire document.
  ...
  */
  toRangeMapping2(t, n) {
    if (Pr(this.original.endLineNumberExclusive, t) && Pr(this.modified.endLineNumberExclusive, n))
      return new Ae(new G(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new G(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new Ae(G.fromPositions(new ee(this.original.startLineNumber, 1), et(new ee(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), G.fromPositions(new ee(this.modified.startLineNumber, 1), et(new ee(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new Ae(G.fromPositions(et(new ee(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), et(new ee(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), G.fromPositions(et(new ee(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), et(new ee(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new be();
  }
}
function et(e, t) {
...
class Ie extends ye {
  ...
  flip() {
    return new Ie(this.modified, this.original, this.innerChanges?.map((t) => t.flip()));
  }
  withInnerChangesFromLineRanges() {
    return new Ie(this.original, this.modified, [this.toRangeMapping()]);
  }
}
class Ae {
  ...
  flip() {
    return new Ae(this.modifiedRange, this.originalRange);
  }
  /**
  ...
  */
  toTextEdit(t) {
    ...
    return new Bl(this.originalRange, n);
  }
}
const ql = 3;
class Ol {
  computeDiff(t, n, i) {
    ...
    for (const o of s.changes) {
      let u;
      o.originalEndLineNumber === 0 ? u = new O(o.originalStartLineNumber + 1, o.originalStartLineNumber + 1) : u = new O(o.originalStartLineNumber, o.originalEndLineNumber + 1);
      let c;
      o.modifiedEndLineNumber === 0 ? c = new O(o.modifiedStartLineNumber + 1, o.modifiedStartLineNumber + 1) : c = new O(o.modifiedStartLineNumber, o.modifiedEndLineNumber + 1);
      let d = new Ie(u, c, o.charChanges?.map((m) => new Ae(new G(m.originalStartLineNumber, m.originalStartColumn, m.originalEndLineNumber, m.originalEndColumn), new G(m.modifiedStartLineNumber, m.modifiedStartColumn, m.modifiedEndLineNumber, m.modifiedEndColumn))));
      l && (l.modified.endLineNumberExclusive === d.modified.startLineNumber || l.original.endLineNumberExclusive === d.original.startLineNumber) && (d = new Ie(l.original.join(d.original), l.modified.join(d.modified), l.innerChanges && d.innerChanges ? l.innerChanges.concat(d.innerChanges) : void 0), a.pop()), a.push(d), l = d;
    }
    return Qt(() => La(a, (o, u) => u.original.startLineNumber - o.original.endLineNumberExclusive === u.modified.startLineNumber - o.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    o.original.endLineNumberExclusive < u.original.startLineNumber && o.modified.endLineNumberExclusive < u.modified.startLineNumber)), new It(a, [], s.quitEarly);
  }
}
function Ma(e, t, n, i) {
  return new Be(e, t, n).ComputeDiff(i);
}
let Br = class {
  constructor(t) {
    const n = [], i = [];
    for (let r = 0, s = t.length; r < s; r++)
      n[r] = Fn(t[r], 1), i[r] = Pn(t[r], 1);
...
function jl(e) {
  ...
  for (let i = 1, r = e.length; i < r; i++) {
    ...
    Math.min(a, l) < ql ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
  }
  return t;
}
class bt {
...
class $l {
  ...
  computeDiff() {
    ...
    const t = Ma(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const l = [];
      for (let o = 0, u = n.length; o < u; o++)
        l.push(bt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[o], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: i,
        changes: l
      };
    ...
    for (let l = -1, o = n.length; l < o; l++) {
      ...
      for (; s < c && a < d; ) {
        ...
        if (m !== f) {
          ...
          {
            let _ = Pn(m, 1), g = Pn(f, 1);
            const k = m.length + 1, y = f.length + 1;
            for (; _ < k && g < y; ) {
              const v = m.charCodeAt(_ - 1), L = m.charCodeAt(g - 1);
              if (v !== L)
                break;
              _++, g++;
            }
      ...
      u && (r.push(bt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, u, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += u.originalLength, a += u.modifiedLength);
    }
    return {
      quitEarly: i,
      changes: r
  ...
  _pushTrimWhitespaceCharChange(t, n, i, r, s, a, l) {
    if (this._mergeTrimWhitespaceCharChange(t, n, i, r, s, a, l))
      return;
    let o;
    this.shouldComputeCharChanges && (o = [new at(n, i, n, r, s, a, s, l)]), t.push(new bt(n, n, s, s, o));
  }
  _mergeTrimWhitespaceCharChange(t, n, i, r, s, a, l) {
    ...
    if (o === 0)
      return !1;
    const u = t[o - 1];
    return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0 ? !1 : u.originalEndLineNumber === n && u.modifiedEndLineNumber === s ? (this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new at(n, i, n, r, s, a, s, l)), !0) : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === s ? (u.originalEndLineNumber = n, u.modifiedEndLineNumber = s, this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new at(n, i, n, r, s, a, s, l)), !0) : !1;
  }
}
function Fn(e, t) {
  const n = xo(e);
...
class Ut {
  ...
  findLastMaxBy(t) {
    let n, i = !0;
    return this.iterate((r) => ((i || Bn.isGreaterThan(t(r, n))) && (i = !1, n = r), !0)), n;
  }
}
class ze {
  static trivial(t, n) {
    return new ze([new Z(j.ofLength(t.length), j.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new ze([new Z(j.ofLength(t.length), j.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class Z {
  static invert(t, n) {
    const i = [];
    return Yl(t, (r, s) => {
      i.push(Z.fromOffsetPairs(r ? r.getEndExclusives() : Se.zero, s ? s.getStarts() : new Se(n, (r ? r.seq2Range.endExclusive - r.seq1Range.endExclusive : 0) + n)));
    }), i;
  }
  static fromOffsetPairs(t, n) {
    return new Z(new j(t.offset1, n.offset1), new j(t.offset2, n.offset2));
  }
  static assertSorted(t) {
    let n;
    for (const i of t) {
...
class eu {
  compute(t, n, i = At.instance, r) {
    if (t.length === 0 || n.length === 0)
      return ze.trivial(t, n);
    const s = new yn(t.length, n.length), a = new yn(t.length, n.length), l = new yn(t.length, n.length);
    for (let _ = 0; _ < t.length; _++)
      for (let g = 0; g < n.length; g++) {
        ...
        const L = Math.max(k, y, v);
        if (L === v) {
          const M = _ > 0 && g > 0 ? l.get(_ - 1, g - 1) : 0;
          l.set(_, g, M + 1), a.set(_, g, 3);
        } else L === k ? (l.set(_, g, 0), a.set(_, g, 1)) : L === y && (l.set(_, g, 0), a.set(_, g, 2));
        s.set(_, g, L);
      }
    const o = [];
    let u = t.length, c = n.length;
    function d(_, g) {
      (_ + 1 !== u || g + 1 !== c) && o.push(new Z(new j(_ + 1, u), new j(g + 1, c))), u = _, c = g;
    }
...
class Na {
  compute(t, n, i = At.instance) {
    ...
    o.set(0, a(0, 0));
    const u = new nu();
    u.set(0, o.get(0) === 0 ? null : new Or(null, 0, 0, o.get(0)));
    let c = 0;
    e: for (; ; ) {
      if (l++, !i.isValid())
        return ze.trivialTimedOut(r, s);
      const g = -Math.min(l, s.length + l % 2), k = Math.min(l, r.length + l % 2);
      for (c = g; c <= k; c += 2) {
        const y = c === k ? -1 : o.get(c + 1), v = c === g ? -1 : o.get(c - 1) + 1, L = Math.min(Math.max(y, v), r.length), M = L - c;
        if (L > r.length || M > s.length)
          continue;
        const D = a(L, M);
        o.set(c, D);
        const N = L === y ? u.get(c + 1) : u.get(c - 1);
        if (u.set(c, D !== L ? new Or(N, L, M, D - L) : N), o.get(c) === r.length && o.get(c) - c === s.length)
          break e;
      }
    }
    let d = u.get(c);
    ...
    for (; ; ) {
      ...
      if ((g !== f || k !== _) && m.push(new Z(new j(g, f), new j(k, _))), !d)
        break;
      f = d.x, _ = d.y, d = d.prev;
    }
    return m.reverse(), new ze(m, !1);
  }
}
class Or {
  constructor(t, n, i, r) {
...
class Zt {
  ...
  getBoundaryScore(t) {
    const n = jr(t > 0 ? this.elements[t - 1] : -1), i = jr(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && i === 8)
      return 0;
    if (n === 8)
      return 150;
    let r = 0;
    return n !== i && (r += 10, n === 0 && i === 1 && (r += 1)), r += Vr(n), r += Vr(i), r;
  }
  translateOffset(t, n = "right") {
    const i = yt(this.firstElementOffsetByLineIdx, (s) => s <= t), r = t - this.firstElementOffsetByLineIdx[i];
    return new ee(this.range.startLineNumber + i, 1 + this.lineStartOffsets[i] + r + (r === 0 && n === "left" ? 0 : this.trimmedWsLengthsByLineIdx[i]));
  }
  translateRange(t) {
  ...
  findWordContaining(t) {
    ...
    for (; n > 0 && xn(this.elements[n - 1]); )
      n--;
    let i = t;
    for (; i < this.elements.length && xn(this.elements[i]); )
      i++;
    return new j(n, i);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = lt(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0, i = Pl(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new j(n, i);
  }
}
function xn(e) {
...
function ru(e, t, n, i, r, s) {
  let { moves: a, excludedChanges: l } = au(e, t, n, s);
  if (!s.isValid())
    return [];
  const o = e.filter((c) => !l.has(c)), u = ou(o, i, r, t, n, s);
  return Ql(a, u), a = lu(a), a = a.filter((c) => {
    const d = c.original.toOffsetRange().slice(t).map((f) => f.trim());
    return d.join(`
`).length >= 15 && su(d, (f) => f.length >= 2) >= 2;
  }), a = uu(e, a), a;
}
function su(e, t) {
  let n = 0;
...
function au(e, t, n, i) {
  const r = [], s = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new xt(o.original, t, o)), a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new xt(o.modified, n, o))), l = /* @__PURE__ */ new Set();
  for (const o of s) {
    let u = -1, c;
    for (const d of a) {
    ...
    if (u > 0.9 && c && (a.delete(c), r.push(new ye(o.range, c.range)), l.add(o.source), l.add(c.source)), !i.isValid())
...
function ou(e, t, n, i, r, s) {
  ...
  o.sort(Zl(zt((m) => m.modifiedLineRange.length, Ht)));
  const u = new Ee(), c = new Ee();
  for (const m of o) {
    ...
    for (const y of k.ranges) {
      if (y.length < 3)
        continue;
      const v = y, L = y.delta(-f);
      a.push(new ye(L, v)), u.addRange(v), c.addRange(L);
    }
  }
  a.sort(zt((m) => m.original.startLineNumber, Ht));
  const d = new dn(e);
  for (let m = 0; m < a.length; m++) {
    const f = a[m], _ = d.findLastMonotonous((N) => N.original.startLineNumber <= f.original.startLineNumber), g = lt(e, (N) => N.modified.startLineNumber <= f.modified.startLineNumber), k = Math.max(f.original.startLineNumber - _.original.startLineNumber, f.modified.startLineNumber - g.modified.startLineNumber), y = d.findLastMonotonous((N) => N.original.startLineNumber < f.original.endLineNumberExclusive), v = lt(e, (N) => N.modified.startLineNumber < f.modified.endLineNumberExclusive), L = Math.max(y.original.endLineNumberExclusive - f.original.endLineNumberExclusive, v.modified.endLineNumberExclusive - f.modified.endLineNumberExclusive);
    let M;
    for (M = 0; M < k; M++) {
      const N = f.original.startLineNumber - M - 1, b = f.modified.startLineNumber - M - 1;
      if (N > i.length || b > r.length || u.contains(b) || c.contains(N) || !$r(i[N - 1], r[b - 1], s))
        break;
    }
    ...
    D > 0 && (c.addRange(new O(f.original.endLineNumberExclusive, f.original.endLineNumberExclusive + D)), u.addRange(new O(f.modified.endLineNumberExclusive, f.modified.endLineNumberExclusive + D))), (M > 0 || D > 0) && (a[m] = new ye(new O(f.original.startLineNumber - M, f.original.endLineNumberExclusive + D), new O(f.modified.startLineNumber - M, f.modified.endLineNumberExclusive + D)));
  }
  return a;
}
function $r(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new Na().compute(new Zt([e], new G(1, 1, 1, e.length), !1), new Zt([t], new G(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function uu(e, t) {
  const n = new dn(e);
  return t = t.filter((i) => {
    const r = n.findLastMonotonous((l) => l.original.startLineNumber < i.original.endLineNumberExclusive) || new ye(new O(1, 1), new O(1, 1)), s = lt(e, (l) => l.modified.startLineNumber < i.modified.endLineNumberExclusive);
    return r !== s;
  }), t;
}
function Gr(e, t, n) {
  let i = n;
  return i = Xr(e, t, i), i = Xr(e, t, i), i = cu(e, t, i), i;
}
function Xr(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let s = 1; s < n.length; s++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (u = 1; u <= o && !(e.getElement(l.seq1Range.start - u) !== e.getElement(l.seq1Range.endExclusive - u) || t.getElement(l.seq2Range.start - u) !== t.getElement(l.seq2Range.endExclusive - u)); u++)
        ;
      if (u--, u === o) {
        i[i.length - 1] = new Z(new j(a.seq1Range.start, l.seq1Range.endExclusive - o), new j(a.seq2Range.start, l.seq2Range.endExclusive - o));
        continue;
      }
      l = l.delta(-u);
    }
  ...
  for (let s = 0; s < i.length - 1; s++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (u = 0; u < o && !(!e.isStronglyEqual(l.seq1Range.start + u, l.seq1Range.endExclusive + u) || !t.isStronglyEqual(l.seq2Range.start + u, l.seq2Range.endExclusive + u)); u++)
        ;
      if (u === o) {
        i[s + 1] = new Z(new j(l.seq1Range.start + o, a.seq1Range.endExclusive), new j(l.seq2Range.start + o, a.seq2Range.endExclusive));
        continue;
      }
      u > 0 && (l = l.delta(u));
    }
...
function cu(e, t, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    ...
    s.seq1Range.isEmpty ? n[i] = Yr(s, e, t, l, o) : s.seq2Range.isEmpty && (n[i] = Yr(s.swap(), t, e, o, l).swap());
  }
  return n;
}
...
function hu(e, t, n) {
  ...
  for (const r of n) {
    ...
    r.seq1Range.start - s.seq1Range.endExclusive <= 2 || r.seq2Range.start - s.seq2Range.endExclusive <= 2 ? i[i.length - 1] = new Z(s.seq1Range.join(r.seq1Range), s.seq2Range.join(r.seq2Range)) : i.push(r);
  }
  return i;
}
function du(e, t, n) {
  const i = Z.invert(n, e.length), r = [];
  let s = new Se(0, 0);
  function a(o, u) {
    ...
    for (; i.length > 0; ) {
      ...
      if (!(k.seq1Range.intersects(m.seq1Range) || k.seq2Range.intersects(m.seq2Range)))
        break;
      const v = e.findWordContaining(k.seq1Range.start), L = t.findWordContaining(k.seq2Range.start), M = new Z(v, L), D = M.intersect(k);
...
function pu(e, t, n) {
    ...
    for (let u = 1; u < i.length; u++) {
      let m = function(_, g) {
        ...
        if (v.length > 20 || v.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const L = e.countLinesIn(_.seq1Range), M = _.seq1Range.length, D = t.countLinesIn(_.seq2Range), N = _.seq2Range.length, b = e.countLinesIn(g.seq1Range), p = g.seq1Range.length, x = t.countLinesIn(g.seq2Range), H = g.seq2Range.length, S = 2 * 40 + 50;
        function T(E) {
          return Math.min(E, S);
        }
        return Math.pow(Math.pow(T(L * 40 + M), 1.5) + Math.pow(T(D * 40 + N), 1.5), 1.5) + Math.pow(Math.pow(T(b * 40 + p), 1.5) + Math.pow(T(x * 40 + H), 1.5), 1.5) > (S ** 1.5) ** 1.5 * 1.3;
      };
      var l = m;
  ...
  return Jl(i, (o, u, c) => {
    ...
    const k = Z.fromOffsetPairs(o ? o.getEndExclusives() : Se.zero, c ? c.getStarts() : Se.max), y = d.intersect(k);
...
class Jr {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : Qr(this.lines[t - 1]), i = t === this.lines.length ? 0 : Qr(this.lines[t]);
    return 1e3 - (n + i);
  }
  getText(t) {
...
class gu {
  constructor() {
    this.dynamicProgrammingDiffing = new eu(), this.myersDiffingAlgorithm = new Na();
  }
  computeDiff(t, n, i) {
    if (t.length <= 1 && Gl(t, n, (D, N) => D === N))
      return new It([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new It([
        new Ie(new O(1, t.length + 1), new O(1, n.length + 1), [
          new Ae(new G(1, 1, t.length, t[t.length - 1].length + 1), new G(1, 1, n.length, n[n.length - 1].length + 1))
        ])
      ], [], !1);
    const r = i.maxComputationTimeMs === 0 ? At.instance : new Kl(i.maxComputationTimeMs), s = !i.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function l(D) {
      let N = a.get(D);
      return N === void 0 && (N = a.size, a.set(D, N)), N;
    }
    const o = t.map((D) => l(D.trim())), u = n.map((D) => l(D.trim())), c = new Jr(o, t), d = new Jr(u, n), m = c.length + d.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, d, r, (D, N) => t[D] === n[N] ? n[N].length === 0 ? 0.1 : 1 + Math.log(1 + n[N].length) : 0.99) : this.myersDiffingAlgorithm.compute(c, d, r);
    let f = m.diffs, _ = m.hitTimeout;
    f = Gr(c, d, f), f = fu(c, d, f);
    const g = [], k = (D) => {
      if (s)
        for (let N = 0; N < D; N++) {
          const b = y + N, p = v + N;
          if (t[b] !== n[p]) {
            const x = this.refineDiff(t, n, new Z(new j(b, b + 1), new j(p, p + 1)), r, s);
            for (const H of x.mappings)
              g.push(H);
            x.hitTimeout && (_ = !0);
          }
        }
    ...
    let y = 0, v = 0;
    for (const D of f) {
      Qt(() => D.seq1Range.start - y === D.seq2Range.start - v);
    ...
    const L = Zr(g, t, n);
    let M = [];
    return i.computeMoves && (M = this.computeMoves(L, t, n, o, u, r, s)), Qt(() => {
      function D(b, p) {
  ...
  computeMoves(t, n, i, r, s, a, l) {
    return ru(t, n, i, r, s, a).map((c) => {
      const d = this.refineDiff(n, i, new Z(c.original.toOffsetRange(), c.modified.toOffsetRange()), a, l), m = Zr(d.mappings, n, i, !0);
      return new Fl(c, m);
    });
  }
  refineDiff(t, n, i, r, s) {
    const l = _u(i).toRangeMapping2(t, n), o = new Zt(t, l.originalRange, s), u = new Zt(n, l.modifiedRange, s), c = o.length + u.length < 500 ? this.dynamicProgrammingDiffing.compute(o, u, r) : this.myersDiffingAlgorithm.compute(o, u, r);
    let d = c.diffs;
    return d = Gr(o, u, d), d = du(o, u, d), d = hu(o, u, d), d = pu(o, u, d), {
      mappings: d.map((f) => new Ae(o.translateRange(f.seq1Range), u.translateRange(f.seq2Range))),
...
function Zr(e, t, n, i = !1) {
  const r = [];
  for (const s of Xl(e.map((a) => bu(a, t, n)), (a, l) => a.original.overlapOrTouch(l.original) || a.modified.overlapOrTouch(l.modified))) {
    const a = s[0], l = s[s.length - 1];
    r.push(new Ie(a.original.join(l.original), a.modified.join(l.modified), s.map((o) => o.innerChanges[0])));
  }
  return Qt(() => !i && r.length > 0 && (r[0].modified.startLineNumber !== r[0].original.startLineNumber || n.length - r[r.length - 1].modified.endLineNumberExclusive !== t.length - r[r.length - 1].original.endLineNumberExclusive) ? !1 : La(r, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
...
function _u(e) {
  return new ye(new O(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new O(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
}
const Kr = {
  getLegacy: () => new Ol(),
  getDefault: () => new gu()
...
class ve {
  ...
  static toRGBA(t) {
    ...
    if (i === 0)
      ...
      a = ve._hue2rgb(c, u, n + 1 / 3), l = ve._hue2rgb(c, u, n), o = ve._hue2rgb(c, u, n - 1 / 3);
    }
...
class rt {
  ...
  static fromRGBA(t) {
    ...
    let u;
    return l === 0 ? u = 0 : s === n ? u = ((i - r) / l % 6 + 6) % 6 : s === i ? u = (r - n) / l + 2 : u = (n - i) / l + 4, new rt(Math.round(u * 60), o, s, t.a);
  }
...
let Kt = class ne {
  ...
  constructor(t) {
    if (t)
      if (t instanceof ie)
        ...
        this._hsla = t, this.rgba = ve.toRGBA(t);
  ...
  equals(t) {
    return !!t && ie.equals(this.rgba, t.rgba) && ve.equals(this.hsla, t.hsla) && rt.equals(this.hsva, t.hsva);
  }
  /**
  ...
  getRelativeLuminance() {
    const t = ne._relativeLuminanceForComponent(this.rgba.r), n = ne._relativeLuminanceForComponent(this.rgba.g), i = ne._relativeLuminanceForComponent(this.rgba.b), r = 0.2126 * t + 0.7152 * n + 0.0722 * i;
    return je(r, 4);
  }
  ...
  lighten(t) {
    return new ne(new ve(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
  }
  darken(t) {
    return new ne(new ve(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
  }
  ...
  opposite() {
    return new ne(new ie(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  makeOpaque(t) {
    if (this.isOpaque() || t.rgba.a !== 1)
      return this;
    const { r: n, g: i, b: r, a: s } = this.rgba;
    return new ne(new ie(t.rgba.r - s * (t.rgba.r - n), t.rgba.g - s * (t.rgba.g - i), t.rgba.b - s * (t.rgba.b - r), 1));
  }
  toString() {
...
function wu(e, t) {
  ...
  if (n)
    return {
      range: e,
      color: bi(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
    };
}
function es(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = Da(r);
  return {
    range: e,
    color: bi(s[0], s[1], s[2], n ? s[3] : 1)
  };
}
function ts(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = Da(r), a = new Kt(new ve(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1));
  return {
    range: e,
    color: bi(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a)
  };
}
function ft(e, t) {
...
function vu(e) {
  const t = [], i = ft(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (i.length > 0)
    for (const r of i) {
...
function Ia(e) {
  ...
  return e = e.replace(xu, ""), { text: e, hasSeparatorLine: t };
}
var is;
(function(e) {
  async function t(i) {
...
class Eu {
  ...
  onEvents(t) {
    ...
    const n = t.changes;
    for (const i of n)
      this._acceptDeleteRange(i.range), this._acceptInsertText(new ee(i.range.startLineNumber, i.range.startColumn), i.text);
...
class Ru {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new Mu(Ce.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class Mu extends Eu {
  ...
  findMatches(t) {
    ...
    for (let i = 0; i < this._lines.length; i++) {
      const r = this._lines[i], s = this.offsetAt(new ee(i + 1, 1)), a = r.matchAll(t);
      for (const l of a)
  ...
  getWordAtPosition(t, n) {
    const i = gi(t.column, Ea(n), this._lines[t.lineNumber - 1], 0);
...
class Nu {
  ...
  async $computeUnicodeHighlights(t, n, i) {
    ...
    return r ? Ul.computeUnicodeHighlights(r, n, i) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  async $computeDiff(t, n, i, r) {
    ...
    return !s || !a ? null : Wt.computeDiff(s, a, i, r);
  }
  static computeDiff(t, n, i, r) {
    const s = r === "advanced" ? Kr.getDefault() : Kr.getLegacy(), a = t.getLinesContent(), l = n.getLinesContent(), o = s.computeDiff(a, l, i), u = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function c(d) {
      return d.map((m) => [m.original.startLineNumber, m.original.endLineNumberExclusive, m.modified.startLineNumber, m.modified.endLineNumberExclusive, m.innerChanges?.map((f) => [
  ...
  async $computeMoreMinimalEdits(t, n, i) {
    ...
    for (let { range: o, text: u, eol: c } of n) {
      ...
      const m = sl(d, u, i), f = r.offsetAt(G.lift(o).getStartPosition());
      for (const _ of m) {
  ...
  async $textualSuggest(t, n, i, r) {
    const s = new hn(), a = new RegExp(i, r), l = /* @__PURE__ */ new Set();
    e: for (const o of t) {
      const u = this._getModel(o);
      if (u) {
        for (const c of u.words(a))
          if (!(c === n || !isNaN(Number(c))) && (l.add(c), l.size > Wt._suggestionsLimit))
            break e;
      }
    }
  ...
  async $navigateValueSet(t, n, i, r, s) {
    ...
    return fi.INSTANCE.navigateValueSet(n, o, u, c, i);
  }
}
class Wt extends Nu {
  constructor(t, n) {
  ...
  $loadForeignModule(t, n, i) {
    const a = {
      host: Cl(i, (l, o) => this._host.$fhr(l, o)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(a, n), Promise.resolve(Ir(this._foreignModule))) : new Promise((l, o) => {
      const u = (c) => {
        this._foreignModule = c.create(a, n), l(Ir(this._foreignModule));
      };
      import(`${ya.asBrowserUri(`${t}.js`).toString(!0)}`).then(u).catch(o);
    });
  }
...
var Du = /{([^}]+)}/g;
function Iu(e, t) {
  return Object.keys(t).length === 0 ? e : e.replace(Du, (n, i) => t[i] ?? n);
}
var rs;
(function(e) {
  function t(n) {
...
(function(e) {
  function t(i, r) {
    return i === Number.MAX_VALUE && (i = en.MAX_VALUE), r === Number.MAX_VALUE && (r = en.MAX_VALUE), { line: i, character: r };
  }
  e.create = t;
  function n(i) {
    let r = i;
...
(function(e) {
  function t(i, r, s, a) {
    if (C.uinteger(i) && C.uinteger(r) && C.uinteger(s) && C.uinteger(a))
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return C.objectLiteral(r) && $.is(r.range) && (C.string(r.uri) || C.undefined(r.uri));
  }
  e.is = n;
})(tn || (tn = {}));
var as;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return C.objectLiteral(r) && $.is(r.targetRange) && C.string(r.targetUri) && $.is(r.targetSelectionRange) && ($.is(r.originSelectionRange) || C.undefined(r.originSelectionRange));
  }
  e.is = n;
})(as || (as = {}));
var jn;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return C.objectLiteral(r) && C.numberRange(r.red, 0, 1) && C.numberRange(r.green, 0, 1) && C.numberRange(r.blue, 0, 1) && C.numberRange(r.alpha, 0, 1);
  }
  e.is = n;
})(jn || (jn = {}));
var os;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return C.objectLiteral(r) && $.is(r.range) && jn.is(r.color);
  }
  e.is = n;
})(os || (os = {}));
var ls;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return C.objectLiteral(r) && C.string(r.label) && (C.undefined(r.textEdit) || oe.is(r)) && (C.undefined(r.additionalTextEdits) || C.typedArray(r.additionalTextEdits, oe.is));
  }
  e.is = n;
})(ls || (ls = {}));
var nn;
...
(function(e) {
  function t(i, r, s, a, l, o) {
    ...
    return C.defined(s) && (u.startCharacter = s), C.defined(a) && (u.endCharacter = a), C.defined(l) && (u.kind = l), C.defined(o) && (u.collapsedText = o), u;
  }
  e.create = t;
  function n(i) {
    const r = i;
    return C.objectLiteral(r) && C.uinteger(r.startLine) && C.uinteger(r.startLine) && (C.undefined(r.startCharacter) || C.uinteger(r.startCharacter)) && (C.undefined(r.endCharacter) || C.uinteger(r.endCharacter)) && (C.undefined(r.kind) || C.string(r.kind));
  }
  e.is = n;
})(us || (us = {}));
var $n;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return C.defined(r) && tn.is(r.location) && C.string(r.message);
  }
  e.is = n;
})($n || ($n = {}));
var cs;
...
(function(e) {
  function t(i, r, s, a, l, o) {
    ...
    return C.defined(s) && (u.severity = s), C.defined(a) && (u.code = a), C.defined(l) && (u.source = l), C.defined(o) && (u.relatedInformation = o), u;
  }
  e.create = t;
  function n(i) {
    var r;
    let s = i;
    return C.defined(s) && $.is(s.range) && C.string(s.message) && (C.number(s.severity) || C.undefined(s.severity)) && (C.integer(s.code) || C.string(s.code) || C.undefined(s.code)) && (C.undefined(s.codeDescription) || C.string((r = s.codeDescription) === null || r === void 0 ? void 0 : r.href)) && (C.string(s.source) || C.undefined(s.source)) && (C.undefined(s.relatedInformation) || C.typedArray(s.relatedInformation, $n.is));
  }
  e.is = n;
})(rn || (rn = {}));
var ut;
...
(function(e) {
  ...
  function r(s) {
    const a = s;
    return C.objectLiteral(a) && C.string(a.newText) && $.is(a.range);
  }
  e.is = r;
})(oe || (oe = {}));
var Gn;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return C.objectLiteral(r) && C.string(r.label) && (C.boolean(r.needsConfirmation) || r.needsConfirmation === void 0) && (C.string(r.description) || r.description === void 0);
  }
  e.is = n;
})(Gn || (Gn = {}));
var ct;
...
(function(e) {
  ...
  function r(s) {
    const a = s;
    return oe.is(a) && (Gn.is(a.annotationId) || ct.is(a.annotationId));
  }
  e.is = r;
})(ms || (ms = {}));
var Xn;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return C.defined(r) && Kn.is(r.textDocument) && Array.isArray(r.edits);
  }
  e.is = n;
})(Xn || (Xn = {}));
var Yn;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "create" && C.string(r.uri) && (r.options === void 0 || (r.options.overwrite === void 0 || C.boolean(r.options.overwrite)) && (r.options.ignoreIfExists === void 0 || C.boolean(r.options.ignoreIfExists))) && (r.annotationId === void 0 || ct.is(r.annotationId));
  }
  e.is = n;
})(Yn || (Yn = {}));
var Jn;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "rename" && C.string(r.oldUri) && C.string(r.newUri) && (r.options === void 0 || (r.options.overwrite === void 0 || C.boolean(r.options.overwrite)) && (r.options.ignoreIfExists === void 0 || C.boolean(r.options.ignoreIfExists))) && (r.annotationId === void 0 || ct.is(r.annotationId));
  }
  e.is = n;
})(Jn || (Jn = {}));
var Qn;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "delete" && C.string(r.uri) && (r.options === void 0 || (r.options.recursive === void 0 || C.boolean(r.options.recursive)) && (r.options.ignoreIfNotExists === void 0 || C.boolean(r.options.ignoreIfNotExists))) && (r.annotationId === void 0 || ct.is(r.annotationId));
  }
  e.is = n;
})(Qn || (Qn = {}));
var Zn;
(function(e) {
  function t(n) {
    let i = n;
    return i && (i.changes !== void 0 || i.documentChanges !== void 0) && (i.documentChanges === void 0 || i.documentChanges.every((r) => C.string(r.kind) ? Yn.is(r) || Jn.is(r) || Qn.is(r) : Xn.is(r)));
  }
  e.is = t;
})(Zn || (Zn = {}));
var fs;
...
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r && C.string(r.newText) && $.is(r.insert) && $.is(r.replace);
  }
  e.is = n;
})(_s || (_s = {}));
var ws;
...
(function(e) {
  function t(n) {
    const i = n;
    return i && (C.string(i.detail) || i.detail === void 0) && (C.string(i.description) || i.description === void 0);
  }
  e.is = t;
})(vs || (vs = {}));
var ys;
...
(function(e) {
  function t(n) {
    let i = n;
    return !!i && C.objectLiteral(i) && (Tt.is(i.contents) || sn.is(i.contents) || C.typedArray(i.contents, sn.is)) && (n.range === void 0 || $.is(n.range));
  }
  e.is = t;
})(Ts || (Ts = {}));
var ks;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && C.string(r.name) && C.number(r.kind) && $.is(r.range) && $.is(r.selectionRange) && (r.detail === void 0 || C.string(r.detail)) && (r.deprecated === void 0 || C.boolean(r.deprecated)) && (r.children === void 0 || Array.isArray(r.children)) && (r.tags === void 0 || Array.isArray(r.tags));
  }
  e.is = n;
})(ni || (ni = {}));
var Es;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return C.defined(r) && C.typedArray(r.diagnostics, rn.is) && (r.only === void 0 || C.typedArray(r.only, C.string)) && (r.triggerKind === void 0 || r.triggerKind === on.Invoked || r.triggerKind === on.Automatic);
  }
  e.is = n;
})(Rs || (Rs = {}));
var Ms;
(function(e) {
  function t(i, r, s) {
    let a = { title: i }, l = !0;
    return typeof r == "string" ? (l = !1, a.kind = r) : ut.is(r) ? a.command = r : a.edit = r, l && s !== void 0 && (a.kind = s), a;
  }
  e.create = t;
  function n(i) {
    let r = i;
    return r && C.string(r.title) && (r.diagnostics === void 0 || C.typedArray(r.diagnostics, rn.is)) && (r.kind === void 0 || C.string(r.kind)) && (r.edit !== void 0 || r.command !== void 0) && (r.command === void 0 || ut.is(r.command)) && (r.isPreferred === void 0 || C.boolean(r.isPreferred)) && (r.edit === void 0 || Zn.is(r.edit));
  }
  e.is = n;
})(Ms || (Ms = {}));
var Ns;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return C.defined(r) && $.is(r.range) && (C.undefined(r.command) || ut.is(r.command));
  }
  e.is = n;
})(Ns || (Ns = {}));
var Ds;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return C.defined(r) && $.is(r.range) && (C.undefined(r.target) || C.string(r.target));
  }
  e.is = n;
})(Is || (Is = {}));
var ln;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return C.objectLiteral(r) && $.is(r.range) && (r.parent === void 0 || e.is(r.parent));
  }
  e.is = n;
})(ln || (ln = {}));
var zs;
...
(function(e) {
  function t(n) {
    const i = n;
    return C.objectLiteral(i) && (i.resultId === void 0 || typeof i.resultId == "string") && Array.isArray(i.data) && (i.data.length === 0 || typeof i.data[0] == "number");
  }
  e.is = t;
})(Us || (Us = {}));
var Ws;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r != null && $.is(r.range) && C.string(r.text);
  }
  e.is = n;
})(Ws || (Ws = {}));
var Fs;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r != null && $.is(r.range) && C.boolean(r.caseSensitiveLookup) && (C.string(r.variableName) || r.variableName === void 0);
  }
  e.is = n;
})(Fs || (Fs = {}));
var Ps;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r != null && $.is(r.range) && (C.string(r.expression) || r.expression === void 0);
  }
  e.is = n;
})(Ps || (Ps = {}));
var Bs;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return C.defined(r) && $.is(i.stoppedLocation);
  }
  e.is = n;
})(Bs || (Bs = {}));
var ii;
...
(function(e) {
  ...
  function n(i) {
    const r = i;
    return C.objectLiteral(r) && (r.tooltip === void 0 || C.string(r.tooltip) || Tt.is(r.tooltip)) && (r.location === void 0 || tn.is(r.location)) && (r.command === void 0 || ut.is(r.command));
  }
  e.is = n;
})(ri || (ri = {}));
var qs;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return C.objectLiteral(r) && re.is(r.position) && (C.string(r.label) || C.typedArray(r.label, ri.is)) && (r.kind === void 0 || ii.is(r.kind)) && r.textEdits === void 0 || C.typedArray(r.textEdits, oe.is) && (r.tooltip === void 0 || C.string(r.tooltip) || Tt.is(r.tooltip)) && (r.paddingLeft === void 0 || C.boolean(r.paddingLeft)) && (r.paddingRight === void 0 || C.boolean(r.paddingRight));
  }
  e.is = n;
})(qs || (qs = {}));
var Os;
...
var Qs = class si {
  ...
  update(t, n) {
    for (let i of t)
      if (si.isIncremental(i)) {
        const r = Ha(i.range), s = this.offsetAt(r.start), a = this.offsetAt(r.end);
  ...
  getLineOffsets() {
    return this._lineOffsets === void 0 && (this._lineOffsets = Zs(this._content, !0)), this._lineOffsets;
  }
  positionAt(t) {
...
(function(e) {
  ...
  e.update = n;
  function i(r, s) {
    let a = r.getText(), l = oi(s.map(Hu), (c, d) => {
      let m = c.range.start.line - d.range.start.line;
      return m === 0 ? c.range.start.character - d.range.start.character : m;
    }), o = 0;
    const u = [];
...
(function(e) {
  e.LATEST = {
    textDocument: {
      ...
      hover: {
        contentFormat: [Ne.Markdown, Ne.PlainText]
      }
    }
  };
})(Ks || (Ks = {}));
...
var Uu = class {
  ...
  skipWhitespace() {
    return this.advanceWhileChar((t) => t === Vu || t === ju || t === Bu || t === Ou || t === qu) > 0;
  }
  advanceWhileChar(e) {
...
}, ea = 33, tt = 45, Et = 60, Le = 62, Tn = 47, Wu = 61, Fu = 34, Pu = 39, Bu = 10, qu = 13, Ou = 12, Vu = 32, ju = 9, $u = {
  "text/x-handlebars-template": !0,
  // Fix for https://github.com/microsoft/vscode/issues/77977
  "text/html": !0
};
function ge(e, t = 0, n = B.WithinContent, i = !1) {
  const r = new Uu(e, t);
  ...
  function g(v, L, M) {
    return l = L, a = v, o = M, L;
  }
  function k() {
    const v = r.pos(), L = s, M = y();
    return M !== z.EOS && v === r.pos() && !(i && (M === z.StartTagClose || M === z.EndTagClose)) ? (console.warn("Scanner.scan has not advanced at offset " + v + ", state before: " + L + " after: " + s), r.advance(1), g(v, z.Unknown)) : M;
  }
  function y() {
    const v = r.pos();
    if (r.eos())
    ...
    switch (s) {
      case B.WithinComment:
        return r.advanceIfChars([tt, tt, Le]) ? (s = B.WithinContent, g(v, z.EndCommentTag)) : (r.advanceUntilChars([tt, tt, Le]), g(v, z.Comment));
      case B.WithinDoctype:
        return r.advanceIfChar(Le) ? (s = B.WithinContent, g(v, z.EndDoctypeTag)) : (r.advanceUntilChar(Le), g(v, z.Doctype));
      case B.WithinContent:
        if (r.advanceIfChar(Et)) {
          if (!r.eos() && r.peekChar() === ea) {
            if (r.advanceIfChars([ea, tt, tt]))
          ...
          return r.advanceIfChar(Tn) ? (s = B.AfterOpeningEndTag, g(v, z.EndTagOpen)) : (s = B.AfterOpeningStartTag, g(v, z.StartTagOpen));
        }
        return r.advanceUntilChar(Et), g(v, z.Content);
      case B.AfterOpeningEndTag:
        return f().length > 0 ? (s = B.WithinEndTag, g(v, z.EndTag)) : r.skipWhitespace() ? g(v, z.Whitespace, Te("Tag name must directly follow the open bracket.")) : (s = B.WithinEndTag, r.advanceUntilChar(Le), v < r.pos() ? g(v, z.Unknown, Te("End tag name expected.")) : y());
      case B.WithinEndTag:
        if (r.skipWhitespace())
        ...
        if (i && r.peekChar() === Et)
          return s = B.WithinContent, g(v, z.EndTagClose, Te("Closing bracket missing."));
        L = Te("Closing bracket expected.");
        break;
      case B.AfterOpeningStartTag:
        return c = f(), m = void 0, d = void 0, c.length > 0 ? (u = !1, s = B.WithinTag, g(v, z.StartTag)) : r.skipWhitespace() ? g(v, z.Whitespace, Te("Tag name must directly follow the open bracket.")) : (s = B.WithinTag, r.advanceUntilChar(Le), v < r.pos() ? g(v, z.Unknown, Te("Start tag name expected.")) : y());
      case B.WithinTag:
        return r.skipWhitespace() ? (u = !0, g(v, z.Whitespace)) : u && (d = _(), d.length > 0) ? (s = B.AfterAttributeName, u = !1, g(v, z.AttributeName)) : r.advanceIfChars([Tn, Le]) ? (s = B.WithinContent, g(v, z.StartTagSelfClose)) : r.advanceIfChar(Le) ? (c === "script" ? m && $u[m] ? s = B.WithinContent : s = B.WithinScriptContent : c === "style" ? s = B.WithinStyleContent : s = B.WithinContent, g(v, z.StartTagClose)) : i && r.peekChar() === Et ? (s = B.WithinContent, g(v, z.StartTagClose, Te("Closing bracket missing."))) : (r.advance(1), g(v, z.Unknown, Te("Unexpected character in tag.")));
      case B.AfterAttributeName:
        return r.skipWhitespace() ? (u = !0, g(v, z.Whitespace)) : r.advanceIfChar(Wu) ? (s = B.BeforeAttributeValue, g(v, z.DelimiterAssign)) : (s = B.WithinTag, y());
      case B.BeforeAttributeValue:
        if (r.skipWhitespace())
          return g(v, z.Whitespace);
        let D = r.advanceIfRegExp(/^[^\s"'`=<>]+/);
        if (D.length > 0 && (r.peekChar() === Le && r.peekChar(-1) === Tn && (r.goBack(1), D = D.substring(0, D.length - 1)), d === "type" && (m = D), D.length > 0))
          return s = B.WithinTag, u = !1, g(v, z.AttributeValue);
        const N = r.peekChar();
        return N === Pu || N === Fu ? (r.advance(1), r.advanceUntilChar(N) && r.advance(1), d === "type" && (m = r.getSource().substring(v + 1, r.pos() - 1)), s = B.WithinTag, u = !1, g(v, z.AttributeValue)) : (s = B.WithinTag, u = !1, y());
    ...
    return r.advance(1), s = B.WithinContent, g(v, z.Unknown, L);
  }
  return {
    scan: k,
    getTokenType: () => l,
...
var na = class {
  ...
  findNodeBefore(e) {
    const t = ta(this.children, (n) => e <= n.start) - 1;
    if (t >= 0) {
  ...
  parse(e, t) {
    const n = ge(e, void 0, void 0, !0), i = new na(0, e.length, [], void 0);
    let r = i, s = -1, a, l = null, o = n.scan();
    for (; o !== z.EOS; ) {
      switch (o) {
        case z.StartTagOpen:
          const u = new na(n.getTokenOffset(), e.length, [], r);
...
var Ju = 97, Qu = 122, Zu = 65, Ku = 90, ec = 48, tc = 57;
function pt(e, t) {
  const n = e.charCodeAt(t);
  return Ju <= n && n <= Qu || Zu <= n && n <= Ku || ec <= n && n <= tc;
}
function un(e) {
  return typeof e < "u";
}
...
var ic = class {
  ...
  async computeCompletions(e, t) {
    ...
    for (const i of this.atributeCompletions) {
      const r = sc(e.getText(i.range));
      if (ac(r))
        if (r === "." || r === "..")
          n.isIncomplete = !0;
        else {
          const s = oc(i.value, r, i.range), a = await this.providePathSuggestions(i.value, s, e, t);
          for (const l of a)
            n.items.push(l);
        }
    }
  ...
  async providePathSuggestions(e, t, n, i) {
    ...
    if (s)
      try {
        ...
        for (const [o, u] of l)
          o.charCodeAt(0) !== rc && a.push(lc(o, u === li.Directory, t));
        return a;
      } catch {
      }
    return [];
...
function sc(e) {
  return $e(e, "'") || $e(e, '"') ? e.slice(1, -1) : e;
}
function ac(e) {
  return !($e(e, "http") || $e(e, "https") || $e(e, "//"));
}
function oc(e, t, n) {
  let i;
  ...
  if (r === -1)
    ...
    const s = t.slice(r + 1), a = wt(n.end, -1 - s.length), l = s.indexOf(" ");
    let o;
    l !== -1 ? o = wt(a, l) : o = wt(n.end, -1), i = $.create(a, o);
  }
  return i;
}
function lc(e, t, n) {
...
function uc(e, t, n) {
  const i = wt(e.start, t), r = wt(e.end, n);
  return $.create(i, r);
}
var cc = class {
  constructor(e, t) {
  ...
  async doComplete2(e, t, n, i, r) {
    ...
    const s = new ic(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory), a = this.completionParticipants;
...
\r`.indexOf(R) >= 0)
    ...
    function v(w, A, R = c) {
      const I = g(w, R), F = ra(u, R, B.WithinEndTag, z.EndTagClose) ? "" : ">";
      let U = d;
      for (A && (U = U.parent); U; ) {
        const W = U.tag;
        if (W && (!U.closed || U.endTagStart && U.endTagStart > c)) {
          const q = {
            ...
            insertTextFormat: xe.PlainText
          }, X = y(U.start), se = y(w - 1);
          if (X !== null && se !== null && X !== se) {
            const _e = X + "</" + W + F;
            q.textEdit = oe.replace(g(w - 1 - se.length), _e), q.filterText = se + "</" + W;
          }
    ...
    function N(w, A = c) {
      ...
      let U = "";
      if (!ra(u, A, B.AfterAttributeName, z.DelimiterAssign)) {
        const q = i?.attributeDefaultValue ?? "doublequotes";
        q === "empty" ? U = "=$1" : q === "singlequotes" ? U = "='$1'" : U = '="$1"';
      }
      const W = D();
      return W[I] = !1, a.forEach((q) => {
        q.provideAttributes(f).forEach((X) => {
          if (W[X.name])
            return;
          W[X.name] = !0;
          let se = X.name, _e;
          X.valueSet !== "v" && U.length && (se = se + U, (X.valueSet || X.name === "style") && (_e = {
            title: "Suggest",
            command: "editor.action.triggerSuggest"
          })), r.items.push({
            label: X.name,
            kind: X.valueSet === "handler" ? he.Function : he.Value,
    ...
    function b(w, A) {
      ...
      function F(U) {
        U.attributeNames.forEach((W) => {
          $e(W, R) && !I[W] && !A[W] && (I[W] = W + '="$1"');
        }), U.children.forEach((W) => F(W));
      }
      n && n.roots.forEach((U) => F(U)), Object.keys(I).forEach((U) => r.items.push({
        label: U,
        kind: he.Value,
        textEdit: oe.replace(w, I[U]),
        insertTextFormat: xe.Snippet
      }));
    }
    function p(w, A = c) {
      ...
      if (c > w && c <= A && hc(u[w])) {
        ...
        let W = A;
        A > w && u[A - 1] === u[w] && W--;
        const q = dc(u, c, U), X = mc(u, c, W);
        R = g(q, X), F = c >= U && c <= W ? u.substring(U, c) : "", I = !1;
      } else
        R = g(w, A), F = u.substring(w, c), I = !0;
      if (s.length > 0) {
        const U = f.toLowerCase(), W = _.toLowerCase(), q = g(w, A);
        for (const X of s)
          X.onHtmlAttributeValue && X.onHtmlAttributeValue({ document: e, position: t, tag: U, attribute: W, value: F, range: q });
      }
      return a.forEach((U) => {
        U.provideValues(f, _).forEach((W) => {
          const q = I ? '"' + W.name + '"' : W.name;
          r.items.push({
            label: W.name,
            filterText: q,
            kind: he.Unit,
            documentation: Xe(W, void 0, o),
    ...
    function x(w) {
      return c === m.getTokenEnd() && (E = m.scan(), E === w && m.getTokenOffset() === c) ? m.getTokenEnd() : c;
    }
    function H() {
      for (const w of s)
        ...
        for (const I in _t)
          if (Yu(I, ";")) {
            ...
            r.items.push({
              label: F,
              kind: he.Keyword,
              documentation: Te("Character entity representing '{0}'", _t[I]),
  ...
  doesSupportMarkdown() {
    if (!un(this.supportsMarkdown)) {
      if (!un(this.lsOptions.clientCapabilities))
...
var fc = class {
  ...
  doHover(e, t, n, i) {
    ...
    function d(N, b, p) {
      for (const x of u) {
        let H = null;
        if (x.provideAttributes(N).forEach((S) => {
          if (b === S.name && S.description) {
            const T = Xe(S, i, s);
            T ? H = { contents: T, range: p } : H = null;
          }
        }), H)
          return H.contents = r(H.contents), H;
      }
    ...
    function m(N, b, p, x) {
      for (const H of u) {
        let S = null;
        if (H.provideValues(N, b).forEach((T) => {
          if (p === T.name && T.description) {
            const E = Xe(T, i, s);
            E ? S = { contents: E, range: x } : S = null;
          }
        }), S)
          return S.contents = r(S.contents), S;
      }
      return null;
    }
    function f(N, b) {
      ...
      for (const x in _t) {
        ...
        const S = "&" + x;
        if (p === S) {
          let T = _t[x].charCodeAt(0).toString(16).toUpperCase(), E = "U+";
          if (T.length < 4) {
            const A = 4 - T.length;
            let R = 0;
            for (; R < A; )
          ...
          E += T;
          const w = Te("Character entity representing '{0}', unicode equivalent '{1}'", _t[x], E);
          w ? H = { contents: w, range: b } : H = null;
        }
        if (H)
          return H.contents = r(H.contents), H;
      }
    ...
    function g() {
      ...
      if (N >= 0 && o[N] === "&") {
        let H = null;
        return o[p] === ";" ? H = $.create(re.create(t.line, b), re.create(t.line, x + 1)) : H = $.create(re.create(t.line, b), re.create(t.line, x)), H;
      }
      return null;
    }
    function k(N) {
    ...
    if (L)
      return f(o, L);
    function M(N, b) {
      const p = ge(e.getText(), N);
      let x = p.scan(), H;
      for (; x !== z.EOS && p.getTokenEnd() <= b; )
        x = p.scan(), x === z.AttributeName && (H = p.getTokenText());
      return H;
    }
    const D = _(z.AttributeValue, l.start);
    if (D) {
      const N = l.tag, b = pc(e.getText(D)), p = M(l.start, e.offsetAt(D.start));
      if (p)
        return m(N, p, b, D);
    }
    return null;
...
You passed in: '` + this.raw_options[o] + "'"
    ...
    function(r, s, a) {
      ...
      function v(L, M) {
        this._source_text = L || "", this._options = new l(M), this._ch = null, this._input = null, this.NESTED_AT_RULE = {
          page: !0,
          "font-face": !0,
          keyframes: !0,
...
` && (D === 0 || D < this._options.max_preserve_newlines) && (D++, this._output.add_new_line(!0));
        ...
        for (var L = 0, M = 1, D = this._input.peek(M); D; ) {
          if (D === "{")
            return !0;
          if (D === "(")
            L += 1;
        ...
        M === "auto" && (M = `
`, L && m.test(L || "") && (M = L.match(m)[0])), L = L.replace(f, `
`);
        var D = L.match(/^[\t ]*/)[0];
        this._output = new o(this._options, D), this._input = new u(L), this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
        for (var N = 0, b = !1, p = !1, x = !1, H = !1, S = !1, T = this._ch, E = !1, w, A, R; w = this._input.read(g), A = w !== "", R = T, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), T = this._ch, this._ch; )
          if (this._ch === "/" && this._input.peek() === "*") {
            ...
            U.match(/[ :]$/) && (U = this.eatString(": ").replace(/\s+$/, ""), this.print_string(U), this._output.space_before_token = !0), N === 0 && U.indexOf(":") !== -1 && (p = !0, this.indent());
          } else if (this._ch === "@")
            ...
            (b || x) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !H && N === 0 ? (this.print_string(":"), p || (p = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent())) : (this._input.lookBack(" ") && (this._output.space_before_token = !0), this._input.peek() === ":" ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":"));
          } else if (this._ch === '"' || this._ch === "'") {
            var X = R === '"' || R === "'";
            this.preserveSingleSpace(X || A), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0);
          } else if (this._ch === ";")
            E = !1, N === 0 ? (p && (this.outdent(), p = !1), H = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0);
          else if (this._ch === "(")
            if (this._input.lookBack("url"))
              ...
              var se = !1;
              this._input.lookBack("with") && (se = !0), this.preserveSingleSpace(A || se), this.print_string(this._ch), p && R === "$" && this._options.selector_separator_newline ? (this._output.add_new_line(), S = !0) : (this.eatWhitespace(), N++, this.indent());
            }
          else if (this._ch === ")")
            N && (N--, this.outdent()), S && this._input.peek() === ";" && this._options.selector_separator_newline && (S = !1, this.outdent(), this._output.add_new_line()), this.print_string(this._ch);
          else if (this._ch === ",")
            this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && (!p || S) && N === 0 && !H ? this._output.add_new_line() : this._output.space_before_token = !0;
            ...
            var _e = R === '"' || R === "'";
            this.preserveSingleSpace(_e || A), this.print_string(this._ch), !this._output.just_added_newline() && this._input.peek() === `
` && E && this._output.add_new_line();
          }
        var mn = this._output.get_code(M);
        return mn;
...
You passed in: '` + this.raw_options[o] + "'"
    ...
    function(r, s, a) {
      ...
      var _ = function(b) {
        ...
        var x = null, H = null;
        return p.closed ? (b === "script" ? x = "text/javascript" : b === "style" && (x = "text/css"), x = _(p) || x, x.search("text/css") > -1 ? H = "css" : x.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? H = "javascript" : x.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? H = "html" : x.search(/test\/null/) > -1 && (H = "null"), H) : null;
      };
      function k(b, p) {
      ...
      function L(b, p, x, H) {
        this._source_text = b || "", p = p || {}, this._js_beautify = x, this._css_beautify = H, this._tag_stack = null;
        var S = new l(p, "html");
...
`);
        var x = b.match(/^[\t ]*/)[0], H = {
          text: "",
          type: ""
        }, S = new M(), T = new f(this._options, x), E = new u(b, this._options).tokenize();
        this._tag_stack = new v(T);
        for (var w = null, A = E.next(); A.type !== c.EOF; )
          A.type === c.TAG_OPEN || A.type === c.COMMENT ? (w = this._handle_tag_open(T, A, S, H, E), S = w) : A.type === c.ATTRIBUTE || A.type === c.EQUALS || A.type === c.VALUE || A.type === c.TEXT && !S.tag_complete ? w = this._handle_inside_tag(T, A, S, H) : A.type === c.TAG_CLOSE ? w = this._handle_tag_close(T, A, S) : A.type === c.TEXT ? w = this._handle_text(T, A, S) : A.type === c.CONTROL_FLOW_OPEN ? w = this._handle_control_flow_open(T, A) : A.type === c.CONTROL_FLOW_CLOSE ? w = this._handle_control_flow_close(T, A) : T.add_raw_token(A), H = w, A = E.next();
        var R = T._output.get_code(p);
        return R;
      }, L.prototype._handle_control_flow_open = function(b, p) {
        var x = {
          text: p.text,
          type: p.type
        };
      ...
      }, L.prototype._handle_control_flow_close = function(b, p) {
        var x = {
          text: p.text,
          type: p.type
        };
      ...
      }, L.prototype._handle_tag_close = function(b, p, x) {
        var H = {
          text: p.text,
          type: p.type
        };
      ...
      }, L.prototype._handle_inside_tag = function(b, p, x, H) {
        var S = x.has_wrapped_attrs, T = {
          text: p.text,
          type: p.type
        };
        return b.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), x.is_unformatted ? b.add_raw_token(p) : x.tag_start_char === "{" && p.type === c.TEXT ? b.print_preserved_newlines(p) ? (p.newlines = 0, b.add_raw_token(p)) : b.print_token(p) : (p.type === c.ATTRIBUTE ? b.set_space_before_token(!0) : (p.type === c.EQUALS || p.type === c.VALUE && p.previous.type === c.EQUALS) && b.set_space_before_token(!1), p.type === c.ATTRIBUTE && x.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (b.traverse_whitespace(p), S = S || p.newlines !== 0), this._is_wrap_attributes_force && x.attr_count >= this._options.wrap_attributes_min_attrs && (H.type !== c.TAG_OPEN || // ie. second attribute and beyond
        this._is_wrap_attributes_force_expand_multiline) && (b.print_newline(!1), S = !0)), b.print_token(p), S = S || b.previous_token_wrapped(), x.has_wrapped_attrs = S), T;
      }, L.prototype._handle_text = function(b, p, x) {
        var H = {
          text: p.text,
          type: "TK_CONTENT"
        };
        return x.custom_beautifier_name ? this._print_custom_beatifier_text(b, p, x) : x.is_unformatted || x.is_content_unformatted ? b.add_raw_token(p) : (b.traverse_whitespace(p), b.print_token(p)), H;
      }, L.prototype._print_custom_beatifier_text = function(b, p, x) {
        var H = this;
        if (p.text !== "") {
          var S = p.text, T, E = 1, w = "", A = "";
          x.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? T = this._js_beautify : x.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? T = this._css_beautify : x.custom_beautifier_name === "html" && (T = function(q, X) {
            var se = new L(q, X, H._js_beautify, H._css_beautify);
            return se.beautify();
          }), this._options.indent_scripts === "keep" ? E = 0 : this._options.indent_scripts === "separate" && (E = -b.indent_level);
          var R = b.get_full_indent(E);
          if (S = S.replace(/\n[ \t]*$/, ""), x.custom_beautifier_name !== "html" && S[0] === "<" && S.match(/^(<!--|<!\[CDATA\[)/)) {
            var I = /^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(S);
            if (!I) {
              b.add_raw_token(p);
              return;
...
`;
              ...
              W && (S = S.replace(new RegExp(`
(` + W + ")?", "g"), `
`)), S = R + S.replace(/\n/g, `
` + R);
            }
          w && (S ? S = w + S + `
` + A : S = w + A), b.print_newline(!1), S && (p.text = S, p.whitespace_before = "", p.newlines = 0, b.add_raw_token(p), b.print_newline(!0));
        }
      }, L.prototype._handle_tag_open = function(b, p, x, H, S) {
        var T = this._get_tag_open_token(p);
        if ((x.is_unformatted || x.is_content_unformatted) && !x.is_empty_element && p.type === c.TAG_OPEN && !T.is_start_tag ? (b.add_raw_token(p), T.start_tag_token = this._tag_stack.try_pop(T.tag_name)) : (b.traverse_whitespace(p), this._set_tag_position(b, p, T, x, H), T.is_inline_element || b.set_wrap_point(), b.print_token(p)), T.is_start_tag && this._is_wrap_attributes_force) {
          var E = 0, w;
          do
            w = S.peek(E), w.type === c.ATTRIBUTE && (T.attr_count += 1), E += 1;
      ...
      var M = function(b, p) {
        if (this.parent = b || null, this.text = "", this.type = "TK_TAG_OPEN", this.tag_name = "", this.is_inline_element = !1, this.is_unformatted = !1, this.is_content_unformatted = !1, this.is_empty_element = !1, this.is_start_tag = !1, this.is_end_tag = !1, this.indent_content = !1, this.multiline_content = !1, this.custom_beautifier_name = null, this.start_tag_token = null, this.attr_count = 0, this.has_wrapped_attrs = !1, this.alignment_size = 0, this.tag_complete = !1, this.tag_start_char = "", this.tag_check = "", !p)
          ...
          var H = 2;
          this.tag_start_char === "{" && this.text.length >= 3 && this.text.charAt(2) === "~" && (H = 3), this.is_end_tag = this.is_end_tag || this.tag_start_char === "{" && (this.text.length < 3 || /[^#\^]/.test(this.text.charAt(H)));
        }
      };
      L.prototype._get_tag_open_token = function(b) {
      ...
      }, L.prototype._set_tag_position = function(b, p, x, H, S) {
        if (x.is_empty_element || (x.is_end_tag ? x.start_tag_token = this._tag_stack.try_pop(x.tag_name) : (this._do_optional_end_element(x) && (x.is_inline_element || b.print_newline(!1)), this._tag_stack.record_tag(x), (x.tag_name === "script" || x.tag_name === "style") && !(x.is_unformatted || x.is_content_unformatted) && (x.custom_beautifier_name = g(x.tag_check, p)))), k(x.tag_check, this._options.extra_liners) && (b.print_newline(!1), b._output.just_added_blankline() || b.print_newline(!0)), x.is_empty_element) {
          ...
          x.tag_name === "!--" && S.type === c.TAG_CLOSE && H.is_end_tag && x.text.indexOf(`
`) === -1 || (x.is_inline_element || x.is_unformatted || b.print_newline(!1), this._calcluate_parent_multiline(b, x));
        } else if (x.is_end_tag) {
          var E = !1;
          E = x.start_tag_token && x.start_tag_token.multiline_content, E = E || !x.is_inline_element && !(H.is_inline_element || H.is_unformatted) && !(S.type === c.TAG_CLOSE && x.start_tag_token === H) && S.type !== "TK_CONTENT", (x.is_content_unformatted || x.is_unformatted) && (E = !1), E && b.print_newline(!1);
        } else
          x.indent_content = !x.custom_beautifier_name, x.tag_start_char === "<" && (x.tag_name === "html" ? x.indent_content = this._options.indent_inner_html : x.tag_name === "head" ? x.indent_content = this._options.indent_head_inner_html : x.tag_name === "body" && (x.indent_content = this._options.indent_body_inner_html)), !(x.is_inline_element || x.is_unformatted) && (S.type !== "TK_CONTENT" || x.is_content_unformatted) && b.print_newline(!1), this._calcluate_parent_multiline(b, x);
      }, L.prototype._calcluate_parent_multiline = function(b, p) {
    ...
    function(r, s, a) {
      ...
      _.prototype = new l(), _.prototype._is_comment = function(g) {
        ...
        if (g === "<") {
          ...
          L === "!" && (y = this.__patterns.comment.read(), y ? (v = f.get_directives(y), v && v.ignore === "start" && (y += f.readIgnored(this._input))) : y = this.__patterns.cdata.read()), y && (k = this._create_token(m.COMMENT, y), k.directives = v);
        }
        return k;
        ...
        if (g === "<") {
          var L = this._input.peek(1);
          (L === "!" || L === "?") && (y = this.__patterns.conditional_comment.read(), y = y || this.__patterns.processing.read()), y && (k = this._create_token(m.COMMENT, y), k.directives = v);
        }
        return k;
        ...
        if (g === "@") {
          if (y = this.__patterns.angular_control_flow_start.read(), y === "")
            return v;
          for (var L = y.endsWith("(") ? 1 : 0, M = 0; !(y.endsWith("{") && L === M); ) {
        ...
        } else g === "}" && k && k.type === m.CONTROL_FLOW_OPEN && (y = this._input.next(), v = this._create_token(m.CONTROL_FLOW_CLOSE, y));
        return v;
        ...
        if (y && y.text[0] === "<")
          if (g === "=")
            ...
            L = this.__patterns.attribute.read(), L && (k.type === m.EQUALS ? v = this._create_token(m.VALUE, L) : v = this._create_token(m.ATTRIBUTE, L));
        return v;
        ...
        if (y && y.text[0] === "{")
          ...
          var L = k.opened.text.substr(1).toLowerCase();
          if (L === "script" || L === "style") {
            var M = this._read_comment_or_cdata(g);
            if (M)
              return M.type = m.TEXT, M;
            v = this._input.readUntil(new RegExp("</" + L + "[\\n\\r\\t ]*?>", "ig"));
          } else this._is_content_unformatted(L) && (v = this._input.readUntil(new RegExp("</" + L + "[\\n\\r\\t ]*?>", "ig")));
        }
...
function wc(e, t, n) {
  ...
  if (t) {
    ...
    for (; c > 0 && aa(i, c - 1); )
      c--;
    c === 0 || sa(i, c - 1) ? u = c : c < u && (u = c + 1);
    let d = e.offsetAt(t.end), m = d;
    for (; m < i.length && aa(i, m); )
      m++;
    (m === i.length || sa(i, m)) && (d = m), t = $.create(e.positionAt(u), e.positionAt(d));
  ...
  const l = {
    ...
    unformatted: kn(n, "unformatted", void 0),
    content_unformatted: kn(n, "contentUnformatted", void 0),
    ...
    end_with_newline: r && fe(n, "endWithNewline", !1),
    extra_liners: kn(n, "extraLiners", void 0),
...
`,
  ...
  let o = _c(vc(i), l);
  if (s > 0) {
    const u = n.insertSpaces ? ia(" ", a * s) : ia("	", s);
    o = o.split(`
`).join(`
...
(() => {
  var e = { 470: (r) => {
    ...
    var l = { resolve: function() {
      ...
      var L = "";
      for (y = c + k + 1; y <= d; ++y)
        y !== d && o.charCodeAt(y) !== 47 || (L.length === 0 ? L += ".." : L += "/..");
      return L.length > 0 ? L + u.slice(f + k) : (f += k, u.charCodeAt(f) === 47 && ++f, u.slice(f));
  ...
  (() => {
    let r;
    n.r(i), n.d(i, { URI: () => m, Utils: () => H }), typeof process == "object" ? r = process.platform === "win32" : typeof navigator == "object" && (r = navigator.userAgent.indexOf("Windows") >= 0);
    const s = /^\w[\w\d+.-]*$/, a = /^\//, l = /^\/\//;
    function o(S, T) {
      if (!S.scheme && T)
    ...
    class m {
      ...
      query;
      fragment;
      constructor(T, E, w, A, R, I = !1) {
        typeof T == "object" ? (this.scheme = T.scheme || u, this.authority = T.authority || u, this.path = T.path || u, this.query = T.query || u, this.fragment = T.fragment || u) : (this.scheme = /* @__PURE__ */ function(F, U) {
          return F || U ? F : "file";
        }(T, I), this.authority = E || u, this.path = function(F, U) {
          switch (F) {
            case "https":
            case "http":
            case "file":
      ...
      with(T) {
        if (!T)
          return this;
        let { scheme: E, authority: w, path: A, query: R, fragment: I } = T;
        return E === void 0 ? E = this.scheme : E === null && (E = u), w === void 0 ? w = this.authority : w === null && (w = u), A === void 0 ? A = this.path : A === null && (A = u), R === void 0 ? R = this.query : R === null && (R = u), I === void 0 ? I = this.fragment : I === null && (I = u), E === this.scheme && w === this.authority && A === this.path && R === this.query && I === this.fragment ? this : new _(E, w, A, R, I);
      }
      static parse(T, E = !1) {
        const w = d.exec(T);
        return w ? new _(w[2] || u, N(w[4] || u), N(w[5] || u), N(w[7] || u), N(w[9] || u), E) : new _(u, u, u, u, u);
      }
      static file(T) {
        let E = u;
        if (r && (T = T.replace(/\\/g, c)), T[0] === c && T[1] === c) {
          const w = T.indexOf(c, 2);
          w === -1 ? (E = T.substring(2), T = c) : (E = T.substring(2, w), T = T.substring(w) || c);
        }
        return new _("file", E, T, u, u);
      }
      static from(T) {
        const E = new _(T.scheme, T.authority, T.path, T.query, T.fragment);
        return o(E, !0), E;
      }
      toString(T = !1) {
        return L(this, T);
    ...
    class _ extends m {
      ...
      toString(T = !1) {
        return T ? L(this, !0) : (this._formatted || (this._formatted = L(this, !1)), this._formatted);
      }
      toJSON() {
        const T = { $mid: 1 };
        return this._fsPath && (T.fsPath = this._fsPath, T._sep = f), this._formatted && (T.external = this._formatted), this.path && (T.path = this.path), this.scheme && (T.scheme = this.scheme), this.authority && (T.authority = this.authority), this.query && (T.query = this.query), this.fragment && (T.fragment = this.fragment), T;
      }
    }
    ...
    function k(S, T, E) {
      ...
      for (let R = 0; R < S.length; R++) {
        ...
        if (I >= 97 && I <= 122 || I >= 65 && I <= 90 || I >= 48 && I <= 57 || I === 45 || I === 46 || I === 95 || I === 126 || T && I === 47 || E && I === 91 || E && I === 93 || E && I === 58)
          A !== -1 && (w += encodeURIComponent(S.substring(A, R)), A = -1), w !== void 0 && (w += S.charAt(R));
        else {
          w === void 0 && (w = S.substr(0, R));
          const F = g[I];
          F !== void 0 ? (A !== -1 && (w += encodeURIComponent(S.substring(A, R)), A = -1), w += F) : A === -1 && (A = R);
        }
      }
      return A !== -1 && (w += encodeURIComponent(S.substring(A))), w !== void 0 ? w : S;
    }
    function y(S) {
      let T;
      for (let E = 0; E < S.length; E++) {
        const w = S.charCodeAt(E);
        w === 35 || w === 63 ? (T === void 0 && (T = S.substr(0, E)), T += g[w]) : T !== void 0 && (T += S[E]);
      }
      return T !== void 0 ? T : S;
    }
    function v(S, T) {
      let E;
      return E = S.authority && S.path.length > 1 && S.scheme === "file" ? `//${S.authority}${S.path}` : S.path.charCodeAt(0) === 47 && (S.path.charCodeAt(1) >= 65 && S.path.charCodeAt(1) <= 90 || S.path.charCodeAt(1) >= 97 && S.path.charCodeAt(1) <= 122) && S.path.charCodeAt(2) === 58 ? S.path[1].toLowerCase() + S.path.substr(2) : S.path, r && (E = E.replace(/\//g, "\\")), E;
    }
    function L(S, T) {
      const E = T ? y : k;
      let w = "", { scheme: A, authority: R, path: I, query: F, fragment: U } = S;
      if (A && (w += A, w += ":"), (R || A === "file") && (w += c, w += c), R) {
        let W = R.indexOf("@");
        if (W !== -1) {
          const q = R.substr(0, W);
          R = R.substr(W + 1), W = q.lastIndexOf(":"), W === -1 ? w += E(q, !1, !1) : (w += E(q.substr(0, W), !1, !1), w += ":", w += E(q.substr(W + 1), !1, !0)), w += "@";
        }
        R = R.toLowerCase(), W = R.lastIndexOf(":"), W === -1 ? w += E(R, !1, !0) : (w += E(R.substr(0, W), !1, !0), w += R.substr(W));
      }
      if (I) {
      ...
      return F && (w += "?", w += E(F, !1, !1)), U && (w += "#", w += T ? U : k(U, !1, !1)), w;
    }
    function M(S) {
      try {
        return decodeURIComponent(S);
      } catch {
        return S.length > 3 ? S.substr(0, 3) + M(S.substr(3)) : S;
      }
    }
    const D = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function N(S) {
      return S.match(D) ? S.replace(D, (T) => M(T)) : S;
    }
    var b = n(470);
    const p = b.posix || b, x = "/";
    var H;
...
function Ac(e, t, n, i) {
  ...
  return /^\#/i.test(t) ? e + t : /^\/\//i.test(t) ? ($e(e, "https://") ? "https" : "http") + ":" + t.replace(/^\s*/g, "") : n ? n.resolveReference(t, i || e) : t;
}
function Sc(e, t, n, i, r, s) {
  const a = ui(n);
  if (!kc(a, e.languageId))
    return;
  a.length < n.length && (i++, r--);
  const l = Ac(e.uri, a, t, s);
  if (!l)
    return;
  const o = Cc(l, e);
  return {
...
function Cc(e, t) {
  try {
    ...
    return n.scheme === "file" && n.query && (n = n.with({ query: null }), e = n.toString(
      /* skipEncodig*/
      !0
    )), n.scheme === "file" && n.fragment && !(e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === Lc) ? n.with({ fragment: null }).toString(
      /* skipEncodig*/
      !0
    ) : e;
  } catch {
      ...
      switch (r) {
        ...
        case z.AttributeValue:
          if (a && s && this.dataManager.isPathAttribute(a, s)) {
            ...
            if (!l) {
              const d = Sc(e, t, c, i.getTokenOffset(), i.getTokenEnd(), o);
              d && n.push(d);
            }
            l && typeof o > "u" && (o = ui(c), o && t && (o = t.resolveReference(o, e.uri))), l = !1, s = void 0;
          } else if (s === "id") {
            const c = ui(i.getTokenText());
...
function Rc(e, t, n) {
  ...
  if (!r.tag)
    return [];
  const s = [], a = ua(z.StartTag, e, r.start), l = typeof r.endTagStart == "number" && ua(z.EndTag, e, r.endTagStart);
  return (a && la(a, t) || l && la(l, t)) && (a && s.push({ kind: an.Read, range: a }), l && s.push({ kind: an.Read, range: l })), s;
}
function oa(e, t) {
...
function Mc(e, t) {
  ...
  return n;
  function r(s, a) {
    const l = ti.create(s.name, s.kind, s.range, e.uri, a?.name);
...
function qa(e, t, n) {
  const i = Nc(t), r = $.create(e.positionAt(t.start), e.positionAt(t.end)), s = ni.create(i, void 0, ei.Field, r, r);
  n.push(s), t.children.forEach((a) => {
    s.children ?? (s.children = []), qa(e, a, s.children);
  });
}
function Nc(e) {
  let t = e.tag;
...
var Hc = class {
  ...
  getFoldingRanges(e, t) {
    const n = this.dataManager.getVoidElements(e.languageId), i = ge(e.getText());
    let r = i.scan();
    const s = [], a = [];
    let l = null, o = -1;
    function u(d) {
          ...
          if (f)
            if (f[1])
              ...
              if (_ >= 0) {
                ...
                a.length = _;
                const k = d;
                d = g.startLine, k > d && o !== d && u({ startLine: d, endLine: k, kind: nn.Region });
              }
            }
          else {
            const _ = e.positionAt(i.getTokenOffset() + i.getTokenLength()).line;
            d < _ && u({ startLine: d, endLine: _, kind: nn.Comment });
          }
          break;
        }
      }
  ...
  getSelectionRange(e, t, n) {
    ...
    for (let a = i.length - 1; a >= 0; a--) {
      const l = i[a];
      (!r || l[0] !== r[0] || l[1] !== r[1]) && (s = ln.create($.create(t.positionAt(i[a][0]), t.positionAt(i[a][1])), s)), r = l;
    }
    return s || (s = ln.create($.create(e, e))), s;
  }
  ...
  getAttributeLevelRanges(e, t, n) {
    const i = $.create(e.positionAt(t.start), e.positionAt(t.end)), r = e.getText(i), s = n - t.start, a = ge(r);
    let l = a.scan();
    const o = t.start, u = [];
    let c = !1, d = -1;
    for (; l !== z.EOS; ) {
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
  ...
  setDataProviders(e, t) {
    this.dataProviders = [], e && this.dataProviders.push(new Ua("html5", Wc)), this.dataProviders.push(...t);
  }
  getDataProviders() {
    return this.dataProviders;
  }
  isVoidElement(e, t) {
    return !!e && Gu(t, e.toLowerCase(), (n, i) => n.localeCompare(i)) >= 0;
  }
  getVoidElements(e) {
...
function qc(e = Bc) {
  const t = new Fc(e), n = new fc(e, t), i = new cc(e, t), r = new Xu(t), s = new Uc(r), a = new Hc(t), l = new Ec(t);
  return {
    ...
    format: wc,
    findDocumentHighlights: Rc,
    findDocumentLinks: l.findDocumentLinks.bind(l),
    findDocumentSymbols: Mc,
    findDocumentSymbols2: Ba,
  ...
  constructor(e, t) {
    ...
    if (n?.dataProviders)
      for (const s in n.dataProviders)
        r.push(Oc(s, n.dataProviders[s]));
    this._languageService = qc({
