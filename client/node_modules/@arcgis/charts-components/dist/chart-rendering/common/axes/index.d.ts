...
import { DateTimeFormatOptions, NumberFormatOptions, WebChart, WebChartAxis, WebChartTypes } from '@arcgis/charts-spec';
/**
 * Return the x-axis value format
 *
 * @param chartConfig The chart's config
 */
export declare function getXAxisValueFormat(chartConfig: WebChart): WebChartTypes | undefined;
/**
