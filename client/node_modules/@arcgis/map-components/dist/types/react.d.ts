...
interface ReactArcgisUtilityNetworkValidateTopology extends Partial<Pick<ArcgisUtilityNetworkValidateTopology, 'autoDestroyDisabled' | 'extentToValidate' | 'icon' | 'label' | 'position' | 'referenceElement' | 'utilityNetwork'>>, HTMLProps<HTMLArcgisUtilityNetworkValidateTopologyElement> {
...
interface ReactArcgisVersionManagement extends Partial<Pick<ArcgisVersionManagement, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'initialVersionInfos' | 'label' | 'messageOverrides' | 'mode' | 'pageSize' | 'position' | 'referenceElement' | 'versioningStates'>>, HTMLProps<HTMLArcgisVersionManagementElement> {
...
interface ReactArcgisVideo extends Partial<Pick<ArcgisVideo, 'autoDestroyDisabled' | 'layer' | 'map'>>, HTMLProps<HTMLArcgisVideoElement> {
  onarcgisViewReadyChange?: EventHandler<HTMLArcgisVideoElement["arcgisViewReadyChange"]>;
}

interface ReactArcgisVideoPlayer extends Partial<Pick<ArcgisVideoPlayer, 'autoDestroyDisabled' | 'followingMode' | 'hideHeader' | 'icon' | 'label' | 'layer' | 'messageOverrides' | 'position' | 'referenceElement'>>, HTMLProps<HTMLArcgisVideoPlayerElement> {
...
interface ReactArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, HTMLProps<HTMLArcgisWeatherElement> {
...
interface ReactArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement' | 'state'>>, HTMLProps<HTMLArcgisZoomElement> {
...
declare module "react" {
  namespace JSX {
    interface IntrinsicElements {
      ...
      "arcgis-direct-line-measurement-3d": ReactArcgisDirectLineMeasurement3d;
      ...
      "arcgis-grid-controls": ReactArcgisGridControls;
      ...
      "arcgis-time-zone-label": ReactArcgisTimeZoneLabel;
      ...
      "arcgis-video": ReactArcgisVideo;
      "arcgis-video-player": ReactArcgisVideoPlayer;
