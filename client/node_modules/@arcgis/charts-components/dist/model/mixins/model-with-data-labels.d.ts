...
export declare abstract class ModelWithDataLabels extends ChartModel {
    /**
     ...
     * @returns {boolean}
     */
    getDataLabelsVisibility(): boolean;
    /**
     ...
     */
    setDataLabelsVisibility(newDataLabelsVisibility: boolean): void;
    /**
     ...
     */
    getDataLabelsSymbol(): WebChartTextSymbol | undefined;
    /**
     ...
     */
    setDataLabelsSymbol(newDataLabelsSymbol: WebChartTextSymbol | undefined): void;
}
