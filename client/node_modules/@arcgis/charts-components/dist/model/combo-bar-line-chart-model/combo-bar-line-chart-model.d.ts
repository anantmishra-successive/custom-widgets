import { Color, RESTSimpleLineSymbolStyle, RESTSimpleMarkerSymbolStyle, WebChart, WebChartLineChartSeries, WebChartTypes } from '@arcgis/charts-spec';
...
export declare class ComboBarLineChartModel extends SerialChartModel {
     ...
     */
    protected _config: ChartConfig<typeof ModelTypes.ComboBarLineChart, WebChart>;
    /**
    ...
    setup(params: ModelParams<ChartConfig<typeof ModelTypes.ComboBarLineChart>>): Promise<void>;
    ...
    setSeriesType(seriesIndex: number, seriesType: WebChartTypes): Promise<void>;
    /**
