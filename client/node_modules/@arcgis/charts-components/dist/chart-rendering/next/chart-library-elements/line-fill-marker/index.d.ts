import { Graphics, RoundedRectangle, Sprite, Template } from '@amcharts/amcharts5';
import { State } from '@amcharts/amcharts5/.internal/core/util/States.js';
import { TemplateState } from '@amcharts/amcharts5/.internal/core/util/Template.js';
import { SelectionThemeProperties } from '../../../../utils';
import { ISimpleFillSymbol, ISimpleLineSymbol, ISimpleMarkerSymbol } from '@arcgis/charts-spec';
import { MappedFillSymbol, MappedLineSymbol, MappedMarkerSymbol } from '../symbols/interfaces';
import { FillElementsProps, LineElementsProps, MarkerElementsProps, UpdateSymbolProps } from './interfaces';
 ...
 */
export declare function setStateProperties(state: State<Graphics> | TemplateState<RoundedRectangle>, theme?: SelectionThemeProperties): void;
