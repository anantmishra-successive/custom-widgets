...
import { IField, WebChart } from '@arcgis/charts-spec';
/**
 ...
 */
export declare function getTooltipLabelForBarLineFromFields(props: {
    config: WebChart;
    fieldName?: string;
 ...
 * @param props
 */
export declare function getTooltipYLabel(props: {
    config: WebChart;
    fieldList?: IField[];
