import { Root, SerialChart, Series, Tooltip } from '@amcharts/amcharts5';
import { Axis, AxisRenderer, ValueAxis, XYChart } from '@amcharts/amcharts5/xy.js';
import { TimeIntervalInfo, WebChart, WebChartAxis, WebChartDataTypes } from '@arcgis/charts-spec';
/**
...
/**
 * Check if the axis associated with the axisRenderer is horizontal
 * @param axisRenderer The renderer associated with the axis to check for.
 */
export declare function isHorizontalAxis(axisRenderer: AxisRenderer): boolean;
/**
 * Check if the axis associated with the axisRenderer is vertical
 * @param axisRenderer The renderer associated with the axis to check for.
 */
export declare function isVerticalAxis(axisRenderer: AxisRenderer): boolean;
/**
 ...
 */
export declare function initializeAxisCursorTooltip(root: Root, axis: Axis<AxisRenderer>): Tooltip;
/**
 ...
 *
 * @param props.axis The axis to act on
 * @param timeIntervalInfo For a time binning chart, the object containing the size and unit to use as a base interval
 * @param dateBaseInterval The object containing the size and unit to use as a base interval
 */
export declare function updateBaseInterval(props: {
    axis: Axis<AxisRenderer>;
    timeIntervalInfo?: TimeIntervalInfo;
    dateBaseInterval?: TimeIntervalInfo;
}): void;
/**
 * For log axis, we want to round the min or max of an axis either up or down to the nearest power of 10
 * @param props.num The number
 * @param props.isRoundUp If we should round up or down
 */
export declare function roundToNearestPowerOf10(num: number | null | undefined, isRoundUp: boolean): number | null | undefined;
/**
 * Update chart's axes using either chart config's min/max or the min/max from data.
 *
 * Notes:
 *  This function forces the axis to set its bounds based on the visible series only and their stack type, unless the chat is 100% stacking with all positive values.
 ...
 *
 * @param _minMaxValue Unused value for either the min or max value
 * @param target The target axis
 */
export declare function axisMinMaxChangedCallback(_minMaxValue: number | undefined, target?: ValueAxis<AxisRenderer>): void;
/**
