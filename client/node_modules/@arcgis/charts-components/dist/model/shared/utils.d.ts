import { IField, SupportedLayer, WebChart, WebChartAxis, WebChartGaugeAxis } from '@arcgis/charts-spec';
import { LayerInfo, SplitByFieldInfos } from '../interfaces/common';
/**
 ...
 * @param {WebChart} props.config The chart configuration
