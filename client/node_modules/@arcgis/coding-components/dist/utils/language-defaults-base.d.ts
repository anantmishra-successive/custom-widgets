...
export declare abstract class LanguageDefaultsBase<TApiContext extends ApiContext = ApiContext> {
    ...
    protected _localeToApiLibraryPromiseMap: Map<"id" | "en" | "el" | "hr" | "th" | "tr" | "es" | "da" | "sl" | "fi" | "ca" | "ar" | "de" | "it" | "vi" | "pl" | "et" | "bs" | "sk" | "ru" | "ro" | "no" | "lt" | "cs" | "he" | "fr" | "sv" | "bg" | "hu" | "ja" | "ko" | "lv" | "nl" | "nb" | "pt-BR" | "pt-PT" | "sr" | "uk" | "zh-CN" | "zh-HK" | "zh-TW", Promise<ApiCategory[]>>;
