import { IField, LegendItemVisibility, WebBoxPlot, WebChart, WebChartDataItem, WebChartDataItemValue, WebChartSeries, WebChartStackedKinds, OverlayTerms, WebChartSortOrderKinds, WebChartTemporalBinningUnits, WebChartTypes } from '@arcgis/charts-spec';
import { ChartElementLimit } from '../defaults/interfaces';
import { SelectionData, ChartSubType } from './interfaces';
...
type SerialChartType = typeof WebChartTypes.BarSeries | typeof WebChartTypes.ComboLineAndBarSeries | typeof WebChartTypes.LineSeries | typeof WebChartTypes.RadarSeries;
 ...
 */
export declare function getColorMatch(chartConfig?: WebChart): boolean;
/**
 * Indicates whether or not the chart is rotated.
 * @param chartConfig the chart config.
 * @returns
 */
export declare function isChartRotated(chartConfig?: WebChart): boolean;
/**
 ...
 * @param series
 */
export declare function getStackedType(config?: WebChart): WebChartStackedKinds | undefined;
/**
...
export declare function getFieldAlias(fields: IField[] | undefined, fieldName: undefined): undefined;
export declare function getFieldAlias(fields: IField[] | undefined, fieldName: string | undefined): string | undefined;
/**
 ...
 */
export declare function isSupportedChart(supportedChartTypes: WebChartTypes[], config?: WebChart): boolean;
/**
...
/**
 * Finds localized string for the given `WebChartTemporalBinningUnits` unit type.
 * @param unit
 * @param strings
 * @returns Localized unit type label
 */
export declare function getTimeIntervalUnitLabel(unit: WebChartTemporalBinningUnits, strings: {
    seconds?: string;
    minutes?: string;
    hours?: string;
    days?: string;
 ...
 */
export declare function updateSeriesVisibility(event: CustomEvent<LegendItemVisibility>, config?: WebBoxPlot | WebChart): void;
/**
 ...
 */
export declare function updateRotation<T extends WebBoxPlot | WebChart>(newRotation: boolean, config?: T): T | undefined;
/**
 ...
 * @param {WebChart} chartConfig -  The chart config
 * @returns {string[]} The list of fields to sort by
 */
export declare function getOrderByFields(chartConfig: WebChart): string[];
/**
 ...
 * @param {T[]} props.arrayA - The array to be sorted
 * @param {T[]} props.arrayB - The array to be used for sorting
 * @param {function} props.getKey - The function to get the key of an item
 */
export declare function sortArrayAUsingArrayB<T, K>(props?: {
    arrayA: T[];
    arrayB: T[];
    getKey: (item: T) => K;
}): T[];
