...
interface StencilArcgisAreaMeasurement3d extends Partial<Pick<ArcgisAreaMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisAreaMeasurement3dElement> {
...
interface StencilArcgisBasemapGallery extends Partial<Pick<ArcgisBasemapGallery, 'activeBasemap' | 'autoDestroyDisabled' | 'disabled' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'source'>>, StencilJsx.HTMLAttributes<HTMLArcgisBasemapGalleryElement> {
...
interface StencilArcgisCompass extends Partial<Pick<ArcgisCompass, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisCompassElement> {
...
interface StencilArcgisCoordinateConversion extends Partial<Pick<ArcgisCoordinateConversion, 'autoDestroyDisabled' | 'conversions' | 'formats' | 'goToOverride' | 'headingLevel' | 'hideCaptureButton' | 'hideExpandButton' | 'hideInputButton' | 'hideSettingsButton' | 'icon' | 'label' | 'locationSymbol' | 'mode' | 'multipleConversionsDisabled' | 'orientation' | 'position' | 'referenceElement' | 'storageDisabled' | 'storageType'>>, StencilJsx.HTMLAttributes<HTMLArcgisCoordinateConversionElement> {
...
interface StencilArcgisDirections extends Partial<Pick<ArcgisDirections, 'apiKey' | 'autoDestroyDisabled' | 'goToOverride' | 'headingLevel' | 'hideLayerDetails' | 'hideSaveAsButton' | 'hideSaveButton' | 'icon' | 'label' | 'layer' | 'maxStops' | 'position' | 'referenceElement' | 'routeLayerItemId' | 'searchProperties' | 'unit' | 'useDefaultRouteLayer'>>, StencilJsx.HTMLAttributes<HTMLArcgisDirectionsElement> {
...
interface StencilArcgisDirectLineMeasurement3d extends Partial<Pick<ArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisDirectLineMeasurement3dElement> {
...
interface StencilArcgisDirectlineMeasurement3d extends Partial<Pick<DeprecatedArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisDirectlineMeasurement3dElement> {
  onArcgisPropertyChange?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisPropertyChange"]>;
  onArcgisReady?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisReady"]>;
}

interface StencilArcgisDistanceMeasurement2d extends Partial<Pick<ArcgisDistanceMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisDistanceMeasurement2dElement> {
...
interface StencilArcgisFullscreen extends Partial<Pick<ArcgisFullscreen, 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, ArcgisFullscreenSetterTypes, StencilJsx.HTMLAttributes<HTMLArcgisFullscreenElement> {
...
interface StencilArcgisGridControls extends Partial<Pick<ArcgisGridControls, 'autoDestroyDisabled' | 'customColor' | 'dynamicScaling' | 'gridColor' | 'hideColorSelection' | 'hideDynamicScaleToggle' | 'hideGridEnabledToggle' | 'hideGridSnapEnabledToggle' | 'hideLineIntervalInput' | 'hideNumericInputs' | 'hideOutOfScaleWarning' | 'hidePlacementButtons' | 'hideRotateWithMapToggle' | 'icon' | 'interactivePlacementState' | 'label' | 'majorLineInterval' | 'messageOverrides' | 'placementDisabled' | 'position' | 'referenceElement' | 'rotateWithMap' | 'rotation' | 'snappingEnabled' | 'snappingOptions' | 'spacing' | 'theme' | 'unit'>>, StencilJsx.HTMLAttributes<HTMLArcgisGridControlsElement> {
...
interface StencilArcgisHistogramRangeSlider extends Partial<Pick<ArcgisHistogramRangeSlider, 'autoDestroyDisabled' | 'average' | 'barCreatedFunction' | 'bins' | 'dataLineCreatedFunction' | 'dataLines' | 'icon' | 'label' | 'labelFormatFunction' | 'max' | 'min' | 'position' | 'precision' | 'rangeType' | 'referenceElement' | 'standardDeviation' | 'standardDeviationCount' | 'values'>>, ArcgisHistogramRangeSliderSetterTypes, StencilJsx.HTMLAttributes<HTMLArcgisHistogramRangeSliderElement> {
...
interface StencilArcgisLineOfSight extends Partial<Pick<ArcgisLineOfSight, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisLineOfSightElement> {
...
interface StencilArcgisLinkChartLayoutSwitcher extends Partial<Pick<ArcgisLinkChartLayoutSwitcher, 'appearance' | 'autoDestroyDisabled' | 'closeOnSelectDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'preventExtentUpdate' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisLinkChartLayoutSwitcherElement> {
...
interface StencilArcgisLocate extends Partial<Pick<ArcgisLocate, 'autoDestroyDisabled' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'popupDisabled' | 'position' | 'referenceElement' | 'scale' | 'state'>>, StencilJsx.HTMLAttributes<HTMLArcgisLocateElement> {
...
interface StencilArcgisNavigationToggle extends Partial<Pick<ArcgisNavigationToggle, 'icon' | 'label' | 'layout' | 'messageOverrides' | 'navigationMode' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisNavigationToggleElement> {
...
interface StencilArcgisPrint extends Partial<Pick<ArcgisPrint, 'allowedFormats' | 'allowedFormatsForSaving' | 'allowedLayouts' | 'autoDestroyDisabled' | 'browseTemplateButtonOnClick' | 'excludeDefaultTemplates' | 'excludeOrganizationTemplates' | 'exportedLinks' | 'extraParameters' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'outSpatialReference' | 'portal' | 'position' | 'printServiceUrl' | 'referenceElement' | 'saveAsButtonCallback' | 'showPrintAreaEnabled' | 'templateCustomTextElements' | 'templateOptions'>>, StencilJsx.HTMLAttributes<HTMLArcgisPrintElement> {
...
interface StencilArcgisScene extends Partial<Pick<ArcgisScene, 'alphaCompositingEnabled' | 'analyses' | 'autoDestroyDisabled' | 'basemap' | 'basemapView' | 'camera' | 'cameraFov' | 'cameraHeading' | 'cameraPosition' | 'cameraTilt' | 'clippingArea' | 'constraints' | 'displayFilterDisabled' | 'environment' | 'extent' | 'fatalError' | 'floors' | 'focusAreas' | 'graphics' | 'highlightOptions' | 'highlights' | 'itemId' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'qualityProfile' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'viewingMode' | 'viewpoint' | 'zoom'>>, ArcgisSceneSetterTypes, StencilJsx.HTMLAttributes<HTMLArcgisSceneElement> {
...
interface StencilArcgisSlice extends Partial<Pick<ArcgisSlice, 'analysis' | 'autoDestroyDisabled' | 'excludedLayers' | 'excludeGroundSurface' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'shape' | 'tiltEnabled'>>, StencilJsx.HTMLAttributes<HTMLArcgisSliceElement> {
...
interface StencilArcgisTimeZoneLabel extends Partial<Pick<ArcgisTimeZoneLabel, 'disabled' | 'expanded' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, ArcgisTimeZoneLabelSetterTypes, StencilJsx.HTMLAttributes<HTMLArcgisTimeZoneLabelElement> {
...
interface StencilArcgisTrack extends Partial<Pick<ArcgisTrack, 'autoDestroyDisabled' | 'error' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'positionFilterFunction' | 'referenceElement' | 'rotationDisabled' | 'scale'>>, StencilJsx.HTMLAttributes<HTMLArcgisTrackElement> {
...
interface StencilArcgisUtilityNetworkTrace extends Partial<Pick<ArcgisUtilityNetworkTrace, 'autoDestroyDisabled' | 'defaultGraphicColor' | 'disabled' | 'enableResultArea' | 'flags' | 'gdbVersion' | 'icon' | 'inputSettings' | 'label' | 'position' | 'referenceElement' | 'resultAreaProperties' | 'selectedTraces' | 'selectOnCompleteDisabled' | 'showGraphicsOnCompleteDisabled' | 'showSelectionAttributesDisabled'>>, StencilJsx.HTMLAttributes<HTMLArcgisUtilityNetworkTraceElement> {
  ...
  onArcgisPropertyChange?: EventHandler<HTMLArcgisUtilityNetworkTraceElement["arcgisPropertyChange"]>;
...
interface StencilArcgisUtilityNetworkValidateTopology extends Partial<Pick<ArcgisUtilityNetworkValidateTopology, 'autoDestroyDisabled' | 'extentToValidate' | 'icon' | 'label' | 'position' | 'referenceElement' | 'utilityNetwork'>>, StencilJsx.HTMLAttributes<HTMLArcgisUtilityNetworkValidateTopologyElement> {
  onArcgisPropertyChange?: EventHandler<HTMLArcgisUtilityNetworkValidateTopologyElement["arcgisPropertyChange"]>;
...
interface StencilArcgisVersionManagement extends Partial<Pick<ArcgisVersionManagement, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'initialVersionInfos' | 'label' | 'messageOverrides' | 'mode' | 'pageSize' | 'position' | 'referenceElement' | 'versioningStates'>>, StencilJsx.HTMLAttributes<HTMLArcgisVersionManagementElement> {
...
interface StencilArcgisVideo extends Partial<Pick<ArcgisVideo, 'autoDestroyDisabled' | 'layer' | 'map'>>, StencilJsx.HTMLAttributes<HTMLArcgisVideoElement> {
  onArcgisViewReadyChange?: EventHandler<HTMLArcgisVideoElement["arcgisViewReadyChange"]>;
}

interface StencilArcgisVideoPlayer extends Partial<Pick<ArcgisVideoPlayer, 'autoDestroyDisabled' | 'followingMode' | 'hideHeader' | 'icon' | 'label' | 'layer' | 'messageOverrides' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisVideoPlayerElement> {
  onArcgisPropertyChange?: EventHandler<HTMLArcgisVideoPlayerElement["arcgisPropertyChange"]>;
  onArcgisReady?: EventHandler<HTMLArcgisVideoPlayerElement["arcgisReady"]>;
  onArcgisVideoReady?: EventHandler<HTMLArcgisVideoPlayerElement["arcgisVideoReady"]>;
}

interface StencilArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement'>>, StencilJsx.HTMLAttributes<HTMLArcgisWeatherElement> {
...
interface StencilArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement' | 'state'>>, StencilJsx.HTMLAttributes<HTMLArcgisZoomElement> {
...
interface ExposedElements {
  ...
  "arcgis-direct-line-measurement-3d": StencilArcgisDirectLineMeasurement3d;
  ...
  "arcgis-grid-controls": StencilArcgisGridControls;
  ...
  "arcgis-time-zone-label": StencilArcgisTimeZoneLabel;
  ...
  "arcgis-video": StencilArcgisVideo;
  "arcgis-video-player": StencilArcgisVideoPlayer;
