import { WebChart, WebChartBin, WebChartDataItem, WebChartDataTypes, WebChartSeriesType, WebGaugeChart } from '@arcgis/charts-spec';
import { ChartSubType } from '../misc/interfaces';
import { BoxPlotYValueProps, DataMinMax, BoxPlotYFieldKeys } from './interfaces';
/**
...
/**
 * Gets the data min and max values for a stacked series
 * @param seriesConfig The config for the series
 * @param filteredSeriesIds List of series ids to use as a filter
 * @param filteredData The data to look into
 */
export declare function getDataMinMaxFromStackedSeries(props: {
    seriesConfig: WebChartSeriesType[];
    filteredSeriesIds?: string[];
