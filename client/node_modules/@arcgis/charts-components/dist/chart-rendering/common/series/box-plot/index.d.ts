import { ChartSubType } from '../../../../utils';
import { WebChartDataItem, RESTRendererType } from '@arcgis/charts-spec';
/**
 ...
 */
export declare function shouldUpdateWhiskersWithDefaultColor(props: {
    colorMatch: boolean;
